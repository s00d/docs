...
description: "Öffentliche API des Pakets @i18n-micro/vue: Vue-3-Composables, -Komponenten und -Plugin für Übersetzungen und Locale-Routing, aus dem Quellcode."
---

# `@i18n-micro/vue`

27 Exports über 1 Einstiegspunkt.
...
<code>VueI18nOptions</code> — 6 members, identisch mit [`PreactI18nOptions`](/api/packages/preact).
