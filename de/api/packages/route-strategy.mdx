...
description: "Öffentliche API des Pakets @i18n-micro/route-strategy: Erzeugung lokalisierter Routen zur Buildzeit für Nuxt-Seiten, aus dem Quellcode generiert."
---

# `@i18n-micro/route-strategy`

18 Exports über 1 Einstiegspunkt.
