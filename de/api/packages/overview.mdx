---
title: "Paket-APIs"
description: "Referenzindex jedes @i18n-micro-Workspace-Pakets: exportierte APIs und Typen, generiert aus Snapshots des Quellcodes, gegen die die CI prüft."
---

# Paket-APIs

`nuxt-i18n-micro` besteht aus einer Reihe kleiner Pakete. Die meisten davon sind eigenständig nutzbar: `@i18n-micro/vue` in einer reinen Vue-Anwendung, `@i18n-micro/core` überall.

Jede der unten verlinkten Seiten wird aus dem API-Snapshot generiert, den [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) gegen die TypeScript-Quellen prüft. Ein Export kann also nicht verschwinden, ohne dass sich diese Referenz ändert oder die CI fehlschlägt.

{/* generated:packages-index — do not edit; run `pnpm run docs:generate` */}

| Paket | Einstiegspunkte | Exports |
| --- | --- | --- |
...
- [Integrationen](/integrations/overview): Guides zum Einsatz dieser Pakete in jedem Framework
- [Moduloptionen](/api/module-options): Optionen, die das Nuxt-Modul akzeptiert
- [Methoden](/api/methods): die Runtime-Helfer innerhalb von Komponenten
