...
description: "Öffentliche API des Pakets @i18n-micro/node: Node.js-Runtime-Adapter, Übersetzungs-Loader und exportierte Typen, aus dem Quellcode generiert."
---

# `@i18n-micro/node`

15 Exports über 1 Einstiegspunkt.
...
<code>LoadedTranslations</code> — 2 members, identisch mit [`LoadedTranslations`](/api/packages/astro).
