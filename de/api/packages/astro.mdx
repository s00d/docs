...
description: "Öffentliche API des Pakets @i18n-micro/astro: Integrations-Einstiegspunkt, exportierte Typen und Helfer, zur Buildzeit aus den Quellen generiert."
---

# `@i18n-micro/astro`

56 Exports über 6 Einstiegspunkte.
Generiert aus dem API-Snapshot, den [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) gegen die TypeScript-Quellen prüft.
...
<code>I18nState</code> — 4 members, identisch mit `I18nClientProps` oben.
