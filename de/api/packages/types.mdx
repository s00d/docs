...
description: "Öffentliche API des Pakets @i18n-micro/types: gemeinsame TypeScript-Definitionen, die in Framework-Integrationen verwendet werden, aus dem Quellcode generiert."
---

# `@i18n-micro/types`

26 Exports über 1 Einstiegspunkt.
