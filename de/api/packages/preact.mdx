...
description: "Öffentliche API des Pakets @i18n-micro/preact: Preact-Hooks, -Komponenten und -Provider für Übersetzungen und Routing, aus dem Quellcode generiert."
---

# `@i18n-micro/preact`

39 Exports über 1 Einstiegspunkt.
