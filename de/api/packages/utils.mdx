...
description: "Öffentliche API des Pakets @i18n-micro/utils: Build-Helfer, Quell-Loader, Merger und Premerge-Utilities, zur Buildzeit aus dem Quellcode generiert."
---

# `@i18n-micro/utils`

102 Exports über 24 Einstiegspunkte.
...
<code>SourceLocaleInfo</code> — 2 members, identisch mit `PreMergeLocaleInfo` oben.
