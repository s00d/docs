...
description: "Öffentliche API des Pakets @i18n-micro/core: gemeinsame Runtime-Primitiven und Typen, die jede Framework-Integration antreiben, aus dem Quellcode generiert."
---

# `@i18n-micro/core`

50 Exports über 3 Einstiegspunkte.
...
<code>MergeTranslationChunkOptions</code> — 1 members, identisch mit `MergeTranslationChunkOptions` oben.
