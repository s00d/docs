...
description: "Öffentliche API des Pakets @i18n-micro/solid: SolidJS-Signals, -Komponenten und -Provider für Übersetzungen und Locale-Routing, aus dem Quellcode."
---

# `@i18n-micro/solid`

33 Exports über 1 Einstiegspunkt.
...
<code>FormatService</code> — 19 members, identisch mit [`FormatService`](/api/packages/astro).
<details>
...
<code>Locale</code> — 11 members, identisch mit [`Locale`](/api/packages/types).
<code>ModuleOptions</code> — 47 members, identisch mit [`ModuleOptions`](/api/packages/types).
<details>
...
<code>SolidI18nOptions</code> — 6 members, identisch mit [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 members, identisch mit [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 members, identisch mit [`UseI18nOptions`](/api/packages/preact).
