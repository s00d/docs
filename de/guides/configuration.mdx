...
description: "Jede Moduloption von Nuxt I18n Micro mit Standardwerten, Typen und Beispielen: locales, strategy, meta, translationDir und mehr."
---

# Konfigurationsreferenz

Vollständige Referenz für jede Option unter dem Schlüssel `i18n` in `nuxt.config`. Typen und Defaults entsprechen [`ModuleOptions`](https://github.com/s00d/nuxt-i18n-micro/blob/main/packages/types/src/index.ts) in `@i18n-micro/types`.
