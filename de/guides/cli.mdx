---
title: "Befehle des nuxt-i18n-micro-cli"
description: "Nutze das nuxt-i18n-micro-cli, um Schlüssel aus Templates zu extrahieren, hartkodierten Text in $t-Aufrufe umzuwandeln und Übersetzungs- und Sync-Workflows auszuführen."
---
...
`nuxt-i18n-micro-cli` ist ein Command-Line-Tool, das den Lokalisierungs- und Internationalisierungsprozess in Nuxt.js-Projekten strafft using the `nuxt-i18n-micro` module (Nuxt I18n Micro). Es bietet Utilities, um Übersetzungsschlüssel aus deinem Code zu extrahieren, Übersetzungsdateien zu verwalten, Übersetzungen über Locales hinweg zu synchronisieren und den Übersetzungsprozess mit externen Diensten zu automatisieren.

Dieser Guide führt dich durch Installation, Konfiguration und Nutzung von `nuxt-i18n-micro-cli` zum effektiven Verwalten der Übersetzungen deines Projekts. Paket auf [npmjs.com](https://www.npmjs.com/package/nuxt-i18n-micro-cli).

## 🔧 Installation und Einrichtung

### 📦 Installation von nuxt-i18n-micro-cli

Installiere global oder als Dev-Abhängigkeit in deinem Nuxt-Projekt (recommended for CI):
