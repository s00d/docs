---
title: "Übersetzungen pro Komponente"
description: "Hänge Übersetzungen mit $defineI18nRoute an eine bestimmte Komponente oder Seite. Schlüssel bleiben lokal, statt sie über globale Locale-Dateien zu teilen."
---

# 📖 Übersetzungen pro Komponente

Lerne, wie du Übersetzungen mit `$defineI18nRoute` direkt in Vue-Komponenten definierst. Für modulare und wartbare Lokalisierung.
