...
description: "Nutze @i18n-micro/devtools-ui als eigenständige DevTools-UI und Vite-Plugin, um Übersetzungen in jedem @i18n-micro-Projekt zu durchsuchen und Locales zu bearbeiten."
---

# DevTools-UI-Paket (`@i18n-micro/devtools-ui`)

Das Paket `@i18n-micro/devtools-ui` bietet eine eigenständige Entwicklungs-Tools-Oberfläche zum Verwalten von Übersetzungen. Es enthält ein Vite-Plugin für die automatische Integration und ein universelles Bridge-System für framework-agnostische i18n-Unterstützung.
