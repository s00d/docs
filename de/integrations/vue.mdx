---
title: "Vue-Paket (`@i18n-micro/vue`)"
description: "Nutze @i18n-micro/vue, um Composables, Komponenten und ein Plugin für Übersetzungen und locale-bewusstes Routing in eigenständigen Vue-3-Apps zu ergänzen."
---

# Vue-Paket (`@i18n-micro/vue`)

Das Paket `@i18n-micro/vue` liefert eine schlanke, hochperformante Internationalisierungslösung für Vue-3-Anwendungen. Es teilt sich dieselbe Kernlogik mit Nuxt I18n Micro und bietet reaktive Übersetzungen, Unterstützung pro Route und volle TypeScript-Unterstützung.

## Überblick

`@i18n-micro/vue` ist für Vue 3 Anwendungen gedacht, die Internationalisierung ohne das Nuxt-Framework brauchen. Es bietet:

- **Schlank**: nutzt die gemeinsame Kernlogik aus `@i18n-micro/core`
- **Reaktiv**: Komponenten aktualisieren sich automatisch bei geänderten Übersetzungen
...
- **DevTools-Integration**: eingebaute Vue-DevTools-Unterstützung zum Verwalten von Übersetzungen
...
Das Paket benötigt Vue 3 and optionally Vue Router:
