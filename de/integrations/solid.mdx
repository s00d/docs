---
title: "Solid-Paket (`@i18n-micro/solid`)"
description: "Nutze @i18n-micro/solid, um Signals, Komponenten und einen Provider für Übersetzungen und locale-bewusstes Routing in SolidJS-Anwendungen zu ergänzen."
---

# Solid-Paket (`@i18n-micro/solid`)

The `@i18n-micro/solid` package provides a lightweight, high-performance internationalization solution for SolidJS applications. Es teilt sich dieselbe Kernlogik mit Nuxt I18n Micro und bietet reaktive Übersetzungen, Unterstützung pro Route und volle TypeScript-Unterstützung.

## Überblick

`@i18n-micro/solid` ist für SolidJS Anwendungen gedacht, die Internationalisierung ohne das Nuxt-Framework brauchen. Es bietet:

- **Schlank**: nutzt die gemeinsame Kernlogik aus `@i18n-micro/core`
- **Reaktiv**: Komponenten aktualisieren sich automatisch bei geänderten Übersetzungen using SolidJS signals
...
- **Router-agnostisch**: funktioniert mit beliebigem Router oder ganz ohne via `I18nRoutingStrategy` interface
