---
title: "React-Paket (`@i18n-micro/react`)"
description: "Nutze @i18n-micro/react, um Hooks, Komponenten und einen Provider für Übersetzungen und locale-bewusstes Routing in React-Apps und -Frameworks zu ergänzen."
---

# React-Paket (`@i18n-micro/react`)

Das Paket `@i18n-micro/react` liefert eine schlanke, hochperformante Internationalisierungslösung für React-Anwendungen. Es teilt sich dieselbe Kernlogik mit Nuxt I18n Micro und bietet reaktive Übersetzungen, Unterstützung pro Route und volle TypeScript-Unterstützung.

## Überblick

`@i18n-micro/react` ist für React Anwendungen gedacht, die Internationalisierung ohne das Nuxt-Framework brauchen. Es bietet:

- **Schlank**: nutzt die gemeinsame Kernlogik aus `@i18n-micro/core`
- **Reaktiv**: Komponenten aktualisieren sich automatisch bei geänderten Übersetzungen using `useSyncExternalStore`
...
- **Router-agnostisch**: funktioniert mit beliebigem Router oder ganz ohne
...
Das Paket benötigt React and optionally React Router:
