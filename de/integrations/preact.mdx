---
title: "Preact-Paket (`@i18n-micro/preact`)"
description: "Nutze @i18n-micro/preact, um Preact-Apps mit Übersetzungen, Locale-Wechsel und locale-bewusstem Routing im Nuxt-Stil zu ergänzen."
---

# Preact-Paket (`@i18n-micro/preact`)

The `@i18n-micro/preact` package provides a lightweight, high-performance internationalization solution for **Pure Preact** applications. Es teilt sich dieselbe Kernlogik mit Nuxt I18n Micro und bietet reaktive Übersetzungen, Unterstützung pro Route und volle TypeScript-Unterstützung.

## Überblick

`@i18n-micro/preact` ist für Pure Preact applications (without React compatibility layer) that need internationalization. Es bietet:

- **Schlank**: nutzt die gemeinsame Kernlogik aus `@i18n-micro/core`
- **Reaktiv**: Komponenten aktualisieren sich automatisch bei geänderten Übersetzungen using `useState` + `useEffect` (Pure Preact approach)
...
- **Routen-spezifische Übersetzungen**: Unterstützung von Übersetzungen auf Seitenebene
- **Pluralisierung**: eingebaute Pluralform-Unterstützung
- **Formatierung**: Zahlen, Datumsangaben und relative Zeit formatieren
...
Installiere das Paket mit deinem bevorzugten Package-Manager:
