---
title: "Astro-Paket (`@i18n-micro/astro`)"
description: "Nutze @i18n-micro/astro, um Locale-Routing, Übersetzungen und SEO-Helfer zu Astro-Projekten hinzuzufügen. Nutzt die gemeinsame @i18n-micro/core-Runtime."
---

# Astro-Paket (`@i18n-micro/astro`)

Das Paket `@i18n-micro/astro` liefert eine schlanke, hochperformante Internationalisierungslösung für Astro-Anwendungen. Es teilt sich dieselbe Kernlogik mit Nuxt I18n Micro und bietet SSR-Unterstützung, automatische Locale-Erkennung, Astro-Komponenten und volle TypeScript-Unterstützung.

## Überblick

`@i18n-micro/astro` ist für Astro Anwendungen gedacht, die Internationalisierung mit Unterstützung für serverseitiges Rendering brauchen. Es bietet:

- **Schlank**: nutzt die gemeinsame Kernlogik aus `@i18n-micro/core`
- **SSR-Unterstützung**: volle Kompatibilität mit serverseitigem Rendering
- **Automatische Locale-Erkennung**: erkennt die Locale aus URL-Pfad, Cookies oder Headern
...
- **Router-agnostisch**: funktioniert mit beliebiger Routing-Strategie oder ganz ohne Routing
- **DevTools-Integration**: optionale Entwicklungs-Tools über ein Vite-Plugin
- **SEO-optimiert**: automatische Erzeugung von Meta-Tags und hreflang
