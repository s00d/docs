...
description: "@i18n-micro/vue 套件的公開 API：用於翻譯與語系路由的 Vue 3 composable、元件與外掛，由原始碼產生。"
---
...
| `UseLocaleHeadOptions` | interface | 5 個成員 |
| `VueI18n` | class | 51 個成員 |
| `VueI18nOptions` | interface | 6 個成員 |
...
<details>
<summary><code>UseLocaleHeadOptions</code>：5 個成員</summary>
...
<details>
<summary><code>VueI18n</code>：51 個成員</summary>
