...
description: "@i18n-micro/core 套件的公開 API：驅動每個框架整合的共用執行時原語與型別，由原始碼產生。"
---
...
| 匯出項目 | 類型 | 型別簽章 |
| --- | --- | --- |
| `BaseI18n` | class | 34 個成員 |
| `BaseI18nOptions` | interface | 7 個成員 |
...
| `FormatServiceOptions` | interface | 2 個成員 |
...
| `MergeTranslationChunkOptions` | interface | 1 個成員 |
...
| `ReactiveI18nStore` | interface | 9 個成員 |
...
| `TranslationStorage` | interface | 1 個成員 |
...
<details>
<summary><code>BaseI18n</code>：34 個成員</summary>
...
<details>
<summary><code>BaseI18nOptions</code>：7 個成員</summary>
...
<details>
<summary><code>FormatServiceOptions</code>：2 個成員</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code>：1 個成員</summary>
...
<details>
<summary><code>ReactiveI18nStore</code>：9 個成員</summary>
...
<details>
<summary><code>TranslationStorage</code>：1 個成員</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 個成員 |
...
| `I18nDevtoolsInspectorNode` | interface | 4 個成員 |
| `I18nDevtoolsStateSnapshot` | interface | 7 個成員 |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code>：6 個成員</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code>：4 個成員</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code>：7 個成員</summary>
