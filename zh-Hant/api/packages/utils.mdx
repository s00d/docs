...
description: "@i18n-micro/utils 套件的公開 API：build 輔助工具、原始檔載入器、合併器與 premerge 工具，於建置期由原始碼產生。"
---
...
| `PreMergeLocaleInfo` | interface | 2 個成員 |
...
<details>
<summary><code>PreMergeLocaleInfo</code>：2 個成員</summary>
...
| `CacheControlOptions` | interface | 2 個成員 |

<details>
<summary><code>CacheControl</code>：13 個成員</summary>
...
<details>
<summary><code>CacheControlOptions</code>：2 個成員</summary>
...
| 匯出項目 | 類型 | 型別簽章 |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 個成員 |
...
| `MergeI18nHeadOptions` | interface | 3 個成員 |

<details>
<summary><code>I18nHeadObject</code>：3 個成員</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code>：3 個成員</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 個成員 |
...
| `SourceLocaleInfo` | interface | 2 個成員 |
...
<details>
<summary><code>MergeSourceTranslationsInput</code>：6 個成員</summary>
...
<details>
<summary><code>TranslationFileBuckets</code>：2 個成員</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 個成員 |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 個成員 |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 個成員 |
| `TranslationPayloadStats` | interface | 2 個成員 |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code>：8 個成員</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code>：3 個成員</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code>：2 個成員</summary>
...
<details>
<summary><code>TranslationPayloadStats</code>：2 個成員</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 個成員 |

<details>
<summary><code>TranslationPayloadHostConfig</code>：3 個成員</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 個成員 |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code>：9 個成員</summary>
...
| 匯出項目 | 類型 | 型別簽章 |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 個成員 |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 個成員 |

<details>
<summary><code>HreflangAlternate</code>：2 個成員</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code>：1 個成員</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 個成員 |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 個成員 |

<details>
<summary><code>ResolvePreferredLocaleInput</code>：7 個成員</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code>：8 個成員</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 個成員 |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code>：2 個成員</summary>
...
| `I18nRouteContext` | interface | 3 個成員 |
...
<details>
<summary><code>I18nRouteContext</code>：3 個成員</summary>
...
| `RuntimeI18nOverrides` | interface | 4 個成員 |

<details>
<summary><code>RuntimeI18nOverrides</code>：4 個成員</summary>
...
| `TranslationStorageReader` | interface | 1 個成員 |

<details>
<summary><code>TranslationStorageReader</code>：1 個成員</summary>
...
| 匯出項目 | 類型 | 型別簽章 |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 個成員 |
| `SplitLocaleRoutePage` | interface | 3 個成員 |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 個成員 |

<details>
<summary><code>SplitLocaleRouteEntry</code>：4 個成員</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code>：3 個成員</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code>：2 個成員</summary>
