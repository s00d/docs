---
title: "Integração com o gerador de tipos"
description: "Use o @i18n-micro/types-generator para gerar tipos TypeScript a partir de arquivos JSON de locale e obter autocomplete de chaves."
---
