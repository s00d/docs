...
description: "API pública do pacote @i18n-micro/core: primitivas de runtime compartilhadas e tipos que sustentam cada integração de framework, gerado a partir do código-fonte."
---

# `@i18n-micro/core`

50 exports em 3 pontos de entrada.
