...
description: "API pública do pacote @i18n-micro/test-utils: helpers Vitest, mocks e fixtures para testar comportamento de i18n, gerado a partir do código-fonte."
---

# `@i18n-micro/test-utils`

36 exports em 2 pontos de entrada.
