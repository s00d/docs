...
description: "API pública do pacote @i18n-micro/path-strategy: resolução de path de locale em runtime, redirecionamentos e helpers de SEO, gerado a partir do código-fonte."
---

# `@i18n-micro/path-strategy`

38 exports em 6 pontos de entrada.
