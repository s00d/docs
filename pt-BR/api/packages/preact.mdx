...
description: "API pública do pacote @i18n-micro/preact: hooks Preact, componentes e provider para traduções e roteamento, gerado a partir do código-fonte."
---

# `@i18n-micro/preact`

39 exports em 1 ponto de entrada.
