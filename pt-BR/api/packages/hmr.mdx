...
description: "API pública do pacote @i18n-micro/hmr: helpers de hot module replacement para arquivos JSON de locale durante o desenvolvimento, gerado a partir do código-fonte."
---

# `@i18n-micro/hmr`

8 exports em 3 pontos de entrada.
