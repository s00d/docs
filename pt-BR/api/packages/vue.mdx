...
description: "API pública do pacote @i18n-micro/vue: composables Vue 3, componentes e plugin para traduções e roteamento de locale, a partir do código-fonte."
---

# `@i18n-micro/vue`

27 exports em 1 ponto de entrada.
