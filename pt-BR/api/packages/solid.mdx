...
description: "API pública do pacote @i18n-micro/solid: signals do SolidJS, componentes e provider para traduções e roteamento de locale, a partir do código-fonte."
---

# `@i18n-micro/solid`

33 exports em 1 ponto de entrada.
