...
description: "API pública do pacote @i18n-micro/astro: ponto de entrada da integração, tipos exportados e helpers, gerado a partir do código-fonte em tempo de build."
---

# `@i18n-micro/astro`

56 exports em 6 pontos de entrada.
