...
description: "API pública do pacote @i18n-micro/node: adaptador de runtime Node.js, loaders de tradução e tipos exportados, gerado a partir do código-fonte."
---

# `@i18n-micro/node`

15 exports em 1 ponto de entrada.
