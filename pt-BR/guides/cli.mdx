---
title: "Comandos do nuxt-i18n-micro-cli"
description: "Use o nuxt-i18n-micro-cli para extrair chaves de templates, converter texto fixo em chamadas $t e executar fluxos de tradução e sincronização."
---
