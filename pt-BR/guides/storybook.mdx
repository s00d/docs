...
description: "Integre o Nuxt I18n Micro com o Storybook: configure @nuxtjs/storybook, adicione controles de locale e visualize componentes em vários idiomas."
---
...
Integrar **Nuxt**, **Storybook** e **nuxt-i18n-micro** ao seu projeto permite construir uma aplicação robusta e localizada com uma abordagem de desenvolvimento orientada a componentes. Este guia oferece um passo a passo para configurar essas ferramentas juntas, incluindo configuração, localização e integração com Storybook.

## 🛠 Configuração do Nuxt

Para habilitar localização e Storybook no seu projeto Nuxt, configure seu arquivo `nuxt.config.ts` da seguinte forma:
...
Para integrar o Storybook ao Nuxt e ao nuxt-i18n-micro, configure o arquivo `.storybook/main.ts` e adicione `mergeTranslations` e `staticDirs`.
...
Para exemplos completos, confira estes projetos:

1. **[Exemplo Nuxt + Storybook + i18n no GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Este repositório demonstra como integrar Nuxt, Storybook e nuxt-i18n-micro. Inclui instruções de setup e detalhes de configuração.

2. **[Documentação do Storybook para Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   A documentação oficial para configurar o Storybook com Nuxt. Fornece passos detalhados e boas práticas.

3. **[Exemplo interativo no StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Explore um exemplo ao vivo da integração Nuxt, Storybook e nuxt-i18n-micro diretamente no seu navegador.
