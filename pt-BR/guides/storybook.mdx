---
title: "Guia de integração com Storybook"
description: "Use nuxt-i18n-micro com Storybook."
---

# 🌐 Guia de integração com Storybook
...
Para habilitar localização e Storybook no seu projeto Nuxt, configure seu `nuxt.config.ts` da seguinte forma:
...
Para integrar o Storybook com Nuxt e nuxt-i18n-micro, configure o arquivo `.storybook/main.ts`, adicione `mergeTranslations` e `staticDirs`.
...
2. **[Documentação do Storybook para Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   A documentação oficial para configurar o Storybook com Nuxt. Oferece passos detalhados e boas práticas.
