...
description: "Performance benchmarks comparing Nuxt I18n Micro against @nuxtjs/i18n: build times, memory usage, bundle size, and payload output."
---
...
Focus: build time, peak RSS, deployable **code vs translations vs total**, and server behavior under Artillery + Autocannon.
