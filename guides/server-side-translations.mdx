---
title: "Server-side translations and locale data"
description: "Fetch translations and locale information on the server with Nuxt I18n Micro using useI18n helpers inside Nitro routes and middleware."
---
