...
description: "Recommended locales folder layout for Nuxt I18n Micro: root-level files, page-specific translations, and how premerge and source modes differ."
---
