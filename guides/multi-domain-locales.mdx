---
title: "Multi-domain locales with Nuxt layers"
description: "Serve each locale on its own domain with Nuxt I18n Micro by combining multi-domain setup with layered configuration and per-locale hosts."
---
