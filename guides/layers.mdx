---
title: "Locale settings with Nuxt layers"
description: "Use Nuxt layers with Nuxt I18n Micro to compose locale settings, override defaults per section, and share reusable base configurations."
---
