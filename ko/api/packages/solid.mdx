...
description: "@i18n-micro/solid 패키지의 공용 API: 번역과 로케일 라우팅을 위한 SolidJS 시그널, 컴포넌트, 프로바이더. 소스에서 생성되었습니다."
---
...
<details>
<summary><code>I18nProviderProps</code> — 4개 멤버</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7개 멤버</summary>
...
<details>
<summary><code>SolidI18n</code> — 53개 멤버</summary>
...
<code>SolidI18nOptions</code> — 6개 멤버, 다음과 동일: [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1개 멤버, 다음과 동일: [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2개 멤버, 다음과 동일: [`UseI18nOptions`](/api/packages/preact).
