...
description: "@i18n-micro/path-strategy 패키지의 공용 API: 런타임 로케일 경로 해결, 리디렉션 및 SEO 헬퍼. 소스에서 생성되었습니다."
---
...
<details>
<summary><code>BasePathStrategy</code> — 36개 멤버</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2개 멤버</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2개 멤버</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36개 멤버</summary>
...
<details>
<summary><code>PathStrategy</code> — 22개 멤버</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15개 멤버</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37개 멤버</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44개 멤버</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36개 멤버</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6개 멤버</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2개 멤버</summary>
...
<details>
<summary><code>RouteLike</code> — 6개 멤버</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3개 멤버</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1개 멤버</summary>
...
<code>NoPrefixPathStrategy</code> — 36개 멤버, 다음과 동일: `NoPrefixPathStrategy` above.
<code>Strategy</code> — 36개 멤버, 다음과 동일: `NoPrefixPathStrategy` above.
...
<code>PrefixPathStrategy</code> — 36개 멤버, 다음과 동일: `PrefixPathStrategy` above.
<code>Strategy</code> — 36개 멤버, 다음과 동일: `PrefixPathStrategy` above.
...
<code>PrefixAndDefaultPathStrategy</code> — 37개 멤버, 다음과 동일: `PrefixAndDefaultPathStrategy` above.
<code>Strategy</code> — 37개 멤버, 다음과 동일: `PrefixAndDefaultPathStrategy` above.
...
<code>PrefixExceptDefaultPathStrategy</code> — 44개 멤버, 다음과 동일: `PrefixExceptDefaultPathStrategy` above.
<code>Strategy</code> — 44개 멤버, 다음과 동일: `PrefixExceptDefaultPathStrategy` above.
...
<code>PathStrategy</code> — 22개 멤버, 다음과 동일: `PathStrategy` above.
<code>PathStrategyContext</code> — 15개 멤버, 다음과 동일: `PathStrategyContext` above.
<code>ResolvedRouteLike</code> — 6개 멤버, 다음과 동일: `ResolvedRouteLike` above.
<code>RouteLike</code> — 6개 멤버, 다음과 동일: `RouteLike` above.
<code>RouterAdapter</code> — 3개 멤버, 다음과 동일: `RouterAdapter` above.
<code>SwitchLocaleOptions</code> — 1개 멤버, 다음과 동일: `SwitchLocaleOptions` above.
