...
description: "@i18n-micro/vue 패키지의 공용 API: 번역과 로케일 라우팅을 위한 Vue 3 컴포저블, 컴포넌트, 플러그인. 소스에서 생성되었습니다."
---
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5개 멤버</summary>
...
<details>
<summary><code>VueI18n</code> — 51개 멤버</summary>
...
<code>VueI18nOptions</code> — 6개 멤버, 다음과 동일: [`PreactI18nOptions`](/api/packages/preact).
