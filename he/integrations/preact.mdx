---
title: "חבילת Preact ‏(`@i18n-micro/preact`)"
description: "השתמש ב־@i18n-micro/preact להוספת תרגומים, החלפת שפה וניתוב מודע לשפה לאפליקציות Preact עם חוויית מפתחים דמוית Nuxt."
---
