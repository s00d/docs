---
title: "חבילת React ‏(`@i18n-micro/react`)"
description: "השתמש ב־@i18n-micro/react להוספת hooks, רכיבים ו־provider עבור תרגומים וניתוב מודע לשפה באפליקציות ו־frameworks של React."
---
