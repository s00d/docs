---
title: "חבילת Vue ‏(`@i18n-micro/vue`)"
description: "השתמש ב־@i18n-micro/vue להוספת composables, רכיבים ותוסף עבור תרגומים וניתוב מודע לשפה באפליקציות Vue 3 עצמאיות."
---
