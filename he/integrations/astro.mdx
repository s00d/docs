---
title: "חבילת Astro ‏(`@i18n-micro/astro`)"
description: "השתמש ב־@i18n-micro/astro כדי להוסיף ניתוב שפה, תרגומים ועוזרי SEO לפרויקטי Astro עם זמן הריצה המשותף של @i18n-micro/core."
---
