---
title: "חבילת Solid ‏(`@i18n-micro/solid`)"
description: "השתמש ב־@i18n-micro/solid להוספת signals, רכיבים ו־provider עבור תרגומים וניתוב מודע לשפה באפליקציות SolidJS."
---
