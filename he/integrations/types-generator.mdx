---
title: "מחולל טיפוסים ל־JSON של שפה"
description: "השתמש ב־@i18n-micro/types-generator להנפקת טיפוסי TypeScript מ־JSON של שפה, המעניקים ל־$t ולעוזרים אוטומטית מלאה ובטיחות."
---
