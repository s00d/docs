---
title: "זמן ריצה של Node.js עם @i18n-micro/node"
description: "השתמש ב־@i18n-micro/node לטעינת תרגומים ולזיהוי שפות בשרתי Node.js פשוטים, ב־workers וב־CLIs ללא framework של UI מצורף."
---
