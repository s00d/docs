---
title: "סקירת אינטגרציות framework"
description: "סקירה של אינטגרציות framework של @i18n-micro עבור Vue, ‏React, ‏Preact, ‏SolidJS, ‏Astro ו־Node.js החולקים זמן ריצה תרגום אחד."
---
