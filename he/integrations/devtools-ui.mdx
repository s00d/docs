---
title: "חבילת DevTools UI ‏(`@i18n-micro/devtools-ui`)"
description: "השתמש ב־@i18n-micro/devtools-ui כ־DevTools UI עצמאי ותוסף Vite לעיון בתרגומים ולעריכת שפות בכל פרויקט @i18n-micro."
---
