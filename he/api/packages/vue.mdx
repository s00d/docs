...
description: "API ציבורי של החבילה @i18n-micro/vue: ‏composables של Vue 3, רכיבים ותוסף עבור תרגומים וניתוב שפה, מהמקור."
---

# `@i18n-micro/vue`

27 ייצואים ב־1 נקודות כניסה.
...
<code>VueI18nOptions</code> — 6 חברים, זהה ל־[`PreactI18nOptions`](/api/packages/preact).
