...
description: "API ציבורי של החבילה @i18n-micro/astro: נקודת כניסה של אינטגרציה, טיפוסים מיוצאים ועוזרים, שנוצרו מהמקור בזמן בנייה."
---

# `@i18n-micro/astro`

56 ייצואים ב־6 נקודות כניסה.
...
<code>I18nState</code> — 4 חברים, זהה ל־`I18nClientProps` למעלה.
