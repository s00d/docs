...
description: "API ציבורי של החבילה @i18n-micro/utils: עוזרי בנייה, טוען מקור, ממזג וכלי premerge, שנוצרו מהמקור בזמן בנייה."
---

# `@i18n-micro/utils`

102 ייצואים ב־24 נקודות כניסה.
...
<code>SourceLocaleInfo</code> — 2 חברים, זהה ל־`PreMergeLocaleInfo` למעלה.
