...
description: "API ציבורי של החבילה @i18n-micro/node: מתאם זמן ריצה של Node.js, טוענים של תרגומים וטיפוסים מיוצאים, שנוצרו מהמקור."
---

# `@i18n-micro/node`

15 ייצואים ב־1 נקודות כניסה.
...
<code>LoadedTranslations</code> — 2 חברים, זהה ל־[`LoadedTranslations`](/api/packages/astro).
