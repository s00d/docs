...
description: "API ציבורי של החבילה @i18n-micro/core: פרימיטיבים וטיפוסים משותפים של זמן ריצה המפעילים כל אינטגרציית framework, שנוצרו מהמקור."
---

# `@i18n-micro/core`

50 ייצואים ב־3 נקודות כניסה.
...
<code>MergeTranslationChunkOptions</code> — 1 חברים, זהה ל־`MergeTranslationChunkOptions` למעלה.
