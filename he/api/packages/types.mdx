...
description: "API ציבורי של החבילה @i18n-micro/types: הגדרות TypeScript משותפות בשימוש בכל אינטגרציות ה־framework, שנוצרו מהמקור."
---

# `@i18n-micro/types`

26 ייצואים ב־1 נקודות כניסה.
