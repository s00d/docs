...
description: "API ציבורי של החבילה @i18n-micro/solid: אותות SolidJS, רכיבים ו־provider עבור תרגומים וניתוב שפה, מהמקור."
---

# `@i18n-micro/solid`

33 ייצואים ב־1 נקודות כניסה.
...
<code>FormatService</code> — 19 חברים, זהה ל־[`FormatService`](/api/packages/astro).
<details>
...
<code>Locale</code> — 11 חברים, זהה ל־[`Locale`](/api/packages/types).
<code>ModuleOptions</code> — 47 חברים, זהה ל־[`ModuleOptions`](/api/packages/types).
<details>
...
<code>SolidI18nOptions</code> — 6 חברים, זהה ל־[`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 חברים, זהה ל־[`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 חברים, זהה ל־[`UseI18nOptions`](/api/packages/preact).
