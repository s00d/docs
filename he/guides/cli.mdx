---
title: "פקודות nuxt-i18n-micro-cli"
description: "השתמש ב־nuxt-i18n-micro-cli כדי לחלץ מפתחות מתבניות, להמיר טקסט קשיח לקריאות $t ולהריץ זרימות עבודה של תרגום וסנכרון."
---
