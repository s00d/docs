---
title: "שאלות נפוצות: בעיות נפוצות ופתרונות"
description: "תשובות לשאלות נפוצות על Nuxt I18n Micro: מסלולים חסרים, ‏composables בתוספים, טעינת תרגומים וטיפים לפתרון בעיות."
---
