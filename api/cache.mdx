...
- [Server-Side Translations](/guides/server-side-translations) — Using translations in server routes
- [Firebase Deployment](/guides/firebase) — Deployment-specific cache considerations