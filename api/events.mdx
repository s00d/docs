---
title: "Events"
description: "Use the i18n:register event in Nuxt I18n Micro to add translations at runtime, extending the active locale from plugins and modules."
---
...
Set `hooks: false` in `nuxt.config` to disable automatic `i18n:register` calls (see [Configuration — `hooks`](/guides/configuration#hooks)).
