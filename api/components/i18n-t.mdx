...
description: "Translation component for Vue with slot-based interpolation, pluralization, number and date formatting, and conditional empty-value rendering."
---
