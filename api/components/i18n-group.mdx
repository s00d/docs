...
description: "The <i18n-group> Vue component groups translations under a shared key prefix so nested labels and repeated sections stay concise in templates."
---
