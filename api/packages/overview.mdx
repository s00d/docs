---
title: "Package APIs"
description: "Reference index for every @i18n-micro workspace package, listing exported APIs and types generated from source snapshots the CI checks against."
---
...
[`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) checks against the
...
- [Integrations](/integrations/overview) — guides for using these packages in each framework
