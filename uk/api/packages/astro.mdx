...
description: "Експортоване API @i18n-micro/astro, згенероване з джерела."
---

# `@i18n-micro/astro`

56 експортів у 6 точках входу.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 членів |
| `AstroI18nOptions` | interface | 9 членів |
...
| `I18nClientProps` | interface | 4 членів |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 членів |
| `I18nMiddlewareOptions` | interface | 7 членів |
| `I18nRoutingStrategy` | interface | 10 членів |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 членів |
...
| `LoadTranslationsOptions` | interface | 3 членів |
| `Locale` | interface | 11 член |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 членів |
| `LocaleHeadResult` | interface | 3 членів |
...
<details>
<summary><code>AstroI18n</code> — 48 членів</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 членів</summary>
...
<details>
<summary><code>FormatService</code> — 19 членів</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 членів</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 членів</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 членів</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 членів</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 членів</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 членів</summary>
...
<details>
<summary><code>LocaleHeadOptions</code> — 4 членів</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 членів</summary>
