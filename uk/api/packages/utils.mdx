...
description: "Публічний API пакета @i18n-micro/utils: помічники збірки, завантажувач вихідного коду, обʼєднувач та утиліти premerge, згенеровані з вихідного коду під час збірки."
---

# `@i18n-micro/utils`

102 експорти у 24 точках входу.
