...
description: "Експортоване API @i18n-micro/utils, згенероване з джерела."
---

# `@i18n-micro/utils`

102 експортів у 24 точках входу.
...
| `PreMergeLocaleInfo` | interface | 2 членів |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 членів</summary>
...
| `CacheControlOptions` | interface | 2 членів |

<details>
<summary><code>CacheControl</code> — 13 членів</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 членів</summary>
...
| Експорт | Вид | Сигнатура |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 членів |
...
| `MergeI18nHeadOptions` | interface | 3 членів |

<details>
<summary><code>I18nHeadObject</code> — 3 членів</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 членів</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 членів |
...
| `SourceLocaleInfo` | interface | 2 членів |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 членів</summary>
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 членів</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 членів |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 членів |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 членів |
| `TranslationPayloadStats` | interface | 2 членів |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 членів</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 членів</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 членів</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 членів</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 членів |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 членів</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 членів |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 членів</summary>
...
| Експорт | Вид | Сигнатура |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 членів |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 член |

<details>
<summary><code>HreflangAlternate</code> — 2 членів</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 членів</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 членів |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 членів |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 членів</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 членів</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 членів |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 членів</summary>
...
| `I18nRouteContext` | interface | 3 членів |
...
<details>
<summary><code>I18nRouteContext</code> — 3 членів</summary>
...
| `RuntimeI18nOverrides` | interface | 4 членів |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 членів</summary>
...
| `TranslationStorageReader` | interface | 1 член |

<details>
<summary><code>TranslationStorageReader</code> — 1 членів</summary>
...
| Експорт | Вид | Сигнатура |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 членів |
| `SplitLocaleRoutePage` | interface | 3 членів |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 членів |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 членів</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 членів</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 членів</summary>
