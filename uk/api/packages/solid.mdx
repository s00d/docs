...
description: "Публічний API пакета @i18n-micro/solid: сигнали SolidJS, компоненти та провайдер для перекладів і маршрутизації локалей, з вихідного коду."
---

# `@i18n-micro/solid`

33 експорти у 1 точці входу.
...
<code>FormatService</code> — 19 членів, ідентично до [`FormatService`](/api/packages/astro).
<details>
...
<code>Locale</code> — 11 членів, ідентично до [`Locale`](/api/packages/types).
<code>ModuleOptions</code> — 47 членів, ідентично до [`ModuleOptions`](/api/packages/types).
<details>
...
<code>SolidI18nOptions</code> — 6 членів, ідентично до [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 членів, ідентично до [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 членів, ідентично до [`UseI18nOptions`](/api/packages/preact).
