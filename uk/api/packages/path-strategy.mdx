...
description: "Експортоване API @i18n-micro/path-strategy, згенероване з джерела."
---

# `@i18n-micro/path-strategy`

38 експортів у 6 точках входу.
...
| `BasePathStrategy` | class | 36 членів |
...
| `GetRouteBaseNameOptions` | interface | 2 членів |
...
| `IsIndexRouteNameOptions` | interface | 2 членів |
| `NoPrefixPathStrategy` | class | 36 членів |
...
| `PathStrategy` | interface | 22 членів |
| `PathStrategyContext` | interface | 15 членів |
| `PrefixAndDefaultPathStrategy` | class | 37 членів |
| `PrefixExceptDefaultPathStrategy` | class | 44 членів |
| `PrefixPathStrategy` | class | 36 членів |
| `ResolvedRouteLike` | interface | 6 членів |
| `resolvePathWithParams` | function | `(path: string, params?: Record<string, unknown>) => string` |
| `RouteAnalysis` | interface | 2 членів |
| `RouteLike` | interface | 6 членів |
| `RouterAdapter` | interface | 3 членів |
| `SwitchLocaleOptions` | interface | 1 член |

<details>
<summary><code>BasePathStrategy</code> — 36 членів</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2 членів</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2 членів</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36 членів</summary>
...
<details>
<summary><code>PathStrategy</code> — 22 членів</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15 членів</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37 членів</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44 членів</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36 членів</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6 членів</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2 членів</summary>
...
<details>
<summary><code>RouteLike</code> — 6 членів</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3 членів</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 членів</summary>
