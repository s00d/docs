...
description: "Публічний API пакета @i18n-micro/types: спільні визначення TypeScript, що використовуються у всіх інтеграціях з фреймворками, згенеровані з вихідного коду."
---
