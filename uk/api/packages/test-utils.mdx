...
description: "Експортоване API @i18n-micro/test-utils, згенероване з джерела."
---

# `@i18n-micro/test-utils`

36 експортів у 2 точках входу.
...
| Експорт | Вид | Сигнатура |
| --- | --- | --- |
| `ExportTarget` | interface | 3 членів |
...
<details>
<summary><code>ExportTarget</code> — 3 членів</summary>
