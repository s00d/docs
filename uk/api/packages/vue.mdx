...
description: "Експортоване API @i18n-micro/vue, згенероване з джерела."
---

# `@i18n-micro/vue`

27 експортів у 1 точці входу.
...
| `UseLocaleHeadOptions` | interface | 5 членів |
| `VueI18n` | class | 51 член |
| `VueI18nOptions` | interface | 6 членів |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 членів</summary>
...
<details>
<summary><code>VueI18n</code> — 51 членів</summary>
