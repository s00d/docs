...
description: "Публічний API пакета @i18n-micro/vue: композабли Vue 3, компоненти та плагін для перекладів і маршрутизації локалей, з вихідного коду."
---
...
<code>VueI18nOptions</code> — 6 членів, ідентично до [`PreactI18nOptions`](/api/packages/preact).
