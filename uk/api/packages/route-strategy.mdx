...
description: "Публічний API пакета @i18n-micro/route-strategy: генерація локалізованих маршрутів для сторінок Nuxt на етапі збірки, згенеровано з вихідного коду."
---
