...
description: "Експортоване API @i18n-micro/route-strategy, згенероване з джерела."
---

# `@i18n-micro/route-strategy`

18 експортів у 1 точці входу.
...
| `RouteGenerator` | class | 23 членів |
| `RouteGeneratorOptions` | interface | 11 член |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 членів</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 членів</summary>
