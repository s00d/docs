...
description: "Публічний API пакета @i18n-micro/core: спільні рантайм-примітиви та типи, що живлять кожну інтеграцію з фреймворком, згенеровані з вихідного коду."
---
