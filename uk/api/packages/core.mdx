...
description: "Експортоване API @i18n-micro/core, згенероване з джерела."
---

# `@i18n-micro/core`

50 експортів у 3 точках входу.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 членів |
| `BaseI18nOptions` | interface | 7 членів |
...
| `FormatServiceOptions` | interface | 2 членів |
...
| `MergeTranslationChunkOptions` | interface | 1 член |
...
| `ReactiveI18nStore` | interface | 9 членів |
...
| `TranslationStorage` | interface | 1 член |
...
<details>
<summary><code>BaseI18n</code> — 34 членів</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 членів</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 членів</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 членів</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 членів</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 членів</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 членів |
...
| `I18nDevtoolsInspectorNode` | interface | 4 членів |
| `I18nDevtoolsStateSnapshot` | interface | 7 членів |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 членів</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 членів</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 членів</summary>
