...
description: "Публічний API пакета @i18n-micro/node: адаптер рантайму Node.js, завантажувачі перекладів та експортовані типи, згенеровані з вихідного коду."
---

# `@i18n-micro/node`

15 експортів у 1 точці входу.
...
<code>LoadedTranslations</code> — 2 членів, ідентично до [`LoadedTranslations`](/api/packages/astro).
