---
title: "Пакет Preact (`@i18n-micro/preact`)"
description: "Використовуйте @i18n-micro/preact, щоб додати hook-и, провайдери та компоненти для перекладів і locale-aware маршрутизації у Preact-застосунках."
---
...
- **Реактивність** — автоматичні оновлення компонентів при зміні перекладів using `useState` + `useEffect` (Pure Preact approach)
