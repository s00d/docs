---
title: "Пакет React (`@i18n-micro/react`)"
description: "Використовуйте @i18n-micro/react, щоб додати hook-и, провайдери та компоненти для перекладів і locale-aware маршрутизації у React-застосунках."
---

# React Package (`@i18n-micro/react`)

Пакет `@i18n-micro/react` надає легке та високопродуктивне рішення інтернаціоналізації для застосунків React. It shares the same core logic as Nuxt I18n Micro, offering reactive translations, route-specific support, and full TypeScript support.
...
- **Реактивність** — автоматичні оновлення компонентів при зміні перекладів using `useSyncExternalStore`
...
Пакет потребує React та опційно React Router:
