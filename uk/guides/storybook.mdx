---
title: "Гайд з інтеграції Storybook"
description: "Використання nuxt-i18n-micro зі Storybook."
---

# 🌐 Гайд з інтеграції Storybook

## 📖 Вступ

Інтеграція **Nuxt**, **Storybook** та **nuxt-i18n-micro** у ваш проєкт дозволяє створити надійний, локалізований застосунок з підходом розробки, керованої компонентами. Цей гайд надає покроковий інструктаж з налаштування цих інструментів разом, включно з конфігурацією, локалізацією та інтеграцією Storybook.
...
Для повних прикладів ознайомтеся з цими проєктами:
...
2. **[Документація Storybook для Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   Офіційна документація з налаштування Storybook з Nuxt. Вона надає детальні кроки та найкращі практики.

3. **[Інтерактивний приклад на StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Досліджуйте живий приклад інтеграції Nuxt, Storybook та nuxt-i18n-micro прямо у вашому браузері.
