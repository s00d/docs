...
description: "@i18n-micro/solid 包的公开 API：用于翻译和语言路由的 SolidJS signal、组件和 provider，源自源码。"
---
...
<code>ModuleOptions</code> — 47 个成员，与 [`ModuleOptions`](/api/packages/types).
<details>
...
<code>SolidI18nOptions</code> — 6 个成员，与 [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 个成员，与 [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 个成员，与 [`UseI18nOptions`](/api/packages/preact).
