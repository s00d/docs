---
title: "配置参考"
description: "Nuxt I18n Micro 的完整配置参考：语言、策略、payload、SEO 检测、注册开关等 nuxt.config.ts 中的所有 i18n 选项。"
---
...
| [`dateBuild`](/api/module-options) | `string \| number` | — | 值 used for cache-busting translation requests (`?v=...`). |
