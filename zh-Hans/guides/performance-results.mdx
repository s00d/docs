---
title: "性能基准结果"
description: "在 Nuxt I18n Micro 与 @nuxtjs/i18n 之间的基准测试结果：构建时长、内存占用、包体积与压测数据。"
---
...
| Goal | 默认值 CLI profile (`--locales 4 --keys 10000`); raise knobs for regression-radar loads |
