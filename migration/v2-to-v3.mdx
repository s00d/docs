---
title: "Upgrade guide: v2.x to v3.x"
description: "Upgrade Nuxt I18n Micro from v2.x to v3.x: breaking changes, new payload modes, updated composables, and required configuration updates."
---
