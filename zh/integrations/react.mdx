---
title: "React 集成"
description: "在 React 应用中使用 @i18n-micro/react：hook、组件、provider 与翻译加载。"
---
...
- **解决方案**： Ensure `push` and `replace` methods correctly update the URL using your router's navigation API
