...
description: "@i18n-micro/node パッケージのパブリック API: Node.js ランタイムアダプター、翻訳ローダー、エクスポートされる型。ソースから生成されています。"
---

# `@i18n-micro/node`

15 個のエクスポート、1 個のエントリーポイントにわたります。
...
<details>
<summary><code>I18n</code> — 46 メンバー</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 メンバー</summary>
