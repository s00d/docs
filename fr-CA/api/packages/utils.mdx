...
description: "API publique du paquet @i18n-micro/utils : assistants de compilation, chargeur de source, fusionneur et utilitaires de préfusion, généré depuis la source au moment de la compilation."
---
