...
description: "API exportée de @i18n-micro/test-utils, générée à partir des sources."
---

# `@i18n-micro/test-utils`

36 exportations réparties sur 2 points d'entrée.
Généré à partir de l'instantané d'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) compare aux sources TypeScript.
