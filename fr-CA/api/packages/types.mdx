...
description: "API publique du paquet @i18n-micro/types : définitions TypeScript partagées utilisées dans les intégrations de cadriciels, généré depuis la source."
---
