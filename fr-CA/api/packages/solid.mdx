...
description: "API publique du paquet @i18n-micro/solid : signaux, composants et fournisseur SolidJS pour les traductions et le routage linguistique, depuis la source."
---
