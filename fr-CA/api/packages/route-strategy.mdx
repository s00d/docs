...
description: "API publique du paquet @i18n-micro/route-strategy : génération de routes localisées au moment de la compilation pour les pages Nuxt, généré depuis la source."
---
