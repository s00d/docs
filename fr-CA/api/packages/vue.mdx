...
description: "API publique du paquet @i18n-micro/vue : composables Vue 3, composants et plugin pour les traductions et le routage linguistique, depuis la source."
---
