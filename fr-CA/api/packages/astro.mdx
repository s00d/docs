...
description: "API publique du paquet @i18n-micro/astro : point d’entrée d’intégration, types exportés et assistants, généré depuis la source au moment de la compilation."
---
