...
description: "API publique du paquet @i18n-micro/core : primitives d’exécution et types partagés qui alimentent chaque intégration de cadriciel, généré depuis la source."
---
