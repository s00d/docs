...
description: "API publique du paquet @i18n-micro/preact : hooks, composants et fournisseur Preact pour les traductions et le routage, généré depuis la source."
---
