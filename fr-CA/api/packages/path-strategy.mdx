...
description: "API publique du paquet @i18n-micro/path-strategy : résolution des chemins de langue à l’exécution, redirections et assistants SEO, généré depuis la source."
---
