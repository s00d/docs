...
description: "Intégrez Nuxt I18n Micro à Storybook : configurez @nuxtjs/storybook, ajoutez des contrôles de langue et prévisualisez les composants dans plusieurs langues."
---
...
Intégrer **Nuxt**, **Storybook** et **nuxt-i18n-micro** dans votre projet vous permet de bâtir une application robuste et localisée selon une approche pilotée par les composants. Ce guide propose une marche à suivre pour configurer ces outils ensemble, incluant la configuration, la localisation et l'intégration Storybook.
...
2. **[Documentation Storybook pour Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   La documentation officielle pour configurer Storybook avec Nuxt. Elle fournit des étapes détaillées et les bonnes pratiques.
