...
description: "Utiliser nuxt-i18n-micro avec Storybook."
---
...
Intégrer **Nuxt**, **Storybook** et **nuxt-i18n-micro** dans votre projet vous permet de bâtir une application localisée robuste selon une approche de développement axée sur les composants. Ce guide propose une visite guidée étape par étape pour configurer ces outils ensemble, y compris la configuration, la localisation et l'intégration à Storybook.
...
Pour intégrer Storybook avec Nuxt et nuxt-i18n-micro, configurez le fichier `.storybook/main.ts`, et ajoutez `mergeTranslations` ainsi que `staticDirs`.
...
1. **[Exemple Nuxt + Storybook + i18n sur GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Ce dépôt démontre comment intégrer Nuxt, Storybook et nuxt-i18n-micro. Il comprend les instructions de configuration et les détails de la configuration.
