---
title: "Astro-pakket (`@i18n-micro/astro`)"
description: "i18n voor Astro met @i18n-micro/astro."
---

# Astro-pakket (`@i18n-micro/astro`)

Het `@i18n-micro/astro`-pakket biedt een lichtgewicht, krachtige internationalisatie-oplossing voor Astro-applicaties. Het deelt dezelfde kernlogica als Nuxt I18n Micro en biedt SSR-ondersteuning, automatische localedetectie, Astro-componenten en volledige TypeScript-ondersteuning.
