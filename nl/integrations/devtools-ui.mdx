---
title: "DevTools UI-pakket (`@i18n-micro/devtools-ui`)"
description: "Standalone DevTools UI en Vite-plugin."
---

# DevTools UI-pakket (`@i18n-micro/devtools-ui`)

Het `@i18n-micro/devtools-ui`-pakket biedt een standalone ontwikkeltools-interface voor het beheren van vertalingen. Het bevat een Vite-plugin voor automatische integratie en een universeel bridge-systeem voor framework-onafhankelijke i18n-ondersteuning.

## Overzicht

`@i18n-micro/devtools-ui` is een zelfstandig pakket dat biedt:

- **Vite-plugin** - Automatische knopinjectie en API-endpoints
- **Universele bridge** - Framework-onafhankelijke bridge-creatie voor elke i18n-implementatie
- **Web-component** - Custom element voor de DevTools UI
- **Bestandsoperaties** - Vertaalbestanden opsommen, laden en opslaan via API

## Installatie

Installeer het pakket via je favoriete pakketbeheerder:
