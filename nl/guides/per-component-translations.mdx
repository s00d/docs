...
description: "Vertalingen per component met $defineI18nRoute."
---

# 📖 Vertalingen per component

Leer hoe je vertalingen direct binnen Vue-componenten kunt definiëren met `$defineI18nRoute` voor modulaire en onderhoudbare lokalisatie.
