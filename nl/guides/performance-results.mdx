---
title: "Prestatieresultaten"
description: "Benchmarkresultaten voor Nuxt I18n Micro versus @nuxtjs/i18n: buildtijd, geheugengebruik en bundelomvang op vergelijkbare fixtures."
---
...
<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `build-time-comparison`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `bundle-size-comparison`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `translations-size-comparison`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `total-bundle-comparison`.
</Note>
...
<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `plain-nuxt-traffic`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `plain-nuxt-latency`.
</Note>
...
<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `i18n-v10-traffic`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `i18n-v10-latency`.
</Note>
...
<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `i18n-micro-traffic`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `i18n-micro-latency`.
</Note>
...
<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `comparison-rps-autocannon`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `comparison-rps-artillery`.
</Note>
...
<Note>
Interactive chart omitted in Mintlify docs. Zie de benchmark tables on this page or the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) for chart: `comparison-latency`.
</Note>
