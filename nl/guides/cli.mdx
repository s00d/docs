---
title: "nuxt-i18n-micro-cli-gids"
description: "CLI voor extractie, text-to-i18n en vertaal-workflows."
---

# 🌐 nuxt-i18n-micro-cli-gids

## 📖 Inleiding

`nuxt-i18n-micro-cli` is een commandoregeltool ontworpen om het lokalisatie- en internationalisatieproces in Nuxt.js projects using the `nuxt-i18n-micro` module (Nuxt I18n Micro). It provides utilities to extract translation keys from your codebase, manage translation files, synchronize translations across locales, and automate the translation process using external translation services.
