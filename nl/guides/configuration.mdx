...
description: "Alle nuxt-i18n-micro module-opties, standaardwaarden en voorbeelden."
---

# Configuratiereferentie

Volledige referentie voor elke optie onder de `i18n`-sleutel in `nuxt.config`. Types en standaardwaarden komen overeen met [`ModuleOptions`](https://github.com/s00d/nuxt-i18n-micro/blob/main/packages/types/src/index.ts) in `@i18n-micro/types`.
