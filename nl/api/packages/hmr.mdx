...
description: "Publieke API van het @i18n-micro/hmr-pakket: helpers voor hot module replacement van locale-JSON-bestanden tijdens ontwikkeling, gegenereerd uit de broncode."
---

# `@i18n-micro/hmr`

8 exports verdeeld over 3 entry points.
