...
description: "Publieke API van het @i18n-micro/test-utils-pakket: Vitest-helpers, mocks en fixtures voor het testen van i18n-gedrag, gegenereerd uit de broncode."
---

# `@i18n-micro/test-utils`

36 exports verdeeld over 2 entry points.
...
<details>
<summary><code>ExportTarget</code> — 3 leden</summary>
