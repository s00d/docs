...
description: "Geëxporteerde API van @i18n-micro/route-strategy, gegenereerd uit de bron."
---

# `@i18n-micro/route-strategy`

18 exports over 1 entry point.
...
| `RouteGenerator` | class | 23 leden |
| `RouteGeneratorOptions` | interface | 11 leden |
