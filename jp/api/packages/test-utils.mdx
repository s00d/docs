...
description: "@i18n-micro/test-utils パッケージのパブリック API: i18n 動作をテストするための Vitest ヘルパー、モック、フィクスチャ。ソースから生成されています。"
---

# `@i18n-micro/test-utils`

36 個のエクスポート、2 個のエントリーポイントにわたります。
...
<details>
<summary><code>ExportTarget</code> — 3 メンバー</summary>
