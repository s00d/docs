...
3 つのエントリーポイントにまたがる 8 個のエクスポート。
[`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) が TypeScript ソースと突き合わせている API スナップショットから生成されています。
