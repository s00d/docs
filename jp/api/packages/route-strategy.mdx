...
description: "@i18n-micro/route-strategy パッケージのパブリック API: Nuxt ページ用のビルド時ローカライズルート生成。ソースから生成されています。"
---

# `@i18n-micro/route-strategy`

18 個のエクスポート、1 個のエントリーポイントにわたります。
...
<details>
<summary><code>RouteGenerator</code> — 23 メンバー</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 メンバー</summary>
