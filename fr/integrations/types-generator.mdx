---
title: "Générateur de types pour les JSON de locale"
description: "Utilisez @i18n-micro/types-generator pour émettre des types TypeScript depuis vos JSON de locale, offrant à $t et aux aides une autocomplétion et une sécurité complètes."
---
