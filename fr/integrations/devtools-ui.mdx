...
description: "Utilisez @i18n-micro/devtools-ui comme UI DevTools autonome et plugin Vite pour parcourir les traductions et éditer les locales dans tout projet @i18n-micro."
---
