...
description: "Utilisez @i18n-micro/vue pour ajouter des composables, des composants et un plugin pour les traductions et le routage sensible à la locale dans les apps Vue 3 autonomes."
---
