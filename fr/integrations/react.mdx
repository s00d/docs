...
description: "Utilisez @i18n-micro/react pour ajouter des hooks, des composants et un provider pour les traductions et le routage sensible à la locale dans les apps et frameworks React."
---
