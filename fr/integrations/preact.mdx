...
description: "Utilisez @i18n-micro/preact pour ajouter des traductions, un changement de locale et un routage sensible à la locale aux apps Preact avec une DX proche de Nuxt."
---
