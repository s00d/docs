...
description: "Utilisez @i18n-micro/solid pour ajouter des signals, des composants et un provider pour les traductions et le routage sensible à la locale dans les applications SolidJS."
---
