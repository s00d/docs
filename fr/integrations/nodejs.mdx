...
description: "Utilisez @i18n-micro/node pour charger des traductions et détecter les locales dans des serveurs Node.js, des workers et des CLI sans aucun framework UI attaché."
---
