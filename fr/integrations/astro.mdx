...
description: "Utilisez @i18n-micro/astro pour ajouter le routage de locale, les traductions et des aides SEO aux projets Astro avec le runtime partagé @i18n-micro/core."
---
