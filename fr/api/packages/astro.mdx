...
description: "API publique du paquet @i18n-micro/astro : point d'entrée d'intégration, types exportés et aides, générés depuis le code source au moment du build."
---
