...
description: "API exportée de @i18n-micro/astro, générée à partir du code source."
---

# `@i18n-micro/astro`

56 exports répartis sur 6 points d'entrée.
...
<code>Locale</code> — 11 membres, identique à [`Locale`](/api/packages/types).
<details>
...
<code>Translations</code> — 1 membre, identique à [`Translations`](/api/packages/types).
...
<code>I18nState</code> — 4 membres, identique à `I18nClientProps` ci-dessus.
