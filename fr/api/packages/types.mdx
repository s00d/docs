...
description: "API publique du paquet @i18n-micro/types : définitions TypeScript partagées entre les intégrations de framework, générées depuis le code source."
---

# `@i18n-micro/types`

26 exports répartis sur 1 point d'entrée.
