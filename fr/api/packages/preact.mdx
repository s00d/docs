...
description: "API publique du paquet @i18n-micro/preact : hooks Preact, composants et provider pour les traductions et le routage, générés depuis le code source."
---

# `@i18n-micro/preact`

39 exports répartis sur 1 point d'entrée.
