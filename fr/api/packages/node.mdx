...
description: "API publique du paquet @i18n-micro/node : adaptateur runtime Node.js, chargeurs de traductions et types exportés, générés depuis le code source."
---

# `@i18n-micro/node`

15 exports répartis sur 1 point d'entrée.
