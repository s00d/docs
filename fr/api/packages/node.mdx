...
description: "API exportée de @i18n-micro/node, générée à partir du code source."
---

# `@i18n-micro/node`

15 exports sur 1 point d'entrée.
...
<code>LoadedTranslations</code> — 2 membres, identique à [`LoadedTranslations`](/api/packages/astro).
