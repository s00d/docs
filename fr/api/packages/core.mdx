...
description: "API exportée de @i18n-micro/core, générée à partir du code source."
---

# `@i18n-micro/core`

50 exports répartis sur 3 points d'entrée.
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 membre</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 membre</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 membre, identique à `MergeTranslationChunkOptions` ci-dessus.
