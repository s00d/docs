...
description: "API publique du paquet @i18n-micro/core : primitives runtime partagées et types alimentant chaque intégration de framework, générés depuis le code source."
---
