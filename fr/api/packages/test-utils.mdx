...
description: "API publique du paquet @i18n-micro/test-utils : aides Vitest, mocks et fixtures pour tester le comportement i18n, générés depuis le code source."
---

# `@i18n-micro/test-utils`

36 exports répartis sur 2 points d'entrée.
