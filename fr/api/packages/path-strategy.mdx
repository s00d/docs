...
description: "API exportée de @i18n-micro/path-strategy, générée à partir du code source."
---

# `@i18n-micro/path-strategy`

38 exports répartis sur 6 points d'entrée.
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 membre</summary>
...
<code>NoPrefixPathStrategy</code> — 36 membres, identique à `NoPrefixPathStrategy` ci-dessus.
<code>Strategy</code> — 36 membres, identique à `NoPrefixPathStrategy` ci-dessus.
...
<code>PrefixPathStrategy</code> — 36 membres, identique à `PrefixPathStrategy` ci-dessus.
<code>Strategy</code> — 36 membres, identique à `PrefixPathStrategy` ci-dessus.
...
<code>PrefixAndDefaultPathStrategy</code> — 37 membres, identique à `PrefixAndDefaultPathStrategy` ci-dessus.
<code>Strategy</code> — 37 membres, identique à `PrefixAndDefaultPathStrategy` ci-dessus.
...
<code>PrefixExceptDefaultPathStrategy</code> — 44 membres, identique à `PrefixExceptDefaultPathStrategy` ci-dessus.
<code>Strategy</code> — 44 membres, identique à `PrefixExceptDefaultPathStrategy` ci-dessus.
...
<code>PathStrategy</code> — 22 membres, identique à `PathStrategy` ci-dessus.
<code>PathStrategyContext</code> — 15 membres, identique à `PathStrategyContext` ci-dessus.
<code>ResolvedRouteLike</code> — 6 membres, identique à `ResolvedRouteLike` ci-dessus.
<code>RouteLike</code> — 6 membres, identique à `RouteLike` ci-dessus.
<code>RouterAdapter</code> — 3 membres, identique à `RouterAdapter` ci-dessus.
<code>SwitchLocaleOptions</code> — 1 membre, identique à `SwitchLocaleOptions` ci-dessus.
