...
description: "API publique du paquet @i18n-micro/path-strategy : résolution de chemin de locale à l'exécution, redirections et aides SEO, générés depuis le code source."
---
