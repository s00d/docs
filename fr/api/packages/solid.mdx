...
description: "API exportée de @i18n-micro/solid, générée à partir du code source."
---

# `@i18n-micro/solid`

33 exports sur 1 point d'entrée.
...
<code>SolidI18nOptions</code> — 6 membres, identique à [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 membre, identique à [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 membres, identique à [`UseI18nOptions`](/api/packages/preact).
