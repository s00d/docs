...
description: "API publique du paquet @i18n-micro/solid : signals SolidJS, composants et provider pour les traductions et le routage de locale, depuis le code source."
---

# `@i18n-micro/solid`

33 exports répartis sur 1 point d'entrée.
