...
description: "API exportée de @i18n-micro/vue, générée à partir du code source."
---

# `@i18n-micro/vue`

27 exports sur 1 point d'entrée.
...
<code>VueI18nOptions</code> — 6 membres, identique à [`PreactI18nOptions`](/api/packages/preact).
