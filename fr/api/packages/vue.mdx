...
description: "API publique du paquet @i18n-micro/vue : composables Vue 3, composants et plugin pour les traductions et le routage de locale, depuis le code source."
---

# `@i18n-micro/vue`

27 exports répartis sur 1 point d'entrée.
