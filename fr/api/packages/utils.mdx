...
description: "API exportée de @i18n-micro/utils, générée à partir du code source."
---

# `@i18n-micro/utils`

102 exports répartis sur 24 points d'entrée.
...
<code>SourceLocaleInfo</code> — 2 membres, identique à `PreMergeLocaleInfo` ci-dessus.
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 membre</summary>
...
<details>
<summary><code>TranslationStorageReader</code> — 1 membre</summary>
