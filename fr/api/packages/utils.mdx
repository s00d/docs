...
description: "API publique du paquet @i18n-micro/utils : aides de build, chargeur source, fusionneur et utilitaires de préfusion, générés depuis le code source au moment du build."
---
