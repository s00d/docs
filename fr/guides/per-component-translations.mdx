...
description: "Attachez des traductions à un composant ou une page spécifique avec $defineI18nRoute, en gardant les clés locales plutôt qu'en partageant des fichiers de locale globaux."
---
