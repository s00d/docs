...
description: "Déployez Nuxt I18n Micro sur Firebase AppHosting : corrigez les types MIME JSON, configurez les règles de route et gardez les traductions fonctionnelles en production."
---
