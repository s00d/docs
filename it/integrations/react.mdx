---
title: "Pacchetto React (`@i18n-micro/react`)"
description: "Usa @i18n-micro/react per aggiungere hook, componenti e un provider per traduzioni e routing consapevole della locale in app e framework React."
---
