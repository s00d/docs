---
title: "Pacchetto DevTools UI (`@i18n-micro/devtools-ui`)"
description: "Usa @i18n-micro/devtools-ui come UI DevTools autonoma e plugin Vite per esplorare le traduzioni e modificare le locale in qualsiasi progetto @i18n-micro."
---
