---
title: "Pacchetto Preact (`@i18n-micro/preact`)"
description: "Usa @i18n-micro/preact per aggiungere traduzioni, cambio di locale e routing consapevole della locale ad app Preact con un'esperienza da sviluppatore in stile Nuxt."
---
