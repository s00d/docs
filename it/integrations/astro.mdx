---
title: "Pacchetto Astro (`@i18n-micro/astro`)"
description: "Usa @i18n-micro/astro per aggiungere routing di locale, traduzioni e helper SEO ai progetti Astro con il runtime condiviso @i18n-micro/core."
---
