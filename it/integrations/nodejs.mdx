---
title: "Runtime Node.js con @i18n-micro/node"
description: "Usa @i18n-micro/node per caricare traduzioni e rilevare locale in server Node.js semplici, worker e CLI senza alcun framework UI collegato."
---
