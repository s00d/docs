---
title: "Pacchetto Vue (`@i18n-micro/vue`)"
description: "Usa @i18n-micro/vue per aggiungere composable, componenti e un plugin per traduzioni e routing consapevole della locale in app Vue 3 autonome."
---
