---
title: "Generatore di tipi per JSON di locale"
description: "Usa @i18n-micro/types-generator per emettere tipi TypeScript dai tuoi JSON di locale, offrendo a $t e agli helper autocompletamento e sicurezza completi."
---
