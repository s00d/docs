---
title: "Pacchetto Solid (`@i18n-micro/solid`)"
description: "Usa @i18n-micro/solid per aggiungere signal, componenti e un provider per traduzioni e routing consapevole della locale in applicazioni SolidJS."
---
