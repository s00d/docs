...
description: "API pubblica del pacchetto @i18n-micro/test-utils: helper Vitest, mock e fixture per testare il comportamento i18n, generati dal sorgente."
---

# `@i18n-micro/test-utils`

36 export su 2 entry point.
