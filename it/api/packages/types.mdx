...
description: "API pubblica del pacchetto @i18n-micro/types: definizioni TypeScript condivise usate tra le integrazioni di framework, generate dal sorgente."
---

# `@i18n-micro/types`

26 export su 1 entry point.
