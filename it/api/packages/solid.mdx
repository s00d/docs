...
description: "API pubblica del pacchetto @i18n-micro/solid: signal SolidJS, componenti e provider per traduzioni e routing di locale, dal sorgente."
---

# `@i18n-micro/solid`

33 export su 1 entry point.
...
<code>FormatService</code> — 19 members, identico a [`FormatService`](/api/packages/astro).
<details>
...
<code>Locale</code> — 11 members, identico a [`Locale`](/api/packages/types).
<code>ModuleOptions</code> — 47 members, identico a [`ModuleOptions`](/api/packages/types).
<details>
...
<code>SolidI18nOptions</code> — 6 members, identico a [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 members, identico a [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 members, identico a [`UseI18nOptions`](/api/packages/preact).
