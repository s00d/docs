...
description: "API pubblica del pacchetto @i18n-micro/preact: hook Preact, componenti e provider per traduzioni e routing, generati dal sorgente."
---

# `@i18n-micro/preact`

39 export su 1 entry point.
