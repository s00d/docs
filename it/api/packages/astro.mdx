...
description: "API pubblica del pacchetto @i18n-micro/astro: entry point di integrazione, tipi esportati e helper, generati dal sorgente in fase di build."
---

# `@i18n-micro/astro`

56 export su 6 entry point.
...
<code>I18nState</code> — 4 members, identico a `I18nClientProps` above.
