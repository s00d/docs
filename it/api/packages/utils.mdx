...
description: "API pubblica del pacchetto @i18n-micro/utils: helper di build, source loader, merger e utility di premerge, generati dal sorgente in fase di build."
---

# `@i18n-micro/utils`

102 export su 24 entry point.
...
<code>SourceLocaleInfo</code> — 2 members, identico a `PreMergeLocaleInfo` above.
