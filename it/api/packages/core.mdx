...
description: "API pubblica del pacchetto @i18n-micro/core: primitive runtime condivise e tipi che alimentano ogni integrazione di framework, generati dal sorgente."
---

# `@i18n-micro/core`

50 export su 3 entry point.
...
<code>MergeTranslationChunkOptions</code> — 1 members, identico a `MergeTranslationChunkOptions` sopra.
