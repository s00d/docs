...
description: "API pubblica del pacchetto @i18n-micro/node: adapter runtime Node.js, loader di traduzione e tipi esportati, generati dal sorgente."
---

# `@i18n-micro/node`

15 export su 1 entry point.
...
<code>LoadedTranslations</code> — 2 members, identico a [`LoadedTranslations`](/api/packages/astro).
