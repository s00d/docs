...
description: "API pubblica del pacchetto @i18n-micro/vue: composable Vue 3, componenti e plugin per traduzioni e routing di locale, dal sorgente."
---

# `@i18n-micro/vue`

27 export su 1 entry point.
...
<code>VueI18nOptions</code> — 6 members, identico a [`PreactI18nOptions`](/api/packages/preact).
