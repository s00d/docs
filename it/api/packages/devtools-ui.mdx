...
description: "API pubblica del pacchetto @i18n-micro/devtools-ui: pannello DevTools autonomo, plugin Vite ed helper esportati, generati dal sorgente."
---

# `@i18n-micro/devtools-ui`

25 export su 4 entry point.
...
<code>I18nDevToolsBridge</code> — 4 members, identico a `I18nDevToolsBridge` above.
<code>TranslationContent</code> — 1 members, identico a `TranslationContent` above.
...
<code>BridgeAdapter</code> — 6 members, identico a `BridgeAdapter` above.
<code>CreateBridgeOptions</code> — 4 members, identico a `CreateBridgeOptions` above.
