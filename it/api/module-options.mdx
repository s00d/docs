...
description: "Ogni opzione accettata dal modulo, con il suo tipo, il predefinito e lo scopo — letto in fase di build dalla definizione dei tipi."
---
...
Nulla qui è scritto a mano, quindi non può rimanere indietro rispetto al codice — tipi, predefiniti e
descrizioni provengono dalla dichiarazione stessa.

Per quanto riguarda cosa *significano* insieme queste opzioni — quali combinazioni hanno senso, cosa cambia quando
cambi strategia, esempi funzionanti — leggi [Configurazione](/guides/configuration). Questa
...
Come le traduzioni raggiungono il browser. [Prestazioni](/guides/performance) spiega cosa cambia a runtime.
...
Meta tag generati per ciascuna pagina localizzata.
...
Scelta di una locale per un visitatore che non ne ha scelta una.
...
- [Configurazione](/guides/configuration) — come funzionano insieme queste opzioni
- [Prestazioni](/guides/performance) — cosa cambiano le opzioni di payload a runtime
