---
title: "Guida all'integrazione con Storybook"
description: "Usa nuxt-i18n-micro con Storybook."
---

# 🌐 Guida all'integrazione con Storybook

## 📖 Introduzione

Integrare **Nuxt**, **Storybook** e **nuxt-i18n-micro** nel tuo progetto ti permette di costruire un'applicazione robusta e localizzata con un approccio di sviluppo orientato ai componenti. Questa guida fornisce una panoramica passo passo per configurare questi strumenti insieme, inclusa la configurazione, la localizzazione e l'integrazione con Storybook.
...
Per integrare Storybook con Nuxt e nuxt-i18n-micro, configura il file `.storybook/main.ts`, aggiungi `mergeTranslations` e `staticDirs`.
...
1. **[Esempio Nuxt + Storybook + i18n su GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Questo repository dimostra come integrare Nuxt, Storybook e nuxt-i18n-micro. Include istruzioni di configurazione e dettagli di configurazione.

2. **[Documentazione di Storybook per Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   La documentazione ufficiale per configurare Storybook con Nuxt. Fornisce passi dettagliati e best practice.

3. **[Esempio interattivo su StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Esplora un esempio dal vivo dell'integrazione tra Nuxt, Storybook e nuxt-i18n-micro direttamente nel tuo browser.
