---
title: "Comandi nuxt-i18n-micro-cli"
description: "Usa nuxt-i18n-micro-cli per estrarre chiavi dai template, convertire testo hardcoded in chiamate $t ed eseguire flussi di traduzione e sincronizzazione."
---
