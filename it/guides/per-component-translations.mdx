...
description: "Allega le traduzioni a un componente o pagina specifica con $defineI18nRoute, mantenendo le chiavi locali invece di condividere file di locale globali."
---
