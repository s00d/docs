---
title: "Risultati dei test di prestazione"
description: "Benchmark di prestazione che confrontano Nuxt I18n Micro con @nuxtjs/i18n: tempi di build, uso della memoria, dimensione del bundle e output dei payload."
---
