...
description: "Guida alle prestazioni per Nuxt I18n Micro: perché le build sono più veloci, metodologia di benchmark, suggerimenti di ottimizzazione e ottimizzazioni dei payload serverless."
---
