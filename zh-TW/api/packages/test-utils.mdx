...
description: "@i18n-micro/test-utils 套件的公開 API：用於測試 i18n 行為的 Vitest 輔助工具、mock 與 fixture，由原始碼產生。"
---
...
<details>
<summary><code>ExportTarget</code>：3 個成員</summary>
