...
description: "@i18n-micro/astro 套件的公開 API：整合入口、匯出型別與輔助工具，於建置期由原始碼產生。"
---
...
| 匯出項目 | 類型 | 型別簽章 |
| --- | --- | --- |
| `AstroI18n` | class | 48 個成員 |
| `AstroI18nOptions` | interface | 9 個成員 |
...
| `I18nClientProps` | interface | 4 個成員 |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 個成員 |
| `I18nMiddlewareOptions` | interface | 7 個成員 |
| `I18nRoutingStrategy` | interface | 10 個成員 |
...
| `LoadTranslationsOptions` | interface | 3 個成員 |
| `Locale` | interface | 11 個成員 |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 個成員 |
| `LocaleHeadResult` | interface | 3 個成員 |
...
<details>
<summary><code>AstroI18n</code>：48 個成員</summary>
...
<details>
<summary><code>AstroI18nOptions</code>：9 個成員</summary>
...
<details>
<summary><code>FormatService</code>：19 個成員</summary>
...
<details>
<summary><code>I18nClientProps</code>：4 個成員</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code>：53 個成員</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code>：7 個成員</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code>：10 個成員</summary>
...
<details>
<summary><code>LoadedTranslations</code>：2 個成員</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code>：3 個成員</summary>
...
<details>
<summary><code>LocaleHeadOptions</code>：4 個成員</summary>
...
<details>
<summary><code>LocaleHeadResult</code>：3 個成員</summary>
