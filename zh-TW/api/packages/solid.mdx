...
description: "@i18n-micro/solid 套件的公開 API：用於翻譯與語系路由的 SolidJS signal、元件與 provider，由原始碼產生。"
---
...
| `SolidI18n` | class | 53 個成員 |
| `SolidI18nOptions` | interface | 6 個成員 |
...
<details>
<summary><code>I18nProviderProps</code>：4 個成員</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code>：7 個成員</summary>
...
<details>
<summary><code>SolidI18n</code>：53 個成員</summary>
