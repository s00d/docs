...
description: "@i18n-micro/path-strategy パッケージのパブリック API: runtime locale path resolution, redirects, and SEO helpers。ソースから生成されています。"
---

# `@i18n-micro/path-strategy`

38 個のエクスポート、6 個のエントリーポイントにわたります。
...
<details>
<summary><code>BasePathStrategy</code> — 36 メンバー</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2 メンバー</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2 メンバー</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36 メンバー</summary>
...
<details>
<summary><code>PathStrategy</code> — 22 メンバー</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15 メンバー</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37 メンバー</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44 メンバー</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36 メンバー</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6 メンバー</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2 メンバー</summary>
...
<details>
<summary><code>RouteLike</code> — 6 メンバー</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3 メンバー</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 メンバー</summary>
...
<code>NoPrefixPathStrategy</code> — 36 メンバー、上記の `NoPrefixPathStrategy` と同一です。
<code>Strategy</code> — 36 メンバー、上記の `NoPrefixPathStrategy` と同一です。
...
<code>PrefixPathStrategy</code> — 36 メンバー、上記の `PrefixPathStrategy` と同一です。
<code>Strategy</code> — 36 メンバー、上記の `PrefixPathStrategy` と同一です。
...
<code>PrefixAndDefaultPathStrategy</code> — 37 メンバー、上記の `PrefixAndDefaultPathStrategy` と同一です。
<code>Strategy</code> — 37 メンバー、上記の `PrefixAndDefaultPathStrategy` と同一です。
...
<code>PrefixExceptDefaultPathStrategy</code> — 44 メンバー、上記の `PrefixExceptDefaultPathStrategy` と同一です。
<code>Strategy</code> — 44 メンバー、上記の `PrefixExceptDefaultPathStrategy` と同一です。
...
<code>PathStrategy</code> — 22 メンバー、上記の `PathStrategy` と同一です。
<code>PathStrategyContext</code> — 15 メンバー、上記の `PathStrategyContext` と同一です。
<code>ResolvedRouteLike</code> — 6 メンバー、上記の `ResolvedRouteLike` と同一です。
<code>RouteLike</code> — 6 メンバー、上記の `RouteLike` と同一です。
<code>RouterAdapter</code> — 3 メンバー、上記の `RouterAdapter` と同一です。
<code>SwitchLocaleOptions</code> — 1 メンバー、上記の `SwitchLocaleOptions` と同一です。
