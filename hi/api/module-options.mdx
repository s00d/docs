---
title: "मॉड्यूल विकल्प संदर्भ"
description: "हर Nuxt I18n Micro मॉड्यूल विकल्प का संदर्भ: प्रकार, डिफ़ॉल्ट मान, और उद्देश्य, जो TypeScript परिभाषाओं से बिल्ड समय पर उत्पन्न होता है।"
---
...
you switch strategy, worked examples — read [Configuration](/guides/configuration). This
...
- [Package APIs](/api/packages/overview) — the exported API of every workspace package
