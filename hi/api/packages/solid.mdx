...
description: "Public API of the @i18n-micro/solid package: SolidJS signals, components, and provider for translations and locale routing, from source."
---

# `@i18n-micro/solid`

1 एंट्री पॉइंट में 33 एक्सपोर्ट्स।
...
| `SolidI18n` | class | 53 सदस्य |
| `SolidI18nOptions` | interface | 6 सदस्य |
...
<details>
<summary><code>I18nProviderProps</code> — 4 सदस्य</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 सदस्य</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 सदस्य</summary>
...
<code>SolidI18nOptions</code> — 6 सदस्य, [`PreactI18nOptions`](/api/packages/preact) के समान।
<code>Translations</code> — 1 सदस्य, [`Translations`](/api/packages/types) के समान।
<code>UseI18nOptions</code> — 2 सदस्य, [`UseI18nOptions`](/api/packages/preact) के समान।
