...
description: "@i18n-micro/test-utils पैकेज का सार्वजनिक API: i18n व्यवहार के परीक्षण के लिए Vitest हेल्पर्स, mocks, और fixtures, सोर्स से जनरेट किए गए।"
---

# `@i18n-micro/test-utils`

2 एंट्री पॉइंट्स में 36 एक्सपोर्ट्स।
...
| एक्सपोर्ट | प्रकार | हस्ताक्षर |
| --- | --- | --- |
| `ExportTarget` | interface | 3 सदस्य |
...
<details>
<summary><code>ExportTarget</code> — 3 सदस्य</summary>
