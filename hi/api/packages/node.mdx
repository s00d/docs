...
description: "@i18n-micro/node पैकेज का सार्वजनिक API: Node.js रनटाइम एडेप्टर, ट्रांसलेशन लोडर्स, और एक्सपोर्ट किए गए टाइप्स, सोर्स से जनरेट किए गए।"
---

# `@i18n-micro/node`

1 एंट्री पॉइंट में 15 एक्सपोर्ट्स।
...
<details>
<summary><code>I18n</code> — 46 सदस्य</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 सदस्य</summary>
...
<code>LoadedTranslations</code> — 2 सदस्य, [`LoadedTranslations`](/api/packages/astro) के समान।
