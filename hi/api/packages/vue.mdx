...
1 एंट्री पॉइंट में 27 एक्सपोर्ट्स।
...
| `UseLocaleHeadOptions` | interface | 5 सदस्य |
| `VueI18n` | class | 51 सदस्य |
| `VueI18nOptions` | interface | 6 सदस्य |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 सदस्य</summary>
...
<details>
<summary><code>VueI18n</code> — 51 सदस्य</summary>
...
<code>VueI18nOptions</code> — 6 सदस्य, [`PreactI18nOptions`](/api/packages/preact) के समान।
