...
description: "@i18n-micro/route-strategy पैकेज का सार्वजनिक API: Nuxt पेजों के लिए बिल्ड-टाइम लोकेलाइज़्ड रूट जनरेशन, सोर्स से जनरेट किए गए।"
---

# `@i18n-micro/route-strategy`

1 एंट्री पॉइंट में 18 एक्सपोर्ट्स।
...
| `RouteGenerator` | class | 23 सदस्य |
| `RouteGeneratorOptions` | interface | 11 सदस्य |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 सदस्य</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 सदस्य</summary>
