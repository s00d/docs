...
description: "Public API of the @i18n-micro/utils package: build helpers, source loader, merger, and premerge utilities, generated from source at build time."
---

# `@i18n-micro/utils`

24 एंट्री पॉइंट्स में 102 एक्सपोर्ट्स।
...
| `PreMergeLocaleInfo` | interface | 2 सदस्य |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 सदस्य</summary>
...
| `CacheControlOptions` | interface | 2 सदस्य |

<details>
<summary><code>CacheControl</code> — 13 सदस्य</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 सदस्य</summary>
...
| एक्सपोर्ट | प्रकार | हस्ताक्षर |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 सदस्य |
...
| `MergeI18nHeadOptions` | interface | 3 सदस्य |

<details>
<summary><code>I18nHeadObject</code> — 3 सदस्य</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 सदस्य</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 सदस्य |
...
| `SourceLocaleInfo` | interface | 2 सदस्य |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 सदस्य</summary>
...
<code>SourceLocaleInfo</code> — 2 सदस्य, ऊपर बताए गए `PreMergeLocaleInfo` के समान।
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 सदस्य</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 सदस्य |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 सदस्य |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 सदस्य |
| `TranslationPayloadStats` | interface | 2 सदस्य |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 सदस्य</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 सदस्य</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 सदस्य</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 सदस्य</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 सदस्य |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 सदस्य</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 सदस्य |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 सदस्य</summary>
...
| एक्सपोर्ट | प्रकार | हस्ताक्षर |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 सदस्य |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 सदस्य |

<details>
<summary><code>HreflangAlternate</code> — 2 सदस्य</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 सदस्य</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 सदस्य |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 सदस्य |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 सदस्य</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 सदस्य</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 सदस्य |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 सदस्य</summary>
...
| `I18nRouteContext` | interface | 3 सदस्य |
...
<details>
<summary><code>I18nRouteContext</code> — 3 सदस्य</summary>
...
| `RuntimeI18nOverrides` | interface | 4 सदस्य |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 सदस्य</summary>
...
| `TranslationStorageReader` | interface | 1 सदस्य |

<details>
<summary><code>TranslationStorageReader</code> — 1 सदस्य</summary>
...
| एक्सपोर्ट | प्रकार | हस्ताक्षर |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 सदस्य |
| `SplitLocaleRoutePage` | interface | 3 सदस्य |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 सदस्य |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 सदस्य</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 सदस्य</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 सदस्य</summary>
