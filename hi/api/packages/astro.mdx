...
description: "Public API of the @i18n-micro/astro package: integration entry point, exported types, and helpers, generated from the source at build time."
---

# `@i18n-micro/astro`

6 एंट्री पॉइंट्स में 56 एक्सपोर्ट्स।
...
| --- | --- | --- |
| `AstroI18n` | class | 48 सदस्य |
| `AstroI18nOptions` | interface | 9 सदस्य |
...
| `I18nClientProps` | interface | 4 सदस्य |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 सदस्य |
| `I18nMiddlewareOptions` | interface | 7 सदस्य |
| `I18nRoutingStrategy` | interface | 10 सदस्य |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 सदस्य |
...
| `LoadTranslationsOptions` | interface | 3 सदस्य |
| `Locale` | interface | 11 सदस्य |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 सदस्य |
| `LocaleHeadResult` | interface | 3 सदस्य |
...
<details>
<summary><code>AstroI18n</code> — 48 सदस्य</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 सदस्य</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 सदस्य</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 सदस्य</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 सदस्य</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 सदस्य</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 सदस्य</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 सदस्य</summary>
...
<code>Locale</code> — 11 सदस्य, [`Locale`](/api/packages/types) के समान।
<details>
<summary><code>LocaleHeadOptions</code> — 4 सदस्य</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 सदस्य</summary>
...
<code>Translations</code> — 1 सदस्य, [`Translations`](/api/packages/types) के समान।
...
<code>I18nState</code> — 4 सदस्य, ऊपर बताए गए `I18nClientProps` के समान।
