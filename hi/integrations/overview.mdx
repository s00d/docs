---
title: "फ़्रेमवर्क एकीकरण अवलोकन"
description: "Vue, React, Preact, SolidJS, Astro, और Node.js के लिए @i18n-micro फ़्रेमवर्क एकीकरण का अवलोकन, जो एक अनुवाद रनटाइम साझा करते हैं।"
---
