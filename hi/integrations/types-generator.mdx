---
title: "लोकेल JSON के लिए टाइप्स जनरेटर"
description: "अपने लोकेल JSON से TypeScript प्रकार उत्सर्जित करने के लिए @i18n-micro/types-generator का उपयोग करें, $t और हेल्पर्स को पूर्ण ऑटोकम्प्लीशन और सुरक्षा प्रदान करते हुए।"
---
