---
title: "Vue पैकेज (`@i18n-micro/vue`)"
description: "स्टैंडअलोन Vue 3 ऐप्स में अनुवाद और लोकेल-जागरूक रूटिंग के लिए कम्पोज़ेबल्स, कंपोनेंट्स, और एक प्लगइन जोड़ने के लिए @i18n-micro/vue का उपयोग करें।"
---
