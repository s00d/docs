---
title: "Astro पैकेज (`@i18n-micro/astro`)"
description: "साझा @i18n-micro/core रनटाइम के साथ Astro प्रोजेक्ट्स में लोकेल रूटिंग, अनुवाद, और SEO हेल्पर्स जोड़ने के लिए @i18n-micro/astro का उपयोग करें।"
---
