---
title: "@i18n-micro/node के साथ Node.js रनटाइम"
description: "बिना किसी UI फ़्रेमवर्क के सादे Node.js सर्वर, वर्कर्स, और CLIs में अनुवाद लोड करने और लोकेल्स का पता लगाने के लिए @i18n-micro/node का उपयोग करें।"
---
