---
title: "DevTools UI पैकेज (`@i18n-micro/devtools-ui`)"
description: "किसी भी @i18n-micro प्रोजेक्ट में अनुवाद ब्राउज़ करने और लोकेल्स संपादित करने के लिए @i18n-micro/devtools-ui को स्टैंडअलोन DevTools UI और Vite प्लगइन के रूप में उपयोग करें।"
---
