---
title: "Preact पैकेज (`@i18n-micro/preact`)"
description: "Nuxt जैसे डेवलपर अनुभव के साथ Preact ऐप्स में अनुवाद, लोकेल स्विचिंग, और लोकेल-जागरूक रूटिंग जोड़ने के लिए @i18n-micro/preact का उपयोग करें।"
---
