---
title: "React पैकेज (`@i18n-micro/react`)"
description: "React ऐप्स और फ़्रेमवर्क्स में अनुवाद और लोकेल-जागरूक रूटिंग के लिए हुक्स, कंपोनेंट्स, और एक प्रदाता जोड़ने के लिए @i18n-micro/react का उपयोग करें।"
---
