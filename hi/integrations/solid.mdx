---
title: "Solid पैकेज (`@i18n-micro/solid`)"
description: "SolidJS अनुप्रयोगों में अनुवाद और लोकेल-जागरूक रूटिंग के लिए सिग्नल्स, कंपोनेंट्स, और एक प्रदाता जोड़ने के लिए @i18n-micro/solid का उपयोग करें।"
---
