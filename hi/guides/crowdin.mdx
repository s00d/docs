...
description: "Nuxt I18n Micro को Crowdin से जोड़ें: crowdin.yml कॉन्फ़िगर करें, स्रोत और अनुवाद फ़ाइलें सिंक करें, और स्थानीयकरण वर्कफ़्लो को स्वचालित करें।"
---
