...
description: "सभी nuxt-i18n-micro मॉड्यूल विकल्प, डिफ़ॉल्ट्स, और उदाहरण।"
---

# कॉन्फ़िगरेशन संदर्भ

`nuxt.config` में `i18n` कुंजी के अंतर्गत हर विकल्प के लिए पूर्ण संदर्भ। टाइप्स और डिफ़ॉल्ट्स `@i18n-micro/types` में [`ModuleOptions`](https://github.com/s00d/nuxt-i18n-micro/blob/main/packages/types/src/index.ts) से मेल खाते हैं।

## त्वरित संदर्भ

`ModuleOptions` टाइप से मॉड्यूल द्वारा स्वीकार किया गया हर विकल्प। नीचे दिए गए अनुभाग यह समझाते हैं
नीचे दिए गए अनुभाग यह समझाते हैं कि वे एक साथ कैसे काम करते हैं; [Module Options संदर्भ](/api/module-options) में पूरा विवरण है।
