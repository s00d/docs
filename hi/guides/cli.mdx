---
title: "nuxt-i18n-micro-cli कमांड्स"
description: "टेम्पलेट्स से कीज़ निकालने, हार्डकोडेड टेक्स्ट को $t कॉल्स में बदलने, और अनुवाद व सिंक वर्कफ़्लो चलाने के लिए nuxt-i18n-micro-cli का उपयोग करें।"
---
