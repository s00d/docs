---
title: "कस्टम भाषा पहचान"
description: "हेडर, कुकीज़, जियोलोकेशन, या कस्टम उपयोगकर्ता डेटा पढ़ने के लिए useI18nLocale के साथ Nuxt I18n Micro की अंतर्निहित लोकेल पहचान को ओवरराइड करें।"
---
