---
title: "स्थैतिक फ़ाइलों को i18n रूटिंग से बाहर रखना"
description: "स्थैतिक संपत्तियों, साइटमैप्स, और API रूट्स को Nuxt I18n Micro लोकेल रूटिंग से बाहर रखें ताकि वे बिना किसी लोकेल उपसर्ग के परोसे जाएँ।"
---
