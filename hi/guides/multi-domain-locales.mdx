---
title: "Nuxt लेयर्स के साथ मल्टी-डोमेन लोकेल्स"
description: "मल्टी-डोमेन सेटअप को लेयर्ड कॉन्फ़िगरेशन और प्रति-लोकेल होस्ट्स के साथ जोड़कर Nuxt I18n Micro के साथ प्रत्येक लोकेल को उसके स्वयं के डोमेन पर परोसें।"
---
