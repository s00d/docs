---
title: "Nuxt लेयर्स के साथ लोकेल सेटिंग्स"
description: "लोकेल सेटिंग्स संयोजित करने, प्रति अनुभाग डिफ़ॉल्ट्स ओवरराइड करने, और पुन: प्रयोज्य आधार कॉन्फ़िगरेशन साझा करने के लिए Nuxt I18n Micro के साथ Nuxt लेयर्स का उपयोग करें।"
---
