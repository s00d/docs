...
description: "लोकेल्स ब्राउज़ करने, अनुवाद JSON संपादित करने, कीज़ का निरीक्षण करने, और चल रहे ऐप में लाइव अपडेट का पूर्वावलोकन करने के लिए अंतर्निहित DevTools पैनल का उपयोग करें।"
---
