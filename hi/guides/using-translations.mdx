---
title: "कंपोनेंट्स में अनुवाद का उपयोग"
description: "Nuxt I18n Micro रूट और पेज-विशिष्ट लोकेल फ़ाइलों के साथ Vue कंपोनेंट्स, टेम्पलेट्स, और स्क्रिप्ट्स में $t, $ts, और अनुवाद हेल्पर्स का उपयोग करें।"
---
