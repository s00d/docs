---
title: "localeRoutes के साथ कस्टम स्थानीयकृत रूट्स"
description: "$defineI18nRoute और localeRoutes के साथ Nuxt I18n Micro में प्रति-लोकेल रूट पथ परिभाषित करें ताकि URL भाषाओं और स्लग्स में भिन्न हो सकें।"
---
