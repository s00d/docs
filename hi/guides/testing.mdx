---
title: "Nuxt I18n Micro मॉड्यूल्स का परीक्षण"
description: "Vitest और @i18n-micro/test-utils के साथ Nuxt I18n Micro ऐप्स का परीक्षण करें: मॉड्यूल को मॉक करें, रणनीतियों को कवर करें, और कंपोनेंट अनुवादों की जाँच करें।"
---
