---
title: "Storybook एकीकरण गाइड"
description: "Nuxt I18n Micro को Storybook के साथ एकीकृत करें: @nuxtjs/storybook कॉन्फ़िगर करें, लोकेल नियंत्रण जोड़ें, और भाषाओं में कंपोनेंट्स का पूर्वावलोकन करें।"
---
