---
title: "Firebase AppHosting डिप्लॉयमेंट"
description: "Nuxt I18n Micro को Firebase AppHosting पर डिप्लॉय करें: JSON MIME प्रकार ठीक करें, रूट नियम कॉन्फ़िगर करें, और प्रोडक्शन में अनुवाद कार्यशील रखें।"
---
