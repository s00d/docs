...
description: "Every Nuxt I18n Micro module option with default values, types, and examples: locales, strategy, meta, translation directory, and more."
---
...
Na przykład, `\{ 'about-us': 'about' \}` means the `about-us` page will use
...
**Formula for estimating max entries**: `number_of_locales × (number_of_pages + 1)`. Na przykład, 10 locales × 500 pages = ~5010 entries.
</Tip>
