---
title: "Przewodnik integracji Storybook"
description: "Zintegruj Nuxt I18n Micro ze Storybook: skonfiguruj @nuxtjs/storybook, dodaj kontrolki lokalizacji i podglądaj komponenty w różnych językach."
---

# 🌐 Przewodnik integracji Storybook

## 📖 Wprowadzenie

Integracja **Nuxt**, **Storybook** i **nuxt-i18n-micro** w Twoim projekcie pozwala budować solidną, zlokalizowaną aplikację w podejściu component-driven development. Ten przewodnik przeprowadzi Cię krok po kroku przez konfigurację tych narzędzi razem, w tym konfigurację, lokalizację i integrację ze Storybook.

## 🛠 Konfiguracja Nuxt

Aby włączyć lokalizację i Storybook w projekcie Nuxt, skonfiguruj plik `nuxt.config.ts` w następujący sposób:
...
Aby zintegrować Storybook z Nuxt i nuxt-i18n-micro, skonfiguruj plik `.storybook/main.ts`, dodaj `mergeTranslations` i `staticDirs`.
...
Kompletne przykłady znajdziesz w tych projektach:

1. **[Nuxt + Storybook + i18n Example na GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
...
2. **[Dokumentacja Storybook dla Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   Oficjalna dokumentacja konfiguracji Storybook z Nuxt. Zapewnia szczegółowe kroki i najlepsze praktyki.

3. **[Interaktywny przykład na StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Sprawdź na żywo przykład integracji Nuxt, Storybook i nuxt-i18n-micro bezpośrednio w przeglądarce.
