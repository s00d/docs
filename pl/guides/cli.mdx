---
title: "nuxt-i18n-micro-cli commands"
description: "Use the nuxt-i18n-micro-cli to extract keys from templates, convert hardcoded text to $t calls, and run translation and sync workflows."
---
...
Use capturing groups to dynamically insert part of the matched string into the replacement. Na przykład, replace "Hello [name]" with "Hi [name]" while keeping the name intact:
