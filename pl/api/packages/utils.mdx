...
description: "Publiczne API pakietu @i18n-micro/utils: helpery build, source loader, merger i narzędzia premerge, generowane ze źródeł w czasie budowy."
---

# `@i18n-micro/utils`

102 eksportów w 24 punktach wejścia.
...
| `PreMergeLocaleInfo` | interface | 2 członków |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 członków</summary>
...
| `CacheControlOptions` | interface | 2 członków |

<details>
<summary><code>CacheControl</code> — 13 członków</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 członków</summary>
...
| Eksport | Rodzaj | Sygnatura |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 członków |
...
| `MergeI18nHeadOptions` | interface | 3 członków |

<details>
<summary><code>I18nHeadObject</code> — 3 członków</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 członków</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 członków |
...
| `SourceLocaleInfo` | interface | 2 członków |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 członków</summary>
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 członków</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 członków |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 członków |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 członków |
| `TranslationPayloadStats` | interface | 2 członków |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 członków</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 członków</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 członków</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 członków</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 członków |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 członków</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 członków |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 członków</summary>
...
| Eksport | Rodzaj | Sygnatura |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 członków |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 członków |

<details>
<summary><code>HreflangAlternate</code> — 2 członków</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 członków</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 członków |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 członków |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 członków</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 członków</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 członków |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 członków</summary>
...
| `I18nRouteContext` | interface | 3 członków |
...
<details>
<summary><code>I18nRouteContext</code> — 3 członków</summary>
...
| `RuntimeI18nOverrides` | interface | 4 członków |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 członków</summary>
...
| `TranslationStorageReader` | interface | 1 członków |

<details>
<summary><code>TranslationStorageReader</code> — 1 członków</summary>
...
| Eksport | Rodzaj | Sygnatura |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 członków |
| `SplitLocaleRoutePage` | interface | 3 członków |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 członków |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 członków</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 członków</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 członków</summary>
