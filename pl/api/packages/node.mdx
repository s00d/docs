...
description: "Publiczne API pakietu @i18n-micro/node: adapter runtime Node.js, loadery tłumaczeń i eksportowane typy, generowane ze źródeł."
---

# `@i18n-micro/node`

15 eksportów w 1 punktcie wejścia.
...
| `I18n` | class | 46 członków |
| `I18nOptions` | interface | 7 członków |
...
<details>
<summary><code>I18n</code> — 46 członków</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 członków</summary>
