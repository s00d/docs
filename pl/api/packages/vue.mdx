...
description: "Publiczne API pakietu @i18n-micro/vue: composables Vue 3, komponenty i plugin dla tłumaczeń oraz routingu lokalizacji, ze źródeł."
---

# `@i18n-micro/vue`

27 eksportów w 1 punktcie wejścia.
...
| `UseLocaleHeadOptions` | interface | 5 członków |
| `VueI18n` | class | 51 członków |
| `VueI18nOptions` | interface | 6 członków |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 członków</summary>
...
<details>
<summary><code>VueI18n</code> — 51 członków</summary>
