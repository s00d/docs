...
description: "Publiczne API pakietu @i18n-micro/solid: sygnały SolidJS, komponenty i provider dla tłumaczeń oraz routingu lokalizacji, ze źródeł."
---

# `@i18n-micro/solid`

33 eksportów w 1 punktcie wejścia.
...
| `SolidI18n` | class | 53 członków |
| `SolidI18nOptions` | interface | 6 członków |
...
<details>
<summary><code>I18nProviderProps</code> — 4 członków</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 członków</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 członków</summary>
