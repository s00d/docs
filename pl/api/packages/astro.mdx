...
description: "Publiczne API pakietu @i18n-micro/astro: punkt wejścia integracji, eksportowane typy i helpery, generowane ze źródeł w czasie budowy."
---

# `@i18n-micro/astro`

56 eksportów w 6 punktach wejścia.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 członków |
| `AstroI18nOptions` | interface | 9 członków |
...
| `FormatService` | class | 19 członków |
...
| `I18nClientProps` | interface | 4 członków |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 członków |
| `I18nMiddlewareOptions` | interface | 7 członków |
| `I18nRoutingStrategy` | interface | 10 członków |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 członków |
...
| `LoadTranslationsOptions` | interface | 3 członków |
| `Locale` | interface | 11 członków |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 członków |
| `LocaleHeadResult` | interface | 3 członków |
...
| `Translations` | interface | 1 członków |
...
<details>
<summary><code>AstroI18n</code> — 48 członków</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 członków</summary>
...
<details>
<summary><code>FormatService</code> — 19 członków</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 członków</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 członków</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 członków</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 członków</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 członków</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 członków</summary>
...
<details>
<summary><code>LocaleHeadOptions</code> — 4 członków</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 członków</summary>
...
| `I18nState` | interface | 4 członków |
