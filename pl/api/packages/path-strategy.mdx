...
description: "Publiczne API pakietu @i18n-micro/path-strategy: runtime'owe rozwiązywanie ścieżek lokalizacji, przekierowania i helpery SEO, generowane ze źródeł."
---

# `@i18n-micro/path-strategy`

38 eksportów w 6 punktach wejścia.
...
| `BasePathStrategy` | class | 36 członków |
...
| `GetRouteBaseNameOptions` | interface | 2 członków |
...
| `IsIndexRouteNameOptions` | interface | 2 członków |
| `NoPrefixPathStrategy` | class | 36 członków |
...
| `PathStrategy` | interface | 22 członków |
| `PathStrategyContext` | interface | 15 członków |
| `PrefixAndDefaultPathStrategy` | class | 37 członków |
| `PrefixExceptDefaultPathStrategy` | class | 44 członków |
| `PrefixPathStrategy` | class | 36 członków |
| `ResolvedRouteLike` | interface | 6 członków |
| `resolvePathWithParams` | function | `(path: string, params?: Record<string, unknown>) => string` |
| `RouteAnalysis` | interface | 2 członków |
| `RouteLike` | interface | 6 członków |
| `RouterAdapter` | interface | 3 członków |
| `SwitchLocaleOptions` | interface | 1 członków |

<details>
<summary><code>BasePathStrategy</code> — 36 członków</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2 członków</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2 członków</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36 członków</summary>
...
<details>
<summary><code>PathStrategy</code> — 22 członków</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15 członków</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37 członków</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44 członków</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36 członków</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6 członków</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2 członków</summary>
...
<details>
<summary><code>RouteLike</code> — 6 członków</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3 członków</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 członków</summary>
