...
description: "Publiczne API pakietu @i18n-micro/test-utils: helpery Vitest, mocki i fixture do testowania zachowania i18n, generowane ze źródeł."
---

# `@i18n-micro/test-utils`

36 eksportów w 2 punktach wejścia.
...
| Eksport | Rodzaj | Sygnatura |
| --- | --- | --- |
| `ExportTarget` | interface | 3 członków |
...
<details>
<summary><code>ExportTarget</code> — 3 członków</summary>
