...
description: "Publiczne API pakietu @i18n-micro/route-strategy: generowanie zlokalizowanych tras w czasie budowy dla stron Nuxt, generowane ze źródeł."
---

# `@i18n-micro/route-strategy`

18 eksportów w 1 punktcie wejścia.
...
| `RouteGenerator` | class | 23 członków |
| `RouteGeneratorOptions` | interface | 11 członków |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 członków</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 członków</summary>
