...
description: "Publiczne API pakietu @i18n-micro/core: współdzielone prymitywy runtime i typy zasilające każdą integrację frameworkową, generowane ze źródeł."
---

# `@i18n-micro/core`

50 eksportów w 3 punktach wejścia.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 członków |
| `BaseI18nOptions` | interface | 7 członków |
...
| `FormatServiceOptions` | interface | 2 członków |
...
| `MergeTranslationChunkOptions` | interface | 1 członków |
...
| `ReactiveI18nStore` | interface | 9 członków |
...
| `TranslationStorage` | interface | 1 członków |
...
<details>
<summary><code>BaseI18n</code> — 34 członków</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 członków</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 członków</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 członków</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 członków</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 członków</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 członków |
...
| `I18nDevtoolsInspectorNode` | interface | 4 członków |
| `I18nDevtoolsStateSnapshot` | interface | 7 członków |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 członków</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 członków</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 członków</summary>
