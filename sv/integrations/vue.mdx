...
description: "Använd @i18n-micro/vue för att lägga till composables, komponenter och en plugin för översättningar och lokalmedveten routing i fristående Vue 3-appar."
---
