---
title: "Node.js-runtime med @i18n-micro/node"
description: "Använd @i18n-micro/node för att ladda översättningar och upptäcka lokaler i vanliga Node.js-servrar, workers och CLI:er utan något UI-ramverk bifogat."
---
