...
description: "Använd @i18n-micro/react för att lägga till hooks, komponenter och en provider för översättningar och lokalmedveten routing i React-appar och ramverk."
---
