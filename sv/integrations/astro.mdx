...
description: "Använd @i18n-micro/astro för att lägga till lokal-routing, översättningar och SEO-hjälpare till Astro-projekt med den delade @i18n-micro/core-runtime."
---
