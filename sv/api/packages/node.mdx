...
description: "Publikt API för paketet @i18n-micro/node: Node.js-runtime-adapter, översättningsladdare och exporterade typer, genererad från källkod."
---

# `@i18n-micro/node`

15 exporter över 1 ingångspunkt.
...
<details>
<summary><code>I18n</code> — 46 medlemmar</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 medlemmar</summary>
...
<code>LoadedTranslations</code> — 2 medlemmar, identiskt med [`LoadedTranslations`](/api/packages/astro).
