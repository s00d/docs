...
description: "Publikt API för paketet @i18n-micro/route-strategy: generering av lokaliserade rutter vid byggtid för Nuxt-sidor, genererad från källkod."
---

# `@i18n-micro/route-strategy`

18 exporter över 1 ingångspunkt.
...
<details>
<summary><code>RouteGenerator</code> — 23 medlemmar</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 medlemmar</summary>
