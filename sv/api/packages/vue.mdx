...
description: "Publikt API för paketet @i18n-micro/vue: Vue 3-composables, komponenter och plugin för översättningar och lokal-routing, från källkod."
---

# `@i18n-micro/vue`

27 exporter över 1 ingångspunkt.
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 medlemmar</summary>
...
<details>
<summary><code>VueI18n</code> — 51 medlemmar</summary>
...
<code>VueI18nOptions</code> — 6 medlemmar, identiskt med [`PreactI18nOptions`](/api/packages/preact).
