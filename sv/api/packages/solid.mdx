...
description: "Publikt API för paketet @i18n-micro/solid: SolidJS-signals, komponenter och provider för översättningar och lokal-routing, från källkod."
---

# `@i18n-micro/solid`

33 exporter över 1 ingångspunkt.
...
<details>
<summary><code>I18nProviderProps</code> — 4 medlemmar</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 medlemmar</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 medlemmar</summary>
...
<code>SolidI18nOptions</code> — 6 medlemmar, identiskt med [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 medlem, identiskt med [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 medlemmar, identiskt med [`UseI18nOptions`](/api/packages/preact).
