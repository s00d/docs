---
title: "Node.js runtime with @i18n-micro/node"
description: "Use @i18n-micro/node to load translations and detect locales in plain Node.js servers, workers, and CLIs without any UI framework attached."
---
