---
title: "Types generator for locale JSON"
description: "Use @i18n-micro/types-generator to emit TypeScript types from your locale JSON, giving $t and helpers full autocompletion and safety."
---
