---
title: "Metódusok"
description: "Az összes nuxt-i18n-micro futásidejű metódus."
---

# 🛠️ Metódusok

Ez az oldal a `nuxt-i18n-micro` által biztosított összes elérhető metódust dokumentálja. A metódusok funkcionalitás szerint vannak csoportosítva a könnyebb navigáció érdekében.

## 📊 API áttekintés

Minden segéd, amit a plugin injektál, a `PluginsInjections` interfészből olvasva — így ez a
lista nem térhet el a ténylegesen elérhetőtől.

{/* generated:methods-index — do not edit; run `pnpm run docs:generate` */}

| Segéd | Szignatúra | Cél |
| --- | --- | --- |
...
A feloldott modul-konfiguráció úgy, ahogy a futásidő látja.
...
Build-időben vagy Nuxton kívüli környezetben inkább a `#build/i18n.strategy.mjs`-ből származó `getI18nConfig()`-ot használd.
...
Metódusok a területi információk lekéréséhez és kezeléséhez.
...
Minden konfigurált terület, a metaadataival együtt.
...
A konfigurált alapértelmezett terület kódja.
...
A fordítások lekérésének és kezelésének fő metódusai.
...
Metódusok számok és dátumok formázásához a területi konvenciók szerint.
...
## 🔄 Útvonal- és területváltás

Metódusok területek és útvonalak közötti váltáshoz.
...
Metódusok területspecifikus útvonalak és útvonalpaths generálásához.
...
### Használat useI18n composable-lel
