...
description: "Az @i18n-micro/utils exportált API-ja, a forrásból generálva."
---

# `@i18n-micro/utils`

102 export 24 belépési ponton át.
...
| `PreMergeLocaleInfo` | interface | 2 tag |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 tag</summary>
...
| `CacheControlOptions` | interface | 2 tag |

<details>
<summary><code>CacheControl</code> — 13 tag</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 tag</summary>
...
| Export | Fajta | Szignatúra |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 tag |
...
| `MergeI18nHeadOptions` | interface | 3 tag |

<details>
<summary><code>I18nHeadObject</code> — 3 tag</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 tag</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 tag |
...
| `SourceLocaleInfo` | interface | 2 tag |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 tag</summary>
...
<code>SourceLocaleInfo</code> — 2 tag, megegyezik a fenti `PreMergeLocaleInfo`-nal.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 tag</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 tag |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 tag |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 tag |
| `TranslationPayloadStats` | interface | 2 tag |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 tag</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 tag</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 tag</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 tag</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 tag |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 tag</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 tag |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 tag</summary>
...
| Export | Fajta | Szignatúra |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 tag |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 tag |

<details>
<summary><code>HreflangAlternate</code> — 2 tag</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 tag</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 tag |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 tag |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 tag</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 tag</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 tag |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 tag</summary>
...
| `I18nRouteContext` | interface | 3 tag |
...
<details>
<summary><code>I18nRouteContext</code> — 3 tag</summary>
...
| `RuntimeI18nOverrides` | interface | 4 tag |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 tag</summary>
...
| `TranslationStorageReader` | interface | 1 tag |

<details>
<summary><code>TranslationStorageReader</code> — 1 tag</summary>
...
| Export | Fajta | Szignatúra |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 tag |
| `SplitLocaleRoutePage` | interface | 3 tag |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 tag |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 tag</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 tag</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 tag</summary>
