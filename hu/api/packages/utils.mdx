...
description: "A @i18n-micro/utils csomag nyilvános API-ja: build segédek, forrás betöltő, összeolvasztó és előre-összeolvasztási segédek, forrásból generálva build időben."
---

# `@i18n-micro/utils`

102 export 24 belépési pontban.
...
<code>SourceLocaleInfo</code> — 2 tag, azonos ezzel: `PreMergeLocaleInfo` fentebb.
