---
title: "Csomag API-k"
description: "Referencia index minden @i18n-micro workspace csomaghoz, felsorolva az exportált API-kat és típusokat, amelyeket forrás pillanatképekből generálunk, amelyeket a CI ellenőriz."
---

# Csomag API-k

A `nuxt-i18n-micro` kis csomagok halmazából épül fel, amelyek többsége önmagában is használható. Az `@i18n-micro/vue` egyszerű Vue alkalmazásban, az `@i18n-micro/core` bárhol.

Az alábbi minden oldal egy API pillanatképből generálódik, amelyet a [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) ellenőriz a TypeScript forrásokkal szemben, így egy export nem tűnhet el anélkül, hogy vagy ez a referencia változna, vagy a CI hibát dobna.

{/* generated:packages-index — do not edit; run `pnpm run docs:generate` */}

| Csomag | Belépési pontok | Exportok |
| --- | --- | --- |
...
- [Integrációk](/integrations/overview) — útmutatók e csomagok használatához az egyes keretrendszerekben
- [Modulopciók](/api/module-options) — a Nuxt modul által elfogadott opciók
- [Metódusok](/api/methods) — a komponensekben elérhető futásidejű segédek
