---
title: "Csomag-API-k"
description: "Minden workspace-csomag exportált API-ja, build-időben beolvasva a CI által a forráshoz ellenőrzött snapshotokból."
---

# Csomag-API-k

A `nuxt-i18n-micro` több kis csomagból épül fel, amelyek többsége önmagában is
használható — például az `@i18n-micro/vue` egy sima Vue-alkalmazásban, az `@i18n-micro/core` pedig bárhol.

Az alábbi oldalak mindegyike abból az API-snapshotból generálódik, amelyet a
[`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) parancs a TypeScript-forráshoz ellenőriz, így egy export nem tűnhet el anélkül, hogy vagy ez a referencia megváltozna,
vagy a CI el ne bukna.
...
- [Integrációk](/integrations/overview) — útmutatók ezekhez a csomagokhoz az egyes keretrendszerekben
- [Modul-opciók](/api/module-options) — a Nuxt modul által elfogadott opciók
