...
description: "Az @i18n-micro/core exportált API-ja, a forrásból generálva."
---

# `@i18n-micro/core`

50 export 3 belépési ponton át.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 tag |
| `BaseI18nOptions` | interface | 7 tag |
...
| `FormatServiceOptions` | interface | 2 tag |
...
| `MergeTranslationChunkOptions` | interface | 1 tag |
...
| `ReactiveI18nStore` | interface | 9 tag |
...
| `TranslationStorage` | interface | 1 tag |
...
<details>
<summary><code>BaseI18n</code> — 34 tag</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 tag</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 tag</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 tag</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 tag</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 tag</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 tag |
...
| `I18nDevtoolsInspectorNode` | interface | 4 tag |
| `I18nDevtoolsStateSnapshot` | interface | 7 tag |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 tag</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 tag</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 tag</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 tag, megegyezik a fenti `MergeTranslationChunkOptions`-nal.
