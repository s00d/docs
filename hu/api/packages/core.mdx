...
description: "A @i18n-micro/core csomag nyilvános API-ja: megosztott futásidejű primitívek és típusok, amelyek minden keretrendszer integrációt működtetnek, forrásból generálva."
---

# `@i18n-micro/core`

50 export 3 belépési pontban.
...
<code>MergeTranslationChunkOptions</code> — 1 tag, azonos ezzel: `MergeTranslationChunkOptions` fentebb.
