...
description: "A @i18n-micro/vue csomag nyilvános API-ja: Vue 3 composables, komponensek és bővítmény a fordításokhoz és területi útválasztáshoz, forrásból."
---

# `@i18n-micro/vue`

27 export 1 belépési pontban.
...
<code>VueI18nOptions</code> — 6 tag, azonos ezzel: [`PreactI18nOptions`](/api/packages/preact).
