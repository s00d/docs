...
description: "Az @i18n-micro/vue exportált API-ja, a forrásból generálva."
---

# `@i18n-micro/vue`

27 export 1 belépési ponton át.
...
| `UseLocaleHeadOptions` | interface | 5 tag |
| `VueI18n` | class | 51 tag |
| `VueI18nOptions` | interface | 6 tag |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 tag</summary>
...
<details>
<summary><code>VueI18n</code> — 51 tag</summary>
...
<code>VueI18nOptions</code> — 6 tag, megegyezik a [`PreactI18nOptions`](/api/packages/preact) taggal.
