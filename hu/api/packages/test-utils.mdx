...
description: "A @i18n-micro/test-utils csomag nyilvános API-ja: Vitest segédek, mock-ok és fixture-ök az i18n viselkedés teszteléséhez, forrásból generálva."
---

# `@i18n-micro/test-utils`

36 export 2 belépési pontban.
...
<details>
<summary><code>ExportTarget</code>  — 3 tag</summary>
