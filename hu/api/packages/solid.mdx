...
description: "A @i18n-micro/solid csomag nyilvános API-ja: SolidJS jelek, komponensek és szolgáltató a fordításokhoz és területi útválasztáshoz, forrásból."
---

# `@i18n-micro/solid`

33 export 1 belépési pontban.
...
<code>SolidI18nOptions</code> — 6 tag, azonos ezzel: [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 tag, azonos ezzel: [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 tag, azonos ezzel: [`UseI18nOptions`](/api/packages/preact).
