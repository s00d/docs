...
description: "Az @i18n-micro/solid exportált API-ja, a forrásból generálva."
---

# `@i18n-micro/solid`

33 export 1 belépési ponton át.
...
| `SolidI18n` | class | 53 tag |
| `SolidI18nOptions` | interface | 6 tag |
...
<details>
<summary><code>I18nProviderProps</code> — 4 tag</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 tag</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 tag</summary>
...
<code>SolidI18nOptions</code> — 6 tag, megegyezik a [`PreactI18nOptions`](/api/packages/preact) taggal.
<code>Translations</code> — 1 tag, megegyezik a [`Translations`](/api/packages/types) taggal.
<code>UseI18nOptions</code> — 2 tag, megegyezik a [`UseI18nOptions`](/api/packages/preact) taggal.
