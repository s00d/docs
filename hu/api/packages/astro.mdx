...
description: "Az @i18n-micro/astro exportált API-ja, a forrásból generálva."
---

# `@i18n-micro/astro`

56 export 6 belépési ponton át.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 tag |
| `AstroI18nOptions` | interface | 9 tag |
...
| `I18nClientProps` | interface | 4 tag |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 tag |
| `I18nMiddlewareOptions` | interface | 7 tag |
| `I18nRoutingStrategy` | interface | 10 tag |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 tag |
...
| `LoadTranslationsOptions` | interface | 3 tag |
| `Locale` | interface | 11 tag |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 tag |
| `LocaleHeadResult` | interface | 3 tag |
...
<details>
<summary><code>AstroI18n</code> — 48 tag</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 tag</summary>
...
<details>
<summary><code>FormatService</code> — 19 tag</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 tag</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 tag</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 tag</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 tag</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 tag</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 tag</summary>
...
<code>Locale</code> — 11 tag, megegyezik a [`Locale`](/api/packages/types) taggal.
<details>
<summary><code>LocaleHeadOptions</code> — 4 tag</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 tag</summary>
...
<code>Translations</code> — 1 tag, megegyezik a [`Translations`](/api/packages/types) taggal.
...
<code>I18nState</code> — 4 tag, megegyezik a fenti `I18nClientProps`-nal.
