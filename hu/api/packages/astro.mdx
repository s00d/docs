...
description: "A @i18n-micro/astro csomag nyilvános API-ja: integrációs belépési pont, exportált típusok és segédek, forrásból generálva build időben."
---

# `@i18n-micro/astro`

56 export 6 belépési pontban.
...
<code>Locale</code> — 11 tag, azonos ezzel: [`Locale`](/api/packages/types).
<details>
...
<code>Translations</code> — 1 tag, azonos ezzel: [`Translations`](/api/packages/types).
...
<code>I18nState</code> — 4 tag, azonos ezzel: `I18nClientProps` fentebb.
