...
description: "A @i18n-micro/preact csomag nyilvános API-ja: Preact hookok, komponensek és szolgáltató a fordításokhoz és útválasztáshoz, forrásból generálva."
---

# `@i18n-micro/preact`

39 export 1 belépési pontban.
...
<code>FormatService</code> — 19 tag, azonos ezzel: [`FormatService`](/api/packages/astro).
<details>
...
<code>ModuleOptions</code> — 47 tag, azonos ezzel: [`ModuleOptions`](/api/packages/types).
<details>
