...
description: "A @i18n-micro/node csomag nyilvános API-ja: Node.js futásidejű adapter, fordítás betöltők és exportált típusok, forrásból generálva."
---

# `@i18n-micro/node`

15 export 1 belépési pontban.
...
<code>LoadedTranslations</code> — 2 tag, azonos ezzel: [`LoadedTranslations`](/api/packages/astro).
