...
description: "A @i18n-micro/route-strategy csomag nyilvános API-ja: build időben honosított útvonal generálás Nuxt oldalakhoz, forrásból generálva."
---

# `@i18n-micro/route-strategy`

18 export 1 belépési pontban.
...
<details>
<summary><code>RouteGenerator</code>  — 23 tag</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code>  — 11 tag</summary>
