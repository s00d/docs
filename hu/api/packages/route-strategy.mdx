...
description: "Az @i18n-micro/route-strategy exportált API-ja, a forrásból generálva."
---

# `@i18n-micro/route-strategy`

18 export 1 belépési ponton át.
...
| `RouteGenerator` | class | 23 tag |
| `RouteGeneratorOptions` | interface | 11 tag |
