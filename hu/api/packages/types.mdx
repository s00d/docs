...
description: "A @i18n-micro/types csomag nyilvános API-ja: megosztott TypeScript definíciók, amelyeket a keretrendszer integrációkban használnak, forrásból generálva."
---

# `@i18n-micro/types`

26 export 1 belépési pontban.
