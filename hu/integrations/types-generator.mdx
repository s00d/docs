---
title: "Típusgenerátor a nyelvi JSON-hoz"
description: "A @i18n-micro/types-generator használatával TypeScript típusok állíthatók elő a nyelvi JSON-ból, teljes automatikus kiegészítést és biztonságot nyújtva a $t és a segédeszközök számára."
---
