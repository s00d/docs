---
title: "Vue csomag (`@i18n-micro/vue`)"
description: "A @i18n-micro/vue használatával composable-ek, komponensek és bővítmény adható a fordításokhoz és a nyelvfüggő útválasztáshoz önálló Vue 3 alkalmazásokban."
---
