---
title: "DevTools UI csomag (`@i18n-micro/devtools-ui`)"
description: "A @i18n-micro/devtools-ui használata önálló DevTools felületként és Vite bővítményként a fordítások böngészésére és a nyelvek szerkesztésére bármely @i18n-micro projektben."
---
