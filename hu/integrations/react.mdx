---
title: "React csomag (`@i18n-micro/react`)"
description: "A @i18n-micro/react használatával hookok, komponensek és provider adható a fordításokhoz és a nyelvfüggő útválasztáshoz React alkalmazásokban és keretrendszerekben."
---
