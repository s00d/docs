---
title: "Astro csomag (`@i18n-micro/astro`)"
description: "A @i18n-micro/astro használatával nyelvi útválasztás, fordítások és SEO segédek adhatók az Astro projektekhez a közös @i18n-micro/core futtatókörnyezet segítségével."
---
