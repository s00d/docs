---
title: "Solid csomag (`@i18n-micro/solid`)"
description: "A @i18n-micro/solid használatával jelzések, komponensek és provider adható a fordításokhoz és a nyelvfüggő útválasztáshoz SolidJS alkalmazásokban."
---
