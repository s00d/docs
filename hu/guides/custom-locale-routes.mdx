---
title: "Egyedi területi útvonalak `localeRoutes`-szal a `Nuxt I18n Micro`-ban"
description: "Területenkénti egyedi útvonalak a localeRoutes-szal."
---

# 🔗 Egyedi területi útvonalak `localeRoutes`-szal a `Nuxt I18n Micro`-ban
