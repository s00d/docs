---
title: "Több domain-alapú területek beállítása a `Nuxt I18n Micro`-val rétegeken keresztül"
description: "Több domainű területi beállítás rétegekkel."
---

# 🌍 Több domain-alapú területek beállítása a `Nuxt I18n Micro`-val rétegeken keresztül
