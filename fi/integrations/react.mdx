---
title: "React-paketti (`@i18n-micro/react`)"
description: "Käytä @i18n-micro/reactia lisätäksesi hookit, komponentit ja providerin käännöksille sekä kielitietoiselle reititykselle React-sovelluksissa ja -kehyksissä."
---
