---
title: "Astro-paketti (`@i18n-micro/astro`)"
description: "Käytä @i18n-micro/astroa lisätäksesi kielireitityksen, käännökset ja SEO-apurit Astro-projekteihin jaetulla @i18n-micro/core-ajonaikaisuudella."
---
