---
title: "DevTools-käyttöliittymäpaketti (`@i18n-micro/devtools-ui`)"
description: "Käytä @i18n-micro/devtools-ui:ta itsenäisenä DevTools-käyttöliittymänä ja Vite-lisäosana selataksesi käännöksiä ja muokataksesi kieliä missä tahansa @i18n-micro-projektissa."
---
