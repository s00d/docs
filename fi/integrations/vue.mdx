---
title: "Vue-paketti (`@i18n-micro/vue`)"
description: "Käytä @i18n-micro/vueta lisätäksesi koostimet, komponentit ja lisäosan käännöksille sekä kielitietoiselle reititykselle itsenäisissä Vue 3 -sovelluksissa."
---
