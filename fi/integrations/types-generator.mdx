---
title: "Tyyppigeneraattori kielten JSON-tiedostoille"
description: "Käytä @i18n-micro/types-generatoria luomaan TypeScript-tyyppejä kielten JSON-tiedostoistasi, jolloin $t ja apurit saavat täyden automaattitäydennyksen ja turvallisuuden."
---
