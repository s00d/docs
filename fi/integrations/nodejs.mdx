---
title: "Node.js-ajonaikaisuus @i18n-micro/node-paketin kanssa"
description: "Käytä @i18n-micro/nodea käännösten lataamiseen ja kielien tunnistamiseen puhtaissa Node.js-palvelimissa, työntekijöissä ja CLI-työkaluissa ilman käyttöliittymäkehystä."
---
