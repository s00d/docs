...
description: "Käytä nuxt-i18n-microa yhdessä Storybookin kanssa."
---
...
**Nuxtin**, **Storybookin** ja **nuxt-i18n-micron** integrointi projektiisi mahdollistaa vahvan, paikallistetun sovelluksen rakentamisen komponenttivetoisella kehitysotteella. Tämä opas tarjoaa vaiheittaisen läpikäynnin näiden työkalujen yhteiskäytön asentamiseen, mukaan lukien konfiguraatio, paikallistaminen ja Storybook-integraatio.

## 🛠 Nuxt-konfiguraatio

Ottaaksesi paikallistamisen ja Storybookin käyttöön Nuxt-projektissasi määritä `nuxt.config.ts`-tiedostosi seuraavasti:
...
Storybookin integroimiseksi Nuxtin ja nuxt-i18n-micron kanssa määritä `.storybook/main.ts`-tiedosto sekä lisää `mergeTranslations` ja `staticDirs`.
...
Katso täydellisiä esimerkkejä näistä projekteista:

1. **[Nuxt + Storybook + i18n -esimerkki GitHubissa](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Tämä repositorio näyttää, miten Nuxt, Storybook ja nuxt-i18n-micro integroidaan. Se sisältää asennusohjeet ja konfiguraatiotiedot.

2. **[Storybook Nuxt -dokumentaatio](https://storybook.nuxtjs.org/getting-started/setup)**  
   Virallinen dokumentaatio Storybookin asettamiseen Nuxtin kanssa. Se tarjoaa yksityiskohtaiset vaiheet ja parhaat käytännöt.

3. **[Interaktiivinen esimerkki StackBlitzissa](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Tutki Nuxtin, Storybookin ja nuxt-i18n-micron integraatiota suoraan selaimessasi.
