---
title: "nuxt-i18n-micro-cli-komennot"
description: "Käytä nuxt-i18n-micro-cli:tä avainten poimimiseen malleista, kovakoodatun tekstin muuntamiseen $t-kutsuiksi sekä käännös- ja synkronointityönkulkujen ajamiseen."
---
