...
description: "Paketin @i18n-micro/core julkinen API: jaetut ajonaikaiset primitiivit ja tyypit, jotka toimivat jokaisen kehysintegraation pohjana. Luotu lähdekoodista."
---

# `@i18n-micro/core`

50 vientiä 3 sisäänpääsypisteessä.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 jäsentä |
| `BaseI18nOptions` | interface | 7 jäsentä |
...
| `FormatServiceOptions` | interface | 2 jäsentä |
...
| `MergeTranslationChunkOptions` | interface | 1 jäsentä |
...
| `ReactiveI18nStore` | interface | 9 jäsentä |
...
| `TranslationStorage` | interface | 1 jäsentä |
...
<details>
<summary><code>BaseI18n</code> — 34 jäsentä</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 jäsentä</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 jäsentä</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 jäsentä</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 jäsentä</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 jäsentä</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 jäsentä |
...
| `I18nDevtoolsInspectorNode` | interface | 4 jäsentä |
| `I18nDevtoolsStateSnapshot` | interface | 7 jäsentä |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 jäsentä</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 jäsentä</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 jäsentä</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 jäsentä, sama kuin `MergeTranslationChunkOptions` yllä.
