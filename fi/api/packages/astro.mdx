...
description: "Paketin @i18n-micro/astro julkinen API: integraation sisäänpääsypiste, viedyt tyypit ja apurit. Luotu lähdekoodista käännösvaiheessa."
---

# `@i18n-micro/astro`

56 vientiä 6 sisäänpääsypisteessä.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 jäsentä |
| `AstroI18nOptions` | interface | 9 jäsentä |
...
| `I18nClientProps` | interface | 4 jäsentä |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 jäsentä |
| `I18nMiddlewareOptions` | interface | 7 jäsentä |
| `I18nRoutingStrategy` | interface | 10 jäsentä |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 jäsentä |
...
| `LoadTranslationsOptions` | interface | 3 jäsentä |
| `Locale` | interface | 11 jäsentä |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 jäsentä |
| `LocaleHeadResult` | interface | 3 jäsentä |
...
<details>
<summary><code>AstroI18n</code> — 48 jäsentä</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 jäsentä</summary>
...
<details>
<summary><code>FormatService</code> — 19 jäsentä</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 jäsentä</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 jäsentä</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 jäsentä</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 jäsentä</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 jäsentä</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 jäsentä</summary>
...
<code>Locale</code> — 11 jäsentä, sama kuin [`Locale`](/api/packages/types).
<details>
<summary><code>LocaleHeadOptions</code> — 4 jäsentä</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 jäsentä</summary>
...
<code>I18nState</code> — 4 jäsentä, sama kuin `I18nClientProps` yllä.
