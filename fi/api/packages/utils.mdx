...
description: "Paketin @i18n-micro/utils julkinen API: käännösvaiheen apurit, lähdelataaja, yhdistäjä ja esikoontityökalut. Luotu lähdekoodista käännösvaiheessa."
---

# `@i18n-micro/utils`

102 vientiä 24 sisäänpääsypisteessä.
...
| `PreMergeLocaleInfo` | interface | 2 jäsentä |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 jäsentä</summary>
...
| `CacheControlOptions` | interface | 2 jäsentä |

<details>
<summary><code>CacheControl</code> — 13 jäsentä</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 jäsentä</summary>
...
| Vienti | Laji | Allekirjoitus |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 jäsentä |
...
| `MergeI18nHeadOptions` | interface | 3 jäsentä |

<details>
<summary><code>I18nHeadObject</code> — 3 jäsentä</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 jäsentä</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 jäsentä |
...
| `SourceLocaleInfo` | interface | 2 jäsentä |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 jäsentä</summary>
...
<code>SourceLocaleInfo</code> — 2 jäsentä, sama kuin `PreMergeLocaleInfo` yllä.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 jäsentä</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 jäsentä |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 jäsentä |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 jäsentä |
| `TranslationPayloadStats` | interface | 2 jäsentä |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 jäsentä</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 jäsentä</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 jäsentä</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 jäsentä</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 jäsentä |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 jäsentä</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 jäsentä |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 jäsentä</summary>
...
| Vienti | Laji | Allekirjoitus |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 jäsentä |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 jäsentä |

<details>
<summary><code>HreflangAlternate</code> — 2 jäsentä</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 jäsentä</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 jäsentä |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 jäsentä |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 jäsentä</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 jäsentä</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 jäsentä |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 jäsentä</summary>
...
| `I18nRouteContext` | interface | 3 jäsentä |
...
<details>
<summary><code>I18nRouteContext</code> — 3 jäsentä</summary>
...
| `RuntimeI18nOverrides` | interface | 4 jäsentä |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 jäsentä</summary>
...
| `TranslationStorageReader` | interface | 1 jäsentä |

<details>
<summary><code>TranslationStorageReader</code> — 1 jäsentä</summary>
...
| Vienti | Laji | Allekirjoitus |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 jäsentä |
| `SplitLocaleRoutePage` | interface | 3 jäsentä |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 jäsentä |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 jäsentä</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 jäsentä</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 jäsentä</summary>
