...
description: "Paketin @i18n-micro/solid julkinen API: SolidJS-signaalit, komponentit ja tarjoaja käännöksiä ja kielikohtaista reititystä varten. Luotu lähdekoodista."
---

# `@i18n-micro/solid`

33 vientiä 1 sisäänpääsypisteessä.
...
| `SolidI18n` | class | 53 jäsentä |
| `SolidI18nOptions` | interface | 6 jäsentä |
...
<details>
<summary><code>I18nProviderProps</code> — 4 jäsentä</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 jäsentä</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 jäsentä</summary>
...
<code>SolidI18nOptions</code> — 6 jäsentä, sama kuin [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 jäsentä, sama kuin [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 jäsentä, sama kuin [`UseI18nOptions`](/api/packages/preact).
