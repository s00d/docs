...
description: "Paketin @i18n-micro/vue julkinen API: Vue 3 -koostajat, komponentit ja liitännäinen käännöksiä ja kielikohtaista reititystä varten. Luotu lähdekoodista."
---

# `@i18n-micro/vue`

27 vientiä 1 sisäänpääsypisteessä.
...
| `UseLocaleHeadOptions` | interface | 5 jäsentä |
| `VueI18n` | class | 51 jäsentä |
| `VueI18nOptions` | interface | 6 jäsentä |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 jäsentä</summary>
...
<details>
<summary><code>VueI18n</code> — 51 jäsentä</summary>
...
<code>VueI18nOptions</code> — 6 jäsentä, sama kuin [`PreactI18nOptions`](/api/packages/preact).
