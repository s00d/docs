...
description: "Paketin @i18n-micro/node julkinen API: Node.js-ajonaikainen sovitin, käännösten lataajat ja viedyt tyypit. Luotu lähdekoodista."
---

# `@i18n-micro/node`

15 vientiä 1 sisäänpääsypisteessä.
...
| `I18n` | class | 46 jäsentä |
| `I18nOptions` | interface | 7 jäsentä |
...
<details>
<summary><code>I18n</code> — 46 jäsentä</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 jäsentä</summary>
...
<code>LoadedTranslations</code> — 2 jäsentä, sama kuin [`LoadedTranslations`](/api/packages/astro).
