...
description: "Paketin @i18n-micro/types julkinen API: jaetut TypeScript-määrittelyt, joita käytetään kehysintegraatioissa. Luotu lähdekoodista."
---

# `@i18n-micro/types`

26 vientiä 1 sisäänpääsypisteessä.
...
| `DefineI18nRouteConfig` | interface | 3 jäsentä |
| `DefineLocaleMessage` | interface | 1 jäsentä |
...
| `I18nHeadInput` | interface | 5 jäsentä |
| `I18nHeadLink` | interface | 4 jäsentä |
| `I18nHeadMeta` | interface | 1 jäsentä |
...
| `ModuleOptionsExtend` | interface | 50 jäsentä |
| `ModulePrivateOptionsExtend` | interface | 50 jäsentä |
...
| `PluralTranslations` | interface | 2 jäsentä |
...
| `TranslationPayloadOptions` | interface | 8 jäsentä |
| `Translations` | interface | 1 jäsentä |

<details>
<summary><code>DefineI18nRouteConfig</code> — 3 jäsentä</summary>
...
<details>
<summary><code>DefineLocaleMessage</code> — 1 jäsentä</summary>
...
<details>
<summary><code>I18nHeadInput</code> — 5 jäsentä</summary>
...
<details>
<summary><code>I18nHeadLink</code> — 4 jäsentä</summary>
...
<details>
<summary><code>I18nHeadMeta</code> — 1 jäsentä</summary>
...
<details>
<summary><code>ModuleOptions</code> — 47 jäsentä</summary>
...
<details>
<summary><code>ModuleOptionsExtend</code> — 50 jäsentä</summary>
...
<details>
<summary><code>ModulePrivateOptionsExtend</code> — 50 jäsentä</summary>
...
<details>
<summary><code>PluralTranslations</code> — 2 jäsentä</summary>
...
<details>
<summary><code>TranslationPayloadOptions</code> — 8 jäsentä</summary>
...
<details>
<summary><code>Translations</code> — 1 jäsentä</summary>
