---
title: "Integrare Node.js"
description: "Utilizarea `@i18n-micro/node` în servicii Node.js: încărcarea payload-urilor, detectarea locale-ului și traducerea pe server."
---
