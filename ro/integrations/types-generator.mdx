---
title: "Generator de tipuri"
description: "Rulează `@i18n-micro/types-generator` pentru a emite tipuri TypeScript din fișierele JSON de locale pentru siguranță tipată a cheilor."
---
