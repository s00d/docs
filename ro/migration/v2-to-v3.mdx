---
title: "Migrare de la v2 la v3"
description: "Actualizează Nuxt I18n Micro de la v2 la v3: schimbări de payload, mutări de cache, actualizări de componente și înlocuiri de API-uri publice."
---
