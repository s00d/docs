...
description: "API-ul public al pachetului @i18n-micro/types: definiții TypeScript partajate folosite în integrările de framework, generate din sursă."
---

# `@i18n-micro/types`

26 exporturi în 1 puncte de intrare.
