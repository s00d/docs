...
description: "API-ul exportat al @i18n-micro/vue, generat din sursă."
---

# `@i18n-micro/vue`

27 exporturi în 1 entry point.
...
<code>VueI18nOptions</code> — 6 membri, identici cu [`PreactI18nOptions`](/api/packages/preact).
