...
description: "API-ul public al pachetului @i18n-micro/vue: composables Vue 3, componente și plugin pentru traduceri și rutare pe locale, din sursă."
---

# `@i18n-micro/vue`

27 exporturi în 1 puncte de intrare.
...
| `UseLocaleHeadOptions` | interface | 5 membri |
| `VueI18n` | class | 51 membri |
| `VueI18nOptions` | interface | 6 membri |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 membri</summary>
...
<details>
<summary><code>VueI18n</code> — 51 membri</summary>
...
<code>VueI18nOptions</code> — 6 membri, identic cu [`PreactI18nOptions`](/api/packages/preact).
