...
description: "API-ul public al pachetului @i18n-micro/route-strategy: generare la build a rutelor localizate pentru pagini Nuxt, generată din sursă."
---

# `@i18n-micro/route-strategy`

18 exporturi în 1 puncte de intrare.
...
| `RouteGenerator` | class | 23 membri |
| `RouteGeneratorOptions` | interface | 11 membri |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 membri</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 membri</summary>
