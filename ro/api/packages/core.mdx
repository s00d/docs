...
description: "API-ul public al pachetului @i18n-micro/core: primitive de runtime partajate și tipuri care alimentează fiecare integrare de framework, generate din sursă."
---

# `@i18n-micro/core`

50 exporturi în 3 puncte de intrare.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 membri |
| `BaseI18nOptions` | interface | 7 membri |
...
| `FormatServiceOptions` | interface | 2 membri |
...
| `MergeTranslationChunkOptions` | interface | 1 membri |
...
| `ReactiveI18nStore` | interface | 9 membri |
...
| `TranslationStorage` | interface | 1 membri |
...
<details>
<summary><code>BaseI18n</code> — 34 membri</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 membri</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 membri</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 membri</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 membri</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 membri</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 membri |
...
| `I18nDevtoolsInspectorNode` | interface | 4 membri |
| `I18nDevtoolsStateSnapshot` | interface | 7 membri |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 membri</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 membri</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 membri</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 membri, identic cu `MergeTranslationChunkOptions` de mai sus.
