...
description: "API-ul exportat al @i18n-micro/core, generat din sursă."
---

# `@i18n-micro/core`

50 exporturi în 3 entry point-uri.
...
<code>MergeTranslationChunkOptions</code> — 1 membri, identici cu `MergeTranslationChunkOptions` above.
