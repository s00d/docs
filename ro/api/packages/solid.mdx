...
description: "API-ul exportat al @i18n-micro/solid, generat din sursă."
---

# `@i18n-micro/solid`

33 exporturi în 1 entry point.
...
<code>SolidI18nOptions</code> — 6 membri, identici cu [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 membri, identici cu [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 membri, identici cu [`UseI18nOptions`](/api/packages/preact).
