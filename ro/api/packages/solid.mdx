...
description: "API-ul public al pachetului @i18n-micro/solid: signals SolidJS, componente și provider pentru traduceri și rutare pe locale, din sursă."
---

# `@i18n-micro/solid`

33 exporturi în 1 puncte de intrare.
...
| `SolidI18n` | class | 53 membri |
| `SolidI18nOptions` | interface | 6 membri |
...
<details>
<summary><code>I18nProviderProps</code> — 4 membri</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 membri</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 membri</summary>
...
<code>SolidI18nOptions</code> — 6 membri, identic cu [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 membri, identic cu [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 membri, identic cu [`UseI18nOptions`](/api/packages/preact).
