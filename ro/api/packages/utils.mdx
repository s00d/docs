...
description: "API-ul exportat al @i18n-micro/utils, generat din sursă."
---

# `@i18n-micro/utils`

102 exporturi în 24 entry point-uri.
...
<code>SourceLocaleInfo</code> — 2 membri, identici cu `PreMergeLocaleInfo` above.
