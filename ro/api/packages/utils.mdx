...
description: "API-ul public al pachetului @i18n-micro/utils: helper-i de build, source loader, merger și utilitare de premerge, generate din sursă la build."
---

# `@i18n-micro/utils`

102 exporturi în 24 puncte de intrare.
...
| `PreMergeLocaleInfo` | interface | 2 membri |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 membri</summary>
...
| `CacheControlOptions` | interface | 2 membri |

<details>
<summary><code>CacheControl</code> — 13 membri</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 membri</summary>
...
| Export | Fel | Semnătură |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 membri |
...
| `MergeI18nHeadOptions` | interface | 3 membri |

<details>
<summary><code>I18nHeadObject</code> — 3 membri</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 membri</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 membri |
...
| `SourceLocaleInfo` | interface | 2 membri |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 membri</summary>
...
<code>SourceLocaleInfo</code> — 2 membri, identic cu `PreMergeLocaleInfo` de mai sus.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 membri</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 membri |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 membri |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 membri |
| `TranslationPayloadStats` | interface | 2 membri |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 membri</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 membri</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 membri</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 membri</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 membri |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 membri</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 membri |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 membri</summary>
...
| Export | Fel | Semnătură |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 membri |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 membri |

<details>
<summary><code>HreflangAlternate</code> — 2 membri</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 membri</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 membri |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 membri |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 membri</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 membri</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 membri |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 membri</summary>
...
| `I18nRouteContext` | interface | 3 membri |
...
<details>
<summary><code>I18nRouteContext</code> — 3 membri</summary>
...
| `RuntimeI18nOverrides` | interface | 4 membri |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 membri</summary>
...
| `TranslationStorageReader` | interface | 1 membri |

<details>
<summary><code>TranslationStorageReader</code> — 1 membri</summary>
...
| Export | Fel | Semnătură |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 membri |
| `SplitLocaleRoutePage` | interface | 3 membri |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 membri |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 membri</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 membri</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 membri</summary>
