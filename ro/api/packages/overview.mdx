---
title: "API-uri de pachet"
description: "Index de referință pentru fiecare pachet din workspace-ul @i18n-micro, listând API-urile exportate și tipurile generate din snapshot-urile sursă pe care CI le verifică."
---

# API-uri de pachet

`nuxt-i18n-micro` este construit dintr-un set de pachete mici, majoritatea utilizabile pe
cont propriu. `@i18n-micro/vue` într-o aplicație Vue simplă, `@i18n-micro/core` oriunde.

Fiecare pagină de mai jos este generată din snapshot-ul API-ului pe care îl verifică
[`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) față de
...
| Pachet | Puncte de intrare | Exporturi |
| --- | --- | --- |
...
- [Integrări](/integrations/overview) — ghiduri pentru utilizarea acestor pachete în fiecare framework
- [Opțiuni de modul](/api/module-options) — opțiunile acceptate de modulul Nuxt
- [Metode](/api/methods) — helper-ii de runtime disponibili în componente
