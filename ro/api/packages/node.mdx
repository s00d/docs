...
description: "API-ul exportat al @i18n-micro/node, generat din sursă."
---

# `@i18n-micro/node`

15 exporturi în 1 entry point.
...
<code>LoadedTranslations</code> — 2 membri, identici cu [`LoadedTranslations`](/api/packages/astro).
