...
description: "API-ul exportat al @i18n-micro/astro, generat din sursă."
---

# `@i18n-micro/astro`

56 exporturi în 6 entry point-uri.
...
<code>Locale</code> — 11 membri, identici cu [`Locale`](/api/packages/types).
<details>
...
<code>Translations</code> — 1 membri, identici cu [`Translations`](/api/packages/types).
...
<code>I18nState</code> — 4 membri, identici cu `I18nClientProps` above.
