...
description: "API-ul public al pachetului @i18n-micro/astro: punct de intrare pentru integrare, tipuri exportate și helper-i, generate din sursă la build."
---

# `@i18n-micro/astro`

56 exporturi în 6 puncte de intrare.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 membri |
| `AstroI18nOptions` | interface | 9 membri |
...
| `I18nClientProps` | interface | 4 membri |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 membri |
| `I18nMiddlewareOptions` | interface | 7 membri |
| `I18nRoutingStrategy` | interface | 10 membri |
...
| `LoadTranslationsOptions` | interface | 3 membri |
| `Locale` | interface | 11 membri |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 membri |
| `LocaleHeadResult` | interface | 3 membri |
...
<details>
<summary><code>AstroI18n</code> — 48 membri</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 membri</summary>
...
<details>
<summary><code>FormatService</code> — 19 membri</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 membri</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 membri</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 membri</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 membri</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 membri</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 membri</summary>
...
<details>
<summary><code>LocaleHeadOptions</code> — 4 membri</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 membri</summary>
...
<code>I18nState</code> — 4 membri, identic cu `I18nClientProps` de mai sus.
