...
description: "API-ul exportat al @i18n-micro/preact, generat din sursă."
---

# `@i18n-micro/preact`

39 exporturi în 1 entry point.
...
<code>FormatService</code> — 19 membri, identici cu [`FormatService`](/api/packages/astro).
<details>
...
<code>ModuleOptions</code> — 47 membri, identici cu [`ModuleOptions`](/api/packages/types).
<details>
