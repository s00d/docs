...
description: "API-ul public al pachetului @i18n-micro/test-utils: helper-i Vitest, mock-uri și fixture-uri pentru testarea comportamentului i18n, generate din sursă."
---

# `@i18n-micro/test-utils`

36 exporturi în 2 puncte de intrare.
...
| Export | Fel | Semnătură |
| --- | --- | --- |
| `ExportTarget` | interface | 3 membri |
...
<details>
<summary><code>ExportTarget</code> — 3 membri</summary>
