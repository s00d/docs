---
title: "Rute personalizate pentru locale"
description: "Definește căi diferite per locale pentru aceeași pagină, inclusiv `globalLocaleRoutes` și `pages:extend` programatic."
---
