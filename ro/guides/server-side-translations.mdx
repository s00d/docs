---
title: "Traduceri pe partea de server"
description: "Utilizarea `useTranslationServerMiddleware` și `useLocaleServerMiddleware` pentru a traduce în handlerele Nitro și pentru a citi detectarea locale-ului."
---
