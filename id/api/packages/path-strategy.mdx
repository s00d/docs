...
description: "API publik paket @i18n-micro/path-strategy: penyelesaian jalur lokal runtime, pengalihan, dan pembantu SEO, dihasilkan dari sumber."
---

# `@i18n-micro/path-strategy`

38 ekspor di 6 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
