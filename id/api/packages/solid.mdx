...
description: "API publik paket @i18n-micro/solid: signal SolidJS, komponen, dan provider untuk terjemahan dan perutean lokal, dari sumber."
---

# `@i18n-micro/solid`

33 ekspor di 1 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
