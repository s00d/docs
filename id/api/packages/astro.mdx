...
description: "API publik paket @i18n-micro/astro: titik masuk integrasi, tipe yang diekspor, dan pembantu, dihasilkan dari sumber saat waktu build."
---

# `@i18n-micro/astro`

56 ekspor di 6 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
