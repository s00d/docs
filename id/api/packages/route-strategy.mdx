...
description: "API publik paket @i18n-micro/route-strategy: pembuatan rute lokal saat waktu build untuk halaman Nuxt, dihasilkan dari sumber."
---

# `@i18n-micro/route-strategy`

18 ekspor di 1 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
