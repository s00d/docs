...
description: "API publik paket @i18n-micro/types: definisi TypeScript bersama yang digunakan di berbagai integrasi framework, dihasilkan dari sumber."
---

# `@i18n-micro/types`

26 ekspor di 1 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
