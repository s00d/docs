...
description: "API publik paket @i18n-micro/vue: composable Vue 3, komponen, dan plugin untuk terjemahan dan perutean lokal, dari sumber."
---

# `@i18n-micro/vue`

27 ekspor di 1 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
