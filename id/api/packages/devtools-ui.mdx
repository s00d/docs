...
description: "API publik paket @i18n-micro/devtools-ui: panel DevTools mandiri, plugin Vite, dan pembantu yang diekspor, dihasilkan dari sumber."
---

# `@i18n-micro/devtools-ui`

25 ekspor di 4 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
