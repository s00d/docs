...
description: "API publik paket @i18n-micro/test-utils: pembantu Vitest, mock, dan fixture untuk menguji perilaku i18n, dihasilkan dari sumber."
---

# `@i18n-micro/test-utils`

36 ekspor di 2 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
