...
description: "API publik paket @i18n-micro/core: primitif dan tipe runtime bersama yang menggerakkan setiap integrasi framework, dihasilkan dari sumber."
---

# `@i18n-micro/core`

50 ekspor di 3 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
