...
description: "API publik paket @i18n-micro/utils: pembantu build, source loader, merger, dan utilitas premerge, dihasilkan dari sumber saat waktu build."
---

# `@i18n-micro/utils`

102 ekspor di 24 titik masuk. Dihasilkan dari snapshot API yang [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) periksa terhadap sumber TypeScript.
