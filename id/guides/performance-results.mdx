---
title: "Hasil kinerja"
description: "Waktu build, ukuran bundle, dan tolok ukur beban runtime yang membandingkan Nuxt I18n Micro dengan @nuxtjs/i18n pada fixture identik."
---
...
Compares **plain Nuxt** (baseline tanpa an i18n module), **i18n-micro**, dan **`@nuxtjs/i18n` v10.6** under one shared dictionary profile.

Focus: build time, peak RSS, deployable **code vs translations vs total**, dan server behaviour under Artillery + Autocannon.

### Methodology notes

- Metrics are **means of 3 consecutive runs per fixture** (fixture A ×3, then B ×3, then C ×3 — not interleaved).
- **Translations** include locale JSON under `locales/` / `_locales/` / `translations/`, everything under `chunks/raw/`, dan matching locale chunks. Older reports that showed `@nuxtjs/i18n` “translations: 0 B” dan a huge “code” column were counting message chunks as app code.
...
| Goal | Default CLI profile (`--locales 4 --keys 10000`); raise knobs untuk regression-radar loads |

Dictionaries come dari `test/fixtures/perf-shared/runtime.json` (written oleh CLI) so all three fixtures stay aligned.
...
## Build Performance untuk test/fixtures/plain-nuxt
...
## Build Performance untuk test/fixtures/i18n
...
## Build Performance untuk test/fixtures/i18n-micro
...
<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `build-time-comparison`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `bundle-size-comparison`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `translations-size-comparison`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `total-bundle-comparison`.
</Note>

## Stress Test Results untuk plain-nuxt
...
<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `plain-nuxt-traffic`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `plain-nuxt-latency`.
</Note>

## Stress Test Results untuk i18n-v10
...
<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `i18n-v10-traffic`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `i18n-v10-latency`.
</Note>

## Stress Test Results untuk i18n-micro
...
<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `i18n-micro-traffic`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `i18n-micro-latency`.
</Note>
...
> **Winner: i18n-micro** dengan 162 RPS

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `comparison-rps-autocannon`.
</Note>

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `comparison-rps-artillery`.
</Note>

### Latency Distribution

> **Winner: i18n-micro** dengan 62.04 ms avg latency

<Note>
Interactive chart omitted in Mintlify docs. Lihat benchmark tables on this page atau the [VitePress docs](https://s00d.github.io/nuxt-i18n-micro/guide/performance-results) untuk chart: `comparison-latency`.
</Note>
...
- Re-run: `pnpm test:performance` atau `pnpm -C scripts cli performance --locales N --keys K --only all|micro|i18n|plain --runs N`.
