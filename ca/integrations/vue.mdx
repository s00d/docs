...
description: "Fes servir @i18n-micro/vue per afegir composables, components i un plugin per a traduccions i enrutament conscient del locale a apps Vue 3 independents."
---
