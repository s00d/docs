...
description: "Fes servir @i18n-micro/react per afegir hooks, components i un proveïdor per a traduccions i enrutament conscient del locale a apps i frameworks de React."
---
