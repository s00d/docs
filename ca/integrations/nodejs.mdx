...
description: "i18n per a Node.js amb @i18n-micro/node."
---
...
Clear cache and reload translations from disk. Use this when fitxer de traducciós change.
...
- 📦 **Same JSON structure** - Use the same fitxer de traducciós as your Nuxt app
...
Pots utilitzar `@i18n-micro/node` in Nuxt server API routes to provide server-side translations:
...
// Create a singleton I18n instance (en producció, you'd want to cache this)
...
6. **Reload on file changes**: Use `reload()` method with file watchers en desenvolupament for hot-reloading
...
- **[Folder Structure](/guides/folder-structure)** - Learn about fitxer de traducció organization
