---
title: "Temps d'execució Node.js amb @i18n-micro/node"
description: "Fes servir @i18n-micro/node per carregar traduccions i detectar locales en servidors Node.js senzills, workers i CLIs sense cap framework d'interfície d'usuari."
---

# 🌐 Temps d'execució de Node.js
