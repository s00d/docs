---
title: "Paquet UI de DevTools (`@i18n-micro/devtools-ui`)"
description: "Fes servir @i18n-micro/devtools-ui com a UI independent de DevTools i plugin Vite per explorar traduccions i editar locales a qualsevol projecte @i18n-micro."
---

# Paquet UI de DevTools (`@i18n-micro/devtools-ui`)
