...
description: "Fes servir @i18n-micro/solid per afegir senyals, components i un proveïdor per a traduccions i enrutament conscient del locale a aplicacions SolidJS."
---
