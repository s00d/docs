---
title: "Paquet Solid (`@i18n-micro/solid`)"
description: "i18n per a SolidJS amb @i18n-micro/solid."
---

# Paquet Solid (`@i18n-micro/solid`)
...
Aquest exemple mostra how to create an adapter for a custom router that uses signals:
...
- `localeAccessor: Accessor<string>` - Reactive accessor for locale actual
...
| `getLocaleName`         | `() => string \| null`                                                              | ❌       | -       | Function to get locale actual name                 |
...
| `customActiveLinkStyle` | `JSX.CSSProperties`                                                                 | ❌       | `\{\}`    | Custom styles for the locale actual link           |
