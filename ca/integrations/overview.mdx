---
title: "Visió general de les integracions de frameworks"
description: "Visió general de les integracions de framework de @i18n-micro per a Vue, React, Preact, SolidJS, Astro i Node.js que comparteixen un únic temps d'execució de traducció."
---
