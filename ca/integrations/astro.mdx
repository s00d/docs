...
description: "Fes servir @i18n-micro/astro per afegir enrutament de locale, traduccions i ajudants SEO a projectes Astro amb el temps d'execució compartit de @i18n-micro/core."
---
