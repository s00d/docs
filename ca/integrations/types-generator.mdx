---
title: "Generador de tipus per a JSON de locale"
description: "Fes servir @i18n-micro/types-generator per emetre tipus TypeScript a partir del teu JSON de locale, donant a $t i als ajudants autocompleció completa i seguretat."
---

# 🔧 Generador de tipus (`@i18n-micro/types-generator`)
