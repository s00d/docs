...
description: "API pública del paquet @i18n-micro/path-strategy: resolució de rutes de locale en temps d'execució, redireccions i ajudants SEO, generat des del codi font."
---

# `@i18n-micro/path-strategy`

38 exportacions distribuïdes entre 6 punts d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| `BasePathStrategy` | class | 36 membres |
...
| `GetRouteBaseNameOptions` | interface | 2 membres |
...
| `IsIndexRouteNameOptions` | interface | 2 membres |
| `NoPrefixPathStrategy` | class | 36 membres |
...
| `PathStrategy` | interface | 22 membres |
| `PathStrategyContext` | interface | 15 membres |
| `PrefixAndDefaultPathStrategy` | class | 37 membres |
| `PrefixExceptDefaultPathStrategy` | class | 44 membres |
| `PrefixPathStrategy` | class | 36 membres |
| `ResolvedRouteLike` | interface | 6 membres |
| `resolvePathWithParams` | function | `(path: string, params?: Record<string, unknown>) => string` |
| `RouteAnalysis` | interface | 2 membres |
| `RouteLike` | interface | 6 membres |
| `RouterAdapter` | interface | 3 membres |
| `SwitchLocaleOptions` | interface | 1 membres |

<details>
<summary><code>BasePathStrategy</code> — 36 membres</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2 membres</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2 membres</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36 membres</summary>
...
<details>
<summary><code>PathStrategy</code> — 22 membres</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15 membres</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37 membres</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44 membres</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36 membres</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6 membres</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2 membres</summary>
...
<details>
<summary><code>RouteLike</code> — 6 membres</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3 membres</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 membres</summary>
...
| --- | --- | --- |
| `NoPrefixPathStrategy` | class | 36 membres |
| `Strategy` | class | 36 membres |

<code>NoPrefixPathStrategy</code>: 36 membres, idèntic a `NoPrefixPathStrategy` anterior.
<code>Strategy</code>: 36 membres, idèntic a `NoPrefixPathStrategy` anterior.
...
<code>PrefixPathStrategy</code>: 36 membres, idèntic a `PrefixPathStrategy` anterior.
<code>Strategy</code>: 36 membres, idèntic a `PrefixPathStrategy` anterior.
...
| --- | --- | --- |
| `PrefixAndDefaultPathStrategy` | class | 37 membres |
| `Strategy` | class | 37 membres |

<code>PrefixAndDefaultPathStrategy</code>: 37 membres, idèntic a `PrefixAndDefaultPathStrategy` anterior.
<code>Strategy</code>: 37 membres, idèntic a `PrefixAndDefaultPathStrategy` anterior.
...
| --- | --- | --- |
| `PrefixExceptDefaultPathStrategy` | class | 44 membres |
| `Strategy` | class | 44 membres |

<code>PrefixExceptDefaultPathStrategy</code>: 44 membres, idèntic a `PrefixExceptDefaultPathStrategy` anterior.
<code>Strategy</code>: 44 membres, idèntic a `PrefixExceptDefaultPathStrategy` anterior.
...
<code>PathStrategy</code>: 22 membres, idèntic a `PathStrategy` anterior.
<code>PathStrategyContext</code>: 15 membres, idèntic a `PathStrategyContext` anterior.
<code>ResolvedRouteLike</code>: 6 membres, idèntic a `ResolvedRouteLike` anterior.
<code>RouteLike</code>: 6 membres, idèntic a `RouteLike` anterior.
<code>RouterAdapter</code>: 3 membres, idèntic a `RouterAdapter` anterior.
<code>SwitchLocaleOptions</code>: 1 membres, idèntic a `SwitchLocaleOptions` anterior.
