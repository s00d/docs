...
description: "API pública del paquet @i18n-micro/node: adaptador de temps d'execució Node.js, carregadors de traduccions i tipus exportats, generat des del codi font."
---

# `@i18n-micro/node`

15 exportacions en 1 punt d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| `I18n` | class | 46 membres |
| `I18nOptions` | interface | 7 membres |
...
<details>
<summary><code>I18n</code> — 46 membres</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 membres</summary>
...
<code>LoadedTranslations</code>: 2 membres, idèntic a [`LoadedTranslations`](/api/packages/astro).
