...
description: "API pública del paquet @i18n-micro/utils: ajudants de compilació, carregador de fonts, fusionador i utilitats de premerge, generat des del codi font en temps de compilació."
---

# `@i18n-micro/utils`

102 exportacions distribuïdes entre 24 punts d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| `PreMergeLocaleInfo` | interface | 2 membres |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 membres</summary>
...
| `CacheControlOptions` | interface | 2 membres |

<details>
<summary><code>CacheControl</code> — 13 membres</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 membres</summary>
...
| Exportació | Tipus | Signatura |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 membres |
...
| `MergeI18nHeadOptions` | interface | 3 membres |

<details>
<summary><code>I18nHeadObject</code> — 3 membres</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 membres</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 membres |
...
| `SourceLocaleInfo` | interface | 2 membres |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 membres</summary>
...
<code>SourceLocaleInfo</code>: 2 membres, idèntic a `PreMergeLocaleInfo` anterior.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 membres</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 membres |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 membres |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 membres |
| `TranslationPayloadStats` | interface | 2 membres |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 membres</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 membres</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 membres</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 membres</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 membres |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 membres</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 membres |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 membres</summary>
...
| Exportació | Tipus | Signatura |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 membres |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 membres |

<details>
<summary><code>HreflangAlternate</code> — 2 membres</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 membres</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 membres |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 membres |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 membres</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 membres</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 membres |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 membres</summary>
...
| `I18nRouteContext` | interface | 3 membres |
...
<details>
<summary><code>I18nRouteContext</code> — 3 membres</summary>
...
| `RuntimeI18nOverrides` | interface | 4 membres |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 membres</summary>
...
| `TranslationStorageReader` | interface | 1 membres |

<details>
<summary><code>TranslationStorageReader</code> — 1 membres</summary>
...
| Exportació | Tipus | Signatura |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 membres |
| `SplitLocaleRoutePage` | interface | 3 membres |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 membres |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 membres</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 membres</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 membres</summary>
