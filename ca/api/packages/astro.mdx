...
description: "API pública del paquet @i18n-micro/astro: punt d'entrada de la integració, tipus exportats i ajudants, generat a partir del codi font en temps de compilació."
---

# `@i18n-micro/astro`

56 exportacions distribuïdes entre 6 punts d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 membres |
| `AstroI18nOptions` | interface | 9 membres |
...
| `I18nClientProps` | interface | 4 membres |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 membres |
| `I18nMiddlewareOptions` | interface | 7 membres |
| `I18nRoutingStrategy` | interface | 10 membres |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 membres |
...
| `LoadTranslationsOptions` | interface | 3 membres |
| `Locale` | interface | 11 membres |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 membres |
| `LocaleHeadResult` | interface | 3 membres |
...
<details>
<summary><code>AstroI18n</code> — 48 membres</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 membres</summary>
...
<details>
<summary><code>FormatService</code> — 19 membres</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 membres</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 membres</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 membres</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 membres</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 membres</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 membres</summary>
...
<code>Locale</code>: 11 membres, idèntic a [`Locale`](/api/packages/types).
<details>
<summary><code>LocaleHeadOptions</code> — 4 membres</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 membres</summary>
...
<code>I18nState</code>: 4 membres, idèntic a `I18nClientProps` anterior.
