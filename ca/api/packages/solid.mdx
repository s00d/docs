...
description: "API pública del paquet @i18n-micro/solid: senyals SolidJS, components i proveïdor per a traduccions i enrutament de locale, des del codi font."
---

# `@i18n-micro/solid`

33 exportacions en 1 punt d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| `SolidI18n` | class | 53 membres |
| `SolidI18nOptions` | interface | 6 membres |
...
<details>
<summary><code>I18nProviderProps</code> — 4 membres</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 membres</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 membres</summary>
...
<code>SolidI18nOptions</code>: 6 membres, idèntic a [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code>: 1 membres, idèntic a [`Translations`](/api/packages/types).
<code>UseI18nOptions</code>: 2 membres, idèntic a [`UseI18nOptions`](/api/packages/preact).
