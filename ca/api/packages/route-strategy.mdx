...
description: "API pública del paquet @i18n-micro/route-strategy: generació de rutes localitzades en temps de compilació per a pàgines Nuxt, generat des del codi font."
---

# `@i18n-micro/route-strategy`

18 exportacions en 1 punt d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
