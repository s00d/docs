...
description: "API pública del paquet @i18n-micro/vue: composables Vue 3, components i plugin per a traduccions i enrutament de locale, des del codi font."
---

# `@i18n-micro/vue`

27 exportacions en 1 punt d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| `UseLocaleHeadOptions` | interface | 5 membres |
| `VueI18n` | class | 51 membres |
| `VueI18nOptions` | interface | 6 membres |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 membres</summary>
...
<details>
<summary><code>VueI18n</code> — 51 membres</summary>
...
<code>VueI18nOptions</code>: 6 membres, idèntic a [`PreactI18nOptions`](/api/packages/preact).
