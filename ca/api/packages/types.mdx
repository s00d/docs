...
description: "API pública del paquet @i18n-micro/types: definicions TypeScript compartides utilitzades entre integracions de frameworks, generat des del codi font."
---

# `@i18n-micro/types`

26 exportacions en 1 punt d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| `DefineI18nRouteConfig` | interface | 3 membres |
| `DefineLocaleMessage` | interface | 1 membres |
...
| `I18nHeadInput` | interface | 5 membres |
| `I18nHeadLink` | interface | 4 membres |
| `I18nHeadMeta` | interface | 1 membres |
...
| `ModuleOptionsExtend` | interface | 50 membres |
| `ModulePrivateOptionsExtend` | interface | 50 membres |
...
| `PluralTranslations` | interface | 2 membres |
...
| `TranslationPayloadOptions` | interface | 8 membres |
| `Translations` | interface | 1 membres |

<details>
<summary><code>DefineI18nRouteConfig</code> — 3 membres</summary>
...
<details>
<summary><code>DefineLocaleMessage</code> — 1 membres</summary>
...
<details>
<summary><code>I18nHeadInput</code> — 5 membres</summary>
...
<details>
<summary><code>I18nHeadLink</code> — 4 membres</summary>
...
<details>
<summary><code>I18nHeadMeta</code> — 1 membres</summary>
...
<details>
<summary><code>ModuleOptions</code> — 47 membres</summary>
...
<details>
<summary><code>ModuleOptionsExtend</code> — 50 membres</summary>
...
<details>
<summary><code>ModulePrivateOptionsExtend</code> — 50 membres</summary>
...
<details>
<summary><code>PluralTranslations</code> — 2 membres</summary>
...
<details>
<summary><code>TranslationPayloadOptions</code> — 8 membres</summary>
...
<details>
<summary><code>Translations</code> — 1 membres</summary>
