...
description: "API pública del paquet @i18n-micro/core: primitives i tipus compartits de temps d'execució que fan funcionar cada integració de framework, generat des del codi font."
---

# `@i18n-micro/core`

50 exportacions distribuïdes entre 3 punts d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 membres |
| `BaseI18nOptions` | interface | 7 membres |
...
| `FormatServiceOptions` | interface | 2 membres |
...
| `MergeTranslationChunkOptions` | interface | 1 membres |
...
| `ReactiveI18nStore` | interface | 9 membres |
...
| `TranslationStorage` | interface | 1 membres |
...
<details>
<summary><code>BaseI18n</code> — 34 membres</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 membres</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 membres</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 membres</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 membres</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 membres</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 membres |
...
| `I18nDevtoolsInspectorNode` | interface | 4 membres |
| `I18nDevtoolsStateSnapshot` | interface | 7 membres |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 membres</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 membres</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 membres</summary>
...
<code>MergeTranslationChunkOptions</code>: 1 membres, idèntic a `MergeTranslationChunkOptions` anterior.
