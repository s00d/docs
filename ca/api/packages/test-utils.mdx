...
description: "API pública del paquet @i18n-micro/test-utils: ajudants de Vitest, mocks i fixtures per testar el comportament d'i18n, generat des del codi font."
---

# `@i18n-micro/test-utils`

36 exportacions distribuïdes entre 2 punts d'entrada. Generat a partir de la instantània de l'API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) comprova contra els fonts TypeScript.
...
| Exportació | Tipus | Signatura |
| --- | --- | --- |
| `ExportTarget` | interface | 3 membres |
...
<details>
<summary><code>ExportTarget</code> — 3 membres</summary>
