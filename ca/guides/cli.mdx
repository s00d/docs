---
title: "Ordres de nuxt-i18n-micro-cli"
description: "Fes servir nuxt-i18n-micro-cli per extreure claus de plantilles, convertir text codificat a crides $t i executar fluxos de treball de traducció i sincronització."
---
