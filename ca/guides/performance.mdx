...
description: "Guia de rendiment per a Nuxt I18n Micro: per què les compilacions són més ràpides, metodologia de benchmark, consells d'afinació i optimitzacions de payload en serverless."
---
