...
description: "Adjunta traduccions a un component o pàgina específics amb $defineI18nRoute, mantenint les claus locals en lloc de compartir fitxers de locale globals."
---
