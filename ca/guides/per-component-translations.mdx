---
title: "Traduccions per component"
description: "Traduccions per component amb $defineI18nRoute."
---

# 📖 Traduccions per component
...
The `$defineI18nRoute` function configures route behavior based on the locale actual, offering a versatile solution to:
...
- **Increased file size**: All locales reside in the SFC, unlike separate fitxer de traducciós that enable locale-aware loading
- **Slower rendering**: In-file translations are processed en temps d'execució
- **Memory usage**: All translations are loaded regardless of the locale actual
