...
description: "Compara les estratègies d'enrutament de Nuxt I18n Micro: no_prefix, prefix, prefix_except_default i prefix_and_default, amb els compromisos d'URL i SEO."
---
