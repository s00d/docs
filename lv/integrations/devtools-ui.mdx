---
title: "DevTools UI pakotne (`@i18n-micro/devtools-ui`)"
description: "Autonoma DevTools UI un Vite spraudnis."
---

# DevTools UI pakotne (`@i18n-micro/devtools-ui`)

Pakotne `@i18n-micro/devtools-ui` nodrošina autonomu izstrādes rīku saskarni tulkojumu pārvaldībai. Tā iekļauj Vite spraudni automātiskai integrācijai un universālu tilta sistēmu no ietvara neatkarīgam i18n atbalstam.

## Pārskats

`@i18n-micro/devtools-ui` ir pašpietiekama pakotne, kas nodrošina:
