...
description: "Astro integrācija tulkojumiem, lokalizācijas maršrutēšanai un SSR ar @i18n-micro/astro klientiem Preact, React, Solid, Svelte un Vue."
---
...
### Pamata iestatīšana (Without Router Adapter)
...
### Piemērs 1: Subdomain-Based Locale Routing
...
### Piemērs 3: Suffix-Based Locale Routing
...
### Piemērs 4: Integration with Third-Party Router
