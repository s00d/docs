---
title: "Astro pakotne (`@i18n-micro/astro`)"
description: "i18n Astro lietotnēm ar @i18n-micro/astro."
---

# Astro pakotne (`@i18n-micro/astro`)

Pakotne `@i18n-micro/astro` nodrošina vieglu, augstas veiktspējas internacionalizācijas risinājumu Astro lietotnēm. Tā koplieto to pašu galveno loģiku, ko Nuxt I18n Micro, piedāvājot SSR atbalstu, automātisku lokāles noteikšanu, Astro komponentus un pilnu TypeScript atbalstu.

## Pārskats

`@i18n-micro/astro` ir izstrādāts Astro lietotnēm, kurām nepieciešama internacionalizācija ar servera puses renderēšanas atbalstu. Tas nodrošina:
