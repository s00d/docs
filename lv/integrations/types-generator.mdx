---
title: "Tipu ģenerators (`@i18n-micro/types-generator`)"
description: "Ģenerējiet TypeScript tipus no lokāles JSON."
---

# 🔧 Tipu ģenerators (`@i18n-micro/types-generator`)

Pakotne `@i18n-micro/types-generator` nodrošina automātisku TypeScript tipu ģenerēšanu tulkojumu atslēgām. Tā analizē jūsu JSON tulkojumu failus un ģenerē stingrus tipus, iespējojot pilnu tipu drošību un automātisko pabeigšanas atbalstu tulkojumu atslēgām.

## 📖 Pārskats

`@i18n-micro/types-generator` ir izvēles izstrādes atkarība, kas uzlabo jūsu izstrādes pieredzi, nodrošinot:
