---
title: "Solid pakotne (`@i18n-micro/solid`)"
description: "i18n SolidJS lietotnēm ar @i18n-micro/solid."
---

# Solid pakotne (`@i18n-micro/solid`)

Pakotne `@i18n-micro/solid` nodrošina vieglu, augstas veiktspējas internacionalizācijas risinājumu SolidJS lietotnēm. Tā koplieto to pašu galveno loģiku, ko Nuxt I18n Micro, piedāvājot reaktīvus tulkojumus, maršrutam specifisku atbalstu un pilnu TypeScript atbalstu.

## Pārskats

`@i18n-micro/solid` ir izstrādāts SolidJS lietotnēm, kurām nepieciešama internacionalizācija bez Nuxt ietvara. Tas nodrošina:
