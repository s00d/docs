...
description: "SolidJS signāli, komponenti un piegādātājs tulkojumiem, lokalizācijas maršrutēšanai un formatēšanai, izmantojot @i18n-micro/solid."
---
...
### Piemērs 1: Custom Router with Signals
...
### Piemērs 2: Query Parameter-Based Locale Routing
