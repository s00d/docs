...
description: "Preact āķi, komponenti un piegādātājs tulkojumiem, lokalizācijas maršrutēšanai un formatēšanai, izmantojot @i18n-micro/preact."
---
...
### Pamata iestatīšana (Without Router)
...
### Iestatīšana With Router Adapter (Wouter Example)
...
### Maršrutētāja adapteris Abstraction
...
### Iestatīšana With Built-in Router Adapter
...
### Piemērs 2: Preact Router Adapter
...
### Piemērs 3: Query Parameter-Based Locale Routing
