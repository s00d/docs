---
title: "Preact pakotne (`@i18n-micro/preact`)"
description: "i18n Preact lietotnēm ar @i18n-micro/preact."
---

# Preact pakotne (`@i18n-micro/preact`)

Pakotne `@i18n-micro/preact` nodrošina vieglu, augstas veiktspējas internacionalizācijas risinājumu **tīrām Preact** lietotnēm. Tā koplieto to pašu galveno loģiku, ko Nuxt I18n Micro, piedāvājot reaktīvus tulkojumus, maršrutam specifisku atbalstu un pilnu TypeScript atbalstu.

## Pārskats

`@i18n-micro/preact` ir izstrādāts tīrām Preact lietotnēm (bez React saderības slāņa), kurām nepieciešama internacionalizācija. Tas nodrošina:
