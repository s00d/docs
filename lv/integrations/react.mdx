---
title: "React pakotne (`@i18n-micro/react`)"
description: "i18n React lietotnēm ar @i18n-micro/react."
---

# React pakotne (`@i18n-micro/react`)

Pakotne `@i18n-micro/react` nodrošina vieglu, augstas veiktspējas internacionalizācijas risinājumu React lietotnēm. Tā koplieto to pašu galveno loģiku, ko Nuxt I18n Micro, piedāvājot reaktīvus tulkojumus, maršrutam specifisku atbalstu un pilnu TypeScript atbalstu.

## Pārskats

`@i18n-micro/react` ir izstrādāts React lietotnēm, kurām nepieciešama internacionalizācija bez Nuxt ietvara. Tas nodrošina:
