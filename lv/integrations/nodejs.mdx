---
title: "Node.js izpildlaiks"
description: "i18n Node.js lietotnēm ar @i18n-micro/node."
---

# 🌐 Node.js izpildlaiks

Izmantojiet `@i18n-micro/node`, lai jebkurai Node.js lietotnei, CLI rīkam vai aizmugures pakalpojumam pievienotu i18n tulkojumus. Šī pakotne nodrošina to pašu tulkošanas loģiku, ko Nuxt modulis, bet tīrām Node.js vidēm.
...
## 🌍 Izmantošana Nuxt servera maršrutos
...
### Integrācija ar maršrutam specifiskiem tulkojumiem
