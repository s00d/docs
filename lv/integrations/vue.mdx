---
title: "Vue pakotne (`@i18n-micro/vue`)"
description: "i18n Vue 3 lietotnēm ar @i18n-micro/vue."
---

# Vue pakotne (`@i18n-micro/vue`)

Pakotne `@i18n-micro/vue` nodrošina vieglu, augstas veiktspējas internacionalizācijas risinājumu Vue 3 lietotnēm. Tā koplieto to pašu galveno loģiku, ko Nuxt I18n Micro, piedāvājot reaktīvus tulkojumus, maršrutam specifisku atbalstu un pilnu TypeScript atbalstu.

## Pārskats

`@i18n-micro/vue` ir izstrādāts Vue 3 lietotnēm, kurām nepieciešama internacionalizācija bez Nuxt ietvara. Tas nodrošina:
