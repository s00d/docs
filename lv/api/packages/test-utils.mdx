...
description: "Paketes @i18n-micro/test-utils publiskais API: Vitest palīgi, mock objekti un fixtures i18n uzvedības testēšanai, ģenerēts no avota."
---

# `@i18n-micro/test-utils`

36 eksporti pa 2 ieejas punktiem.
...
| Eksports | Veids | Paraksts |
| --- | --- | --- |
| `ExportTarget` | interface | 3 dalībnieki |
...
<details>
<summary><code>ExportTarget</code> — 3 dalībnieki</summary>
