...
description: "Paketes @i18n-micro/astro publiskais API: integrācijas ieejas punkts, eksportētie tipi un palīgi, ģenerēts no avota būvēšanas laikā."
---

# `@i18n-micro/astro`

56 eksporti pa 6 ieejas punktiem.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 dalībnieki |
| `AstroI18nOptions` | interface | 9 dalībnieki |
...
| `FormatService` | class | 19 dalībnieki |
...
| `I18nClientProps` | interface | 4 dalībnieki |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 dalībnieki |
| `I18nMiddlewareOptions` | interface | 7 dalībnieki |
| `I18nRoutingStrategy` | interface | 10 dalībnieki |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 dalībnieki |
...
| `LoadTranslationsOptions` | interface | 3 dalībnieki |
| `Locale` | interface | 11 dalībnieki |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 dalībnieki |
| `LocaleHeadResult` | interface | 3 dalībnieki |
...
<details>
<summary><code>AstroI18n</code> — 48 dalībnieki</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 dalībnieki</summary>
...
<details>
<summary><code>FormatService</code> — 19 dalībnieki</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 dalībnieki</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 dalībnieki</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 dalībnieki</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 dalībnieki</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 dalībnieki</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 dalībnieki</summary>
...
<details>
<summary><code>LocaleHeadOptions</code> — 4 dalībnieki</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 dalībnieki</summary>
...
| `I18nState` | interface | 4 dalībnieki |
