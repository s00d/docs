...
description: "Paketes @i18n-micro/path-strategy publiskais API: izpildlaika lokalizācijas ceļa atrisināšana, pāradresācijas un SEO palīgi, ģenerēts no avota."
---

# `@i18n-micro/path-strategy`

38 eksporti pa 6 ieejas punktiem.
...
| `BasePathStrategy` | class | 36 dalībnieki |
...
| `GetRouteBaseNameOptions` | interface | 2 dalībnieki |
...
| `IsIndexRouteNameOptions` | interface | 2 dalībnieki |
| `NoPrefixPathStrategy` | class | 36 dalībnieki |
...
| `PathStrategy` | interface | 22 dalībnieki |
| `PathStrategyContext` | interface | 15 dalībnieki |
| `PrefixAndDefaultPathStrategy` | class | 37 dalībnieki |
| `PrefixExceptDefaultPathStrategy` | class | 44 dalībnieki |
| `PrefixPathStrategy` | class | 36 dalībnieki |
| `ResolvedRouteLike` | interface | 6 dalībnieki |
| `resolvePathWithParams` | function | `(path: string, params?: Record<string, unknown>) => string` |
| `RouteAnalysis` | interface | 2 dalībnieki |
| `RouteLike` | interface | 6 dalībnieki |
| `RouterAdapter` | interface | 3 dalībnieki |
| `SwitchLocaleOptions` | interface | 1 dalībnieki |

<details>
<summary><code>BasePathStrategy</code> — 36 dalībnieki</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2 dalībnieki</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2 dalībnieki</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36 dalībnieki</summary>
...
<details>
<summary><code>PathStrategy</code> — 22 dalībnieki</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15 dalībnieki</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37 dalībnieki</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44 dalībnieki</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36 dalībnieki</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6 dalībnieki</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2 dalībnieki</summary>
...
<details>
<summary><code>RouteLike</code> — 6 dalībnieki</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3 dalībnieki</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 dalībnieki</summary>
