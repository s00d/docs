...
description: "Paketes @i18n-micro/utils publiskais API: būvēšanas palīgi, avota ielādētājs, sapludinātājs un premerge utilītas, ģenerēts no avota būvēšanas laikā."
---

# `@i18n-micro/utils`

102 eksporti pa 24 ieejas punktiem.
...
| `PreMergeLocaleInfo` | interface | 2 dalībnieki |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 dalībnieki</summary>
...
| `CacheControlOptions` | interface | 2 dalībnieki |

<details>
<summary><code>CacheControl</code> — 13 dalībnieki</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 dalībnieki</summary>
...
| Eksports | Veids | Paraksts |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 dalībnieki |
...
| `MergeI18nHeadOptions` | interface | 3 dalībnieki |

<details>
<summary><code>I18nHeadObject</code> — 3 dalībnieki</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 dalībnieki</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 dalībnieki |
...
| `SourceLocaleInfo` | interface | 2 dalībnieki |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 dalībnieki</summary>
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 dalībnieki</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 dalībnieki |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 dalībnieki |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 dalībnieki |
| `TranslationPayloadStats` | interface | 2 dalībnieki |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 dalībnieki</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 dalībnieki</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 dalībnieki</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 dalībnieki</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 dalībnieki |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 dalībnieki</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 dalībnieki |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 dalībnieki</summary>
...
| Eksports | Veids | Paraksts |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 dalībnieki |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 dalībnieki |

<details>
<summary><code>HreflangAlternate</code> — 2 dalībnieki</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 dalībnieki</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 dalībnieki |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 dalībnieki |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 dalībnieki</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 dalībnieki</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 dalībnieki |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 dalībnieki</summary>
...
| `I18nRouteContext` | interface | 3 dalībnieki |
...
<details>
<summary><code>I18nRouteContext</code> — 3 dalībnieki</summary>
...
| `RuntimeI18nOverrides` | interface | 4 dalībnieki |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 dalībnieki</summary>
...
| `TranslationStorageReader` | interface | 1 dalībnieki |

<details>
<summary><code>TranslationStorageReader</code> — 1 dalībnieki</summary>
...
| Eksports | Veids | Paraksts |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 dalībnieki |
| `SplitLocaleRoutePage` | interface | 3 dalībnieki |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 dalībnieki |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 dalībnieki</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 dalībnieki</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 dalībnieki</summary>
