---
title: "Pakotņu API"
description: "Katras darbatelpas pakotnes eksportētais API, nolasīts būvēšanas laikā no momentuzņēmumiem, ko CI pārbauda pret avotu."
---

# Pakotņu API

`nuxt-i18n-micro` ir izveidots no nelielu pakotņu kopas, no kurām lielākā daļa ir izmantojama
pašas par sevi — `@i18n-micro/vue` parastā Vue lietotnē, `@i18n-micro/core` jebkur.

Katra zemāk esošā lapa tiek ģenerēta no API momentuzņēmuma, ko
[`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) pārbauda pret
TypeScript avotiem, tāpēc eksports nevar pazust, ja vien šī atsauce nemainās
vai CI neneizdodas.

{/* generated:packages-index — do not edit; run `pnpm run docs:generate` */}

| Pakotne | Ieejas punkti | Eksporti |
| --- | --- | --- |
...
- [Integrācijas](/integrations/overview) — ceļveži par šo pakotņu izmantošanu katrā ietvarā
