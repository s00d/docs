...
description: "Paketes @i18n-micro/core publiskais API: koplietotās izpildlaika primitīvas un tipi, kas darbina katru ietvara integrāciju, ģenerēts no avota."
---

# `@i18n-micro/core`

50 eksporti pa 3 ieejas punktiem.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 dalībnieki |
| `BaseI18nOptions` | interface | 7 dalībnieki |
...
| `FormatServiceOptions` | interface | 2 dalībnieki |
...
| `MergeTranslationChunkOptions` | interface | 1 dalībnieki |
...
| `ReactiveI18nStore` | interface | 9 dalībnieki |
...
| `TranslationStorage` | interface | 1 dalībnieki |
...
<details>
<summary><code>BaseI18n</code> — 34 dalībnieki</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 dalībnieki</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 dalībnieki</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 dalībnieki</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 dalībnieki</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 dalībnieki</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 dalībnieki |
...
| `I18nDevtoolsInspectorNode` | interface | 4 dalībnieki |
| `I18nDevtoolsStateSnapshot` | interface | 7 dalībnieki |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 dalībnieki</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 dalībnieki</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 dalībnieki</summary>
