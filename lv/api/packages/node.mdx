...
description: "Paketes @i18n-micro/node publiskais API: Node.js izpildlaika adapteris, tulkojumu ielādētāji un eksportētie tipi, ģenerēts no avota."
---

# `@i18n-micro/node`

15 eksporti pa 1 ieejas punktam.
...
| `I18n` | class | 46 dalībnieki |
| `I18nOptions` | interface | 7 dalībnieki |
...
<details>
<summary><code>I18n</code> — 46 dalībnieki</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 dalībnieki</summary>
