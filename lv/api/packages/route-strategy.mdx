...
description: "Paketes @i18n-micro/route-strategy publiskais API: būvēšanas laika lokalizētu maršrutu ģenerēšana Nuxt lapām, ģenerēts no avota."
---

# `@i18n-micro/route-strategy`

18 eksporti pa 1 ieejas punktam.
...
| `RouteGenerator` | class | 23 dalībnieki |
| `RouteGeneratorOptions` | interface | 11 dalībnieki |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 dalībnieki</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 dalībnieki</summary>
