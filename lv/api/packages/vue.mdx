...
description: "Paketes @i18n-micro/vue publiskais API: Vue 3 kompozīti, komponenti un spraudnis tulkojumiem un lokalizācijas maršrutēšanai, no avota."
---

# `@i18n-micro/vue`

27 eksporti pa 1 ieejas punktam.
...
| `UseLocaleHeadOptions` | interface | 5 dalībnieki |
| `VueI18n` | class | 51 dalībnieki |
| `VueI18nOptions` | interface | 6 dalībnieki |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 dalībnieki</summary>
...
<details>
<summary><code>VueI18n</code> — 51 dalībnieki</summary>
