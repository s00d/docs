...
description: "Paketes @i18n-micro/solid publiskais API: SolidJS signāli, komponenti un piegādātājs tulkojumiem un lokalizācijas maršrutēšanai, no avota."
---

# `@i18n-micro/solid`

33 eksporti pa 1 ieejas punktam.
...
| `SolidI18n` | class | 53 dalībnieki |
| `SolidI18nOptions` | interface | 6 dalībnieki |
...
<details>
<summary><code>I18nProviderProps</code> — 4 dalībnieki</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 dalībnieki</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 dalībnieki</summary>
