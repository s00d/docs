...
description: "Izmantojiet nuxt-i18n-micro ar Storybook."
---
...
**Nuxt**, **Storybook** un **nuxt-i18n-micro** integrēšana projektā ļauj veidot izturīgu, lokalizētu lietotni, izmantojot uz komponentiem balstītas izstrādes pieeju. Šis ceļvedis sniedz soli pa solim norādes par to, kā šos rīkus iestatīt kopā, tostarp konfigurāciju, lokalizāciju un Storybook integrāciju.

## 🛠 Nuxt konfigurācija

Lai savā Nuxt projektā iespējotu lokalizāciju un Storybook, konfigurējiet failu `nuxt.config.ts` šādi:
...
Lai integrētu Storybook ar Nuxt un nuxt-i18n-micro, konfigurējiet failu `.storybook/main.ts`, pievienojiet `mergeTranslations` un `staticDirs`.
...
Pilnīgus piemērus meklējiet šajos projektos:

1. **[Nuxt + Storybook + i18n piemērs GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Šis repozitorijs demonstrē, kā integrēt Nuxt, Storybook un nuxt-i18n-micro. Tas ietver iestatīšanas norādījumus un konfigurācijas detaļas.

2. **[Storybook priekš Nuxt dokumentācija](https://storybook.nuxtjs.org/getting-started/setup)**  
   Oficiālā dokumentācija Storybook iestatīšanai ar Nuxt. Tā sniedz detalizētus soļus un labāko praksi.

3. **[Interaktīvs piemērs StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Izpētiet Nuxt, Storybook un nuxt-i18n-micro integrācijas dzīvo piemēru tieši savā pārlūkā.
