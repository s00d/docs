---
title: "Storybook integrācijas ceļvedis"
description: "Integrē Nuxt I18n Micro ar Storybook: konfigurē @nuxtjs/storybook, pievieno lokalizācijas vadīklas un priekšskati komponentus dažādās valodās."
---

# 🌐 Storybook integrācijas ceļvedis

## 📖 Ievads

**Nuxt**, **Storybook** un **nuxt-i18n-micro** integrēšana tavā projektā ļauj tev izveidot stabilu, lokalizētu lietotni ar komponentu virzītu izstrādes pieeju. Šis ceļvedis sniedz soli pa solim aprakstu par šo rīku iestatīšanu kopā, tostarp konfigurāciju, lokalizāciju un Storybook integrāciju.

## 🛠 Nuxt konfigurācija

Lai savā Nuxt projektā iespējotu lokalizāciju un Storybook, konfigurē savu `nuxt.config.ts` failu šādi:
...
## 🛠 Storybook konfigurācija

Lai integrētu Storybook ar Nuxt un nuxt-i18n-micro, konfigurē `.storybook/main.ts` failu, pievieno `mergeTranslations` un `staticDirs`.
...
Pilnus piemērus skati šajos projektos:

1. **[Nuxt + Storybook + i18n piemērs GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**
   Šis repozitorijs demonstrē, kā integrēt Nuxt, Storybook un nuxt-i18n-micro. Tas ietver iestatīšanas instrukcijas un konfigurācijas detaļas.

2. **[Storybook Nuxt dokumentācija](https://storybook.nuxtjs.org/getting-started/setup)**
   Oficiālā dokumentācija Storybook iestatīšanai ar Nuxt. Tā nodrošina detalizētus soļus un labākās prakses.

3. **[Interaktīvs piemērs StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**
   Izpēti Nuxt, Storybook un nuxt-i18n-micro integrācijas dzīvu piemēru tieši savā pārlūkā.
