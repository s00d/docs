---
title: "مسارات اللغة المخصصة"
description: "حدّد مسارات لكل لغة تحت Nuxt I18n Micro لكسب شرائح URL مترجمة والحفاظ على المفاتيح المشتركة."
---

# 🔗 Custom Localized Routes with `localeRoutes` in `Nuxt I18n Micro`

## 📖 مقدمة to `localeRoutes`
