---
title: "واجهة سطر أوامر Nuxt I18n Micro"
description: "استخدم واجهة سطر أوامر nuxt-i18n-micro لأتمتة إدارة ملفات اللغة وترجمة النصوص والحفاظ على مزامنة ملفات JSON."
---
