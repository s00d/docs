...
description: "واجهة API العامة لحزمة @i18n-micro/node: مُكيّف وقت التشغيل لـ Node.js، ومحمّلات الترجمة، والأنواع المُصدَّرة، مولَّدة من المصدر."
---

# `@i18n-micro/node`

15 عملية تصدير عبر نقطة دخول واحدة.
...
| `Translations` | interface | 1 أعضاء |

<code>FormatService</code> — 19 عضواً، مطابقة لـ [`FormatService`](/api/packages/astro).
<details>
<summary><code>I18n</code> — 46 عضواً</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 أعضاء</summary>
...
<code>LoadedTranslations</code> — 2 أعضاء، مطابقة لـ [`LoadedTranslations`](/api/packages/astro).
<code>Locale</code> — 11 عضواً، مطابقة لـ [`Locale`](/api/packages/types).
<code>Translations</code> — 1 أعضاء، مطابقة لـ [`Translations`](/api/packages/types).
