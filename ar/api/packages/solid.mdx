...
description: "واجهة API العامة لحزمة @i18n-micro/solid: إشارات SolidJS ومكوّنات ومزوّد للترجمات وتوجيه اللغة، من المصدر."
---

# `@i18n-micro/solid`

33 عملية تصدير عبر نقطة دخول واحدة.
...
| `SolidI18n` | class | 53 أعضاء |
| `SolidI18nOptions` | interface | 6 أعضاء |
...
<details>
<summary><code>I18nProviderProps</code> — 4 أعضاء</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 أعضاء</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 أعضاء</summary>
...
<code>SolidI18nOptions</code> — 6 أعضاء, مطابقة لـ [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — عضو واحد, مطابقة لـ [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — عضوان, مطابقة لـ [`UseI18nOptions`](/api/packages/preact).
