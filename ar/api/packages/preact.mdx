...
description: "واجهة API العامة لحزمة @i18n-micro/preact: خطاطيف Preact ومكوّنات ومزوّد للترجمات وتوجيه اللغة، مولَّدة من المصدر."
---

# `@i18n-micro/preact`

39 عملية تصدير عبر نقطة دخول واحدة.
...
| `I18nGroupProps` | interface | 301 أعضاء |
| `I18nLink` | const | `(props: I18nLinkProps) => JSX.Element` |
| `I18nLinkProps` | interface | 314 أعضاء |
...
| `PreactI18n` | class | 44 أعضاء |
| `PreactI18nOptions` | interface | 6 أعضاء |
...
| `UseI18nOptions` | interface | عضوان |
| `UseI18nReturn` | interface | 22 أعضاء |
| `useI18nRouter` | const | `() => I18nRoutingStrategy \| null` |

<code>FormatService</code> — 19 أعضاء, مطابقة لـ [`FormatService`](/api/packages/astro).
<details>
<summary><code>I18nGroupProps</code> — 301 أعضاء</summary>
...
<details>
<summary><code>I18nLinkProps</code> — 314 أعضاء</summary>
...
<details>
<summary><code>I18nProviderProps</code> — 5 أعضاء</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 6 أعضاء</summary>
...
<details>
<summary><code>I18nSwitcherProps</code> — 314 أعضاء</summary>
...
<details>
<summary><code>I18nTProps</code> — 311 أعضاء</summary>
...
<code>ModuleOptions</code> — 47 أعضاء, مطابقة لـ [`ModuleOptions`](/api/packages/types).
<details>
<summary><code>PreactI18n</code> — 44 أعضاء</summary>
...
<details>
<summary><code>PreactI18nOptions</code> — 6 أعضاء</summary>
...
<details>
<summary><code>UseI18nOptions</code> — عضوان</summary>
...
<details>
<summary><code>UseI18nReturn</code> — 22 أعضاء</summary>
