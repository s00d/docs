...
description: "واجهة API العامة لحزمة @i18n-micro/route-strategy: توليد مسارات مترجمة في وقت البناء لصفحات Nuxt، مولَّدة من المصدر."
---

# `@i18n-micro/route-strategy`

18 عملية تصدير عبر نقطة دخول واحدة.
...
| `RouteGenerator` | class | 23 أعضاء |
| `RouteGeneratorOptions` | interface | 11 أعضاء |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 أعضاء</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 أعضاء</summary>
