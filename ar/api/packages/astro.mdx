...
description: "واجهة API العامة لحزمة @i18n-micro/astro: مُكيّف الوحدة لـ Astro، ومزوّدات جانب العميل لكل إطار، والأنواع المُصدَّرة، مولَّدة من المصدر."
---

# `@i18n-micro/astro`

56 عملية تصدير عبر 6 نقاط دخول.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 أعضاء |
| `AstroI18nOptions` | interface | 9 أعضاء |
...
| `I18nClientProps` | interface | 4 أعضاء |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 أعضاء |
| `I18nMiddlewareOptions` | interface | 7 أعضاء |
| `I18nRoutingStrategy` | interface | 10 أعضاء |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | عضوان |
...
| `LoadTranslationsOptions` | interface | 3 أعضاء |
| `Locale` | interface | 11 أعضاء |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 أعضاء |
| `LocaleHeadResult` | interface | 3 أعضاء |
...
<details>
<summary><code>AstroI18n</code> — 48 أعضاء</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 أعضاء</summary>
...
<details>
<summary><code>FormatService</code> — 19 أعضاء</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 أعضاء</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 أعضاء</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 أعضاء</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 أعضاء</summary>
...
<details>
<summary><code>LoadedTranslations</code> — عضوان</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 أعضاء</summary>
...
<code>Locale</code> — 11 أعضاء, مطابقة لـ [`Locale`](/api/packages/types).
<details>
<summary><code>LocaleHeadOptions</code> — 4 أعضاء</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 أعضاء</summary>
...
<code>Translations</code> — عضو واحد, مطابقة لـ [`Translations`](/api/packages/types).
...
<code>I18nState</code> — 4 أعضاء, مطابقة لـ `I18nClientProps` أعلاه.
