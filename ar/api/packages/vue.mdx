...
description: "واجهة API العامة لحزمة @i18n-micro/vue: تكامل Vue 3، وإضافة I18n، والـ composables، والمكوّنات، مولَّدة من المصدر."
---

# `@i18n-micro/vue`

27 عملية تصدير عبر نقطة دخول واحدة.
...
| `UseLocaleHeadOptions` | interface | 5 أعضاء |
| `VueI18n` | class | 51 أعضاء |
| `VueI18nOptions` | interface | 6 أعضاء |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 أعضاء</summary>
...
<details>
<summary><code>VueI18n</code> — 51 أعضاء</summary>
...
<code>VueI18nOptions</code> — 6 أعضاء, مطابقة لـ [`PreactI18nOptions`](/api/packages/preact).
