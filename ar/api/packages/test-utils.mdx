...
description: "واجهة API العامة لحزمة @i18n-micro/test-utils: مساعدات Vitest، ومحاكيات، وتركيبات لاختبار سلوك i18n، مولَّدة من المصدر."
---

# `@i18n-micro/test-utils`

36 عملية تصدير عبر نقطتي دخول.
...
| التصدير | النوع | التوقيع |
| --- | --- | --- |
| `ExportTarget` | interface | 3 أعضاء |
...
<details>
<summary><code>ExportTarget</code> — 3 أعضاء</summary>
