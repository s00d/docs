...
description: "واجهة API العامة لحزمة @i18n-micro/core: نواة وقت التشغيل المشتركة، بما في ذلك FormatService، ومساعدات DevTools، والأنواع، مولَّدة من المصدر."
---

# `@i18n-micro/core`

50 عملية تصدير عبر 3 نقاط دخول.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 أعضاء |
| `BaseI18nOptions` | interface | 7 أعضاء |
...
| `FormatServiceOptions` | interface | عضوان |
...
| `MergeTranslationChunkOptions` | interface | عضو واحد |
...
| `ReactiveI18nStore` | interface | 9 أعضاء |
...
| `TranslationStorage` | interface | عضو واحد |
...
<details>
<summary><code>BaseI18n</code> — 34 أعضاء</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 أعضاء</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — عضوان</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — عضو واحد</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 أعضاء</summary>
...
<details>
<summary><code>TranslationStorage</code> — عضو واحد</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 أعضاء |
...
| `I18nDevtoolsInspectorNode` | interface | 4 أعضاء |
| `I18nDevtoolsStateSnapshot` | interface | 7 أعضاء |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 أعضاء</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 أعضاء</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 أعضاء</summary>
...
<code>MergeTranslationChunkOptions</code> — عضو واحد, مطابقة لـ `MergeTranslationChunkOptions` أعلاه.
