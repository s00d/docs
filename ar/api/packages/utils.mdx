...
description: "واجهة API العامة لحزمة @i18n-micro/utils: أدوات مساعدة مشتركة تُستخدم عبر مساحة العمل بأكملها، مولَّدة من المصدر."
---

# `@i18n-micro/utils`

102 عملية تصدير across 24 entry points.
...
| `PreMergeLocaleInfo` | interface | عضوان |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — عضوان</summary>
...
| `CacheControlOptions` | interface | عضوان |

<details>
<summary><code>CacheControl</code> — 13 أعضاء</summary>
...
<details>
<summary><code>CacheControlOptions</code> — عضوان</summary>
...
| التصدير | النوع | التوقيع |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 أعضاء |
...
| `MergeI18nHeadOptions` | interface | 3 أعضاء |

<details>
<summary><code>I18nHeadObject</code> — 3 أعضاء</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 أعضاء</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 أعضاء |
...
| `SourceLocaleInfo` | interface | عضوان |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 أعضاء</summary>
...
<code>SourceLocaleInfo</code> — عضوان, مطابقة لـ `PreMergeLocaleInfo` أعلاه.
...
<details>
<summary><code>TranslationFileBuckets</code> — عضوان</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 أعضاء |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 أعضاء |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | عضوان |
| `TranslationPayloadStats` | interface | عضوان |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 أعضاء</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 أعضاء</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — عضوان</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — عضوان</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 أعضاء |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 أعضاء</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 أعضاء |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 أعضاء</summary>
...
| التصدير | النوع | التوقيع |
| --- | --- | --- |
| `HreflangAlternate` | interface | عضوان |
...
| `ResolveHreflangAlternatesOptions` | interface | عضو واحد |

<details>
<summary><code>HreflangAlternate</code> — عضوان</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — عضو واحد</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 أعضاء |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 أعضاء |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 أعضاء</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 أعضاء</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | عضوان |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — عضوان</summary>
...
| `I18nRouteContext` | interface | 3 أعضاء |
...
<details>
<summary><code>I18nRouteContext</code> — 3 أعضاء</summary>
...
| `RuntimeI18nOverrides` | interface | 4 أعضاء |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 أعضاء</summary>
...
| `TranslationStorageReader` | interface | عضو واحد |

<details>
<summary><code>TranslationStorageReader</code> — عضو واحد</summary>
...
| التصدير | النوع | التوقيع |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 أعضاء |
| `SplitLocaleRoutePage` | interface | 3 أعضاء |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | عضوان |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 أعضاء</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 أعضاء</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — عضوان</summary>
