---
title: "تكامل Preact"
description: "استخدم @i18n-micro/preact لإضافة الترجمات وتبديل اللغة والتوجيه المترجم إلى تطبيقات Preact."
---
...
### الإعداد With Router Adapter (Wouter Example)
...
### الإعداد With Built-in Router Adapter
...
### مثال 3: Query Parameter-Based Locale Routing
