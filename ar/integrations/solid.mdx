---
title: "تكامل Solid"
description: "استخدم @i18n-micro/solid لإضافة الترجمات التفاعلية والمكوّنات إلى تطبيقات SolidJS."
---
...
### مثال 1: Custom Router with Signals
...
### مثال 2: Query Parameter-Based Locale Routing
