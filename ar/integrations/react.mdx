---
title: "تكامل React"
description: "استخدم @i18n-micro/preact مع React لإضافة الترجمات وتبديل اللغة والتوجيه المترجم إلى تطبيقات React."
---
...
### مثال 2: TanStack Router Adapter
