---
title: "自定义本地化路由"
description: "通过 globalLocaleRoutes、defineI18nRoute 及别名让 Nuxt I18n Micro 使用与语言相关的完全本地化 URL。"
---
...
**重要**： `$setI18nRouteParams` should be called after fetching data that contains locale-specific slugs, typically inside `useFetch` or `useAsyncData`.
