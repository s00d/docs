---
title: "在 `Nuxt I18n Micro` 中通过 `localeRoutes` 自定义本地化路由"
description: "使用 localeRoutes 为每种语言自定义路由。"
---

# 🔗 在 `Nuxt I18n Micro` 中通过 `localeRoutes` 自定义本地化路由
...
## 🎯 结合 slug 与 `$setI18nRouteParams` 的动态路由
