...
description: "@i18n-micro/core 的导出 API,由源代码生成。"
---
...
| 导出 | 类别 | 签名 |
| --- | --- | --- |
| `BaseI18n` | class | 34 个成员 |
| `BaseI18nOptions` | interface | 7 个成员 |
...
| `FormatServiceOptions` | interface | 2 个成员 |
...
| `MergeTranslationChunkOptions` | interface | 1 个成员 |
...
| `ReactiveI18nStore` | interface | 9 个成员 |
...
| `TranslationStorage` | interface | 1 个成员 |
...
<details>
<summary><code>BaseI18n</code> —— 34 个成员</summary>
...
<details>
<summary><code>BaseI18nOptions</code> —— 7 个成员</summary>
...
<details>
<summary><code>FormatServiceOptions</code> —— 2 个成员</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> —— 1 个成员</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> —— 9 个成员</summary>
...
<details>
<summary><code>TranslationStorage</code> —— 1 个成员</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 个成员 |
...
| `I18nDevtoolsInspectorNode` | interface | 4 个成员 |
| `I18nDevtoolsStateSnapshot` | interface | 7 个成员 |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> —— 6 个成员</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> —— 4 个成员</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> —— 7 个成员</summary>
