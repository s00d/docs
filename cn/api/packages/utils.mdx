...
description: "@i18n-micro/utils 的导出 API,由源代码生成。"
---
...
| `PreMergeLocaleInfo` | interface | 2 个成员 |
...
<details>
<summary><code>PreMergeLocaleInfo</code> —— 2 个成员</summary>
...
| `CacheControlOptions` | interface | 2 个成员 |

<details>
<summary><code>CacheControl</code> —— 13 个成员</summary>
...
<details>
<summary><code>CacheControlOptions</code> —— 2 个成员</summary>
...
| 导出 | 类别 | 签名 |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 个成员 |
...
| `MergeI18nHeadOptions` | interface | 3 个成员 |

<details>
<summary><code>I18nHeadObject</code> —— 3 个成员</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> —— 3 个成员</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 个成员 |
...
| `SourceLocaleInfo` | interface | 2 个成员 |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> —— 6 个成员</summary>
...
<details>
<summary><code>TranslationFileBuckets</code> —— 2 个成员</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 个成员 |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 个成员 |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 个成员 |
| `TranslationPayloadStats` | interface | 2 个成员 |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> —— 8 个成员</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> —— 3 个成员</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> —— 2 个成员</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> —— 2 个成员</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 个成员 |

<details>
<summary><code>TranslationPayloadHostConfig</code> —— 3 个成员</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 个成员 |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> —— 9 个成员</summary>
...
| 导出 | 类别 | 签名 |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 个成员 |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 个成员 |

<details>
<summary><code>HreflangAlternate</code> —— 2 个成员</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> —— 1 个成员</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 个成员 |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 个成员 |

<details>
<summary><code>ResolvePreferredLocaleInput</code> —— 7 个成员</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> —— 8 个成员</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 个成员 |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> —— 2 个成员</summary>
...
| `I18nRouteContext` | interface | 3 个成员 |
...
<details>
<summary><code>I18nRouteContext</code> —— 3 个成员</summary>
...
| `RuntimeI18nOverrides` | interface | 4 个成员 |

<details>
<summary><code>RuntimeI18nOverrides</code> —— 4 个成员</summary>
...
| `TranslationStorageReader` | interface | 1 个成员 |

<details>
<summary><code>TranslationStorageReader</code> —— 1 个成员</summary>
...
| 导出 | 类别 | 签名 |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 个成员 |
| `SplitLocaleRoutePage` | interface | 3 个成员 |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 个成员 |

<details>
<summary><code>SplitLocaleRouteEntry</code> —— 4 个成员</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> —— 3 个成员</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> —— 2 个成员</summary>
