...
description: "@i18n-micro/route-strategy 的导出 API,由源代码生成。"
---
...
| `RouteGenerator` | class | 23 个成员 |
| `RouteGeneratorOptions` | interface | 11 个成员 |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> —— 23 个成员</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> —— 11 个成员</summary>
