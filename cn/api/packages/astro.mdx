...
description: "@i18n-micro/astro 的导出 API,由源代码生成。"
---
...
| 导出 | 类别 | 签名 |
| --- | --- | --- |
| `AstroI18n` | class | 48 个成员 |
| `AstroI18nOptions` | interface | 9 个成员 |
...
| `I18nClientProps` | interface | 4 个成员 |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 个成员 |
| `I18nMiddlewareOptions` | interface | 7 个成员 |
| `I18nRoutingStrategy` | interface | 10 个成员 |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 个成员 |
...
| `LoadTranslationsOptions` | interface | 3 个成员 |
| `Locale` | interface | 11 个成员 |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 个成员 |
| `LocaleHeadResult` | interface | 3 个成员 |
...
<details>
<summary><code>AstroI18n</code> —— 48 个成员</summary>
...
<details>
<summary><code>AstroI18nOptions</code> —— 9 个成员</summary>
...
<details>
<summary><code>FormatService</code> —— 19 个成员</summary>
...
<details>
<summary><code>I18nClientProps</code> —— 4 个成员</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> —— 53 个成员</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> —— 7 个成员</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> —— 10 个成员</summary>
...
<details>
<summary><code>LoadedTranslations</code> —— 2 个成员</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> —— 3 个成员</summary>
...
<details>
<summary><code>LocaleHeadOptions</code> —— 4 个成员</summary>
...
<details>
<summary><code>LocaleHeadResult</code> —— 3 个成员</summary>
