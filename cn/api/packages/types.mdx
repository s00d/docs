...
description: "@i18n-micro/types 的导出 API,由源代码生成。"
---
...
| `DefineI18nRouteConfig` | interface | 3 个成员 |
| `DefineLocaleMessage` | interface | 1 个成员 |
...
| `I18nHeadInput` | interface | 5 个成员 |
| `I18nHeadLink` | interface | 4 个成员 |
| `I18nHeadMeta` | interface | 1 个成员 |
...
| `ModuleOptions` | interface | 47 个成员 |
| `ModuleOptionsExtend` | interface | 50 个成员 |
| `ModulePrivateOptionsExtend` | interface | 50 个成员 |
...
| `PluralTranslations` | interface | 2 个成员 |
...
| `TranslationPayloadOptions` | interface | 8 个成员 |
| `Translations` | interface | 1 个成员 |

<details>
<summary><code>DefineI18nRouteConfig</code> —— 3 个成员</summary>
...
<details>
<summary><code>DefineLocaleMessage</code> —— 1 个成员</summary>
...
<details>
<summary><code>I18nHeadInput</code> —— 5 个成员</summary>
...
<details>
<summary><code>I18nHeadLink</code> —— 4 个成员</summary>
...
<details>
<summary><code>I18nHeadMeta</code> —— 1 个成员</summary>
...
<details>
<summary><code>Locale</code> —— 11 个成员</summary>
...
<details>
<summary><code>ModuleOptions</code> —— 47 个成员</summary>
...
<details>
<summary><code>ModuleOptionsExtend</code> —— 50 个成员</summary>
...
<details>
<summary><code>ModulePrivateOptionsExtend</code> —— 50 个成员</summary>
...
<details>
<summary><code>PluralTranslations</code> —— 2 个成员</summary>
...
<details>
<summary><code>TranslationPayloadOptions</code> —— 8 个成员</summary>
...
<details>
<summary><code>Translations</code> —— 1 个成员</summary>
