...
description: "@i18n-micro/vue 的导出 API,由源代码生成。"
---
...
| `UseLocaleHeadOptions` | interface | 5 个成员 |
| `VueI18n` | class | 51 个成员 |
| `VueI18nOptions` | interface | 6 个成员 |
...
<details>
<summary><code>UseLocaleHeadOptions</code> —— 5 个成员</summary>
...
<details>
<summary><code>VueI18n</code> —— 51 个成员</summary>
