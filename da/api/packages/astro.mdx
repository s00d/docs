...
description: "Eksporteret API for @i18n-micro/astro, genereret fra kildekoden."
---

# `@i18n-micro/astro`

56 eksporter fordelt på 6 entry points.
...
<code>I18nState</code> — 4 medlemmer, identisk med `I18nClientProps` ovenfor.
