...
description: "Offentligt API for pakken @i18n-micro/astro: integrationens indgangspunkt, eksporterede typer og hjælpere, genereret fra kilden ved buildtid."
---

# `@i18n-micro/astro`

56 eksporter fordelt på 6 indgangspunkter.
