...
description: "Offentligt API for pakken @i18n-micro/solid: SolidJS-signals, komponenter og provider til oversættelser og locale-routing, fra kilden."
---

# `@i18n-micro/solid`

33 eksporter fordelt på 1 indgangspunkt.
