...
description: "Eksporteret API for @i18n-micro/path-strategy, genereret fra kildekoden."
---

# `@i18n-micro/path-strategy`

38 eksporter fordelt på 6 entry points.
...
<code>NoPrefixPathStrategy</code> — 36 medlemmer, identisk med `NoPrefixPathStrategy` ovenfor.
<code>Strategy</code> — 36 medlemmer, identisk med `NoPrefixPathStrategy` ovenfor.
...
<code>PrefixPathStrategy</code> — 36 medlemmer, identisk med `PrefixPathStrategy` ovenfor.
<code>Strategy</code> — 36 medlemmer, identisk med `PrefixPathStrategy` ovenfor.
...
<code>PrefixAndDefaultPathStrategy</code> — 37 medlemmer, identisk med `PrefixAndDefaultPathStrategy` ovenfor.
<code>Strategy</code> — 37 medlemmer, identisk med `PrefixAndDefaultPathStrategy` ovenfor.
...
<code>PrefixExceptDefaultPathStrategy</code> — 44 medlemmer, identisk med `PrefixExceptDefaultPathStrategy` ovenfor.
<code>Strategy</code> — 44 medlemmer, identisk med `PrefixExceptDefaultPathStrategy` ovenfor.
...
<code>PathStrategy</code> — 22 medlemmer, identisk med `PathStrategy` ovenfor.
<code>PathStrategyContext</code> — 15 medlemmer, identisk med `PathStrategyContext` ovenfor.
<code>ResolvedRouteLike</code> — 6 medlemmer, identisk med `ResolvedRouteLike` ovenfor.
<code>RouteLike</code> — 6 medlemmer, identisk med `RouteLike` ovenfor.
<code>RouterAdapter</code> — 3 medlemmer, identisk med `RouterAdapter` ovenfor.
<code>SwitchLocaleOptions</code> — 1 medlemmer, identisk med `SwitchLocaleOptions` ovenfor.
