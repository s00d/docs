...
description: "Offentligt API for pakken @i18n-micro/path-strategy: runtime-opløsning af locale-stier, redirects og SEO-hjælpere, genereret fra kilden."
---

# `@i18n-micro/path-strategy`

38 eksporter fordelt på 6 indgangspunkter.
