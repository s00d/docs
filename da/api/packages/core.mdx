...
description: "Eksporteret API for @i18n-micro/core, genereret fra kildekoden."
---

# `@i18n-micro/core`

50 eksporter fordelt på 3 entry points.
...
<code>MergeTranslationChunkOptions</code> — 1 medlemmer, identisk med `MergeTranslationChunkOptions` ovenfor.
