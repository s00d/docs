...
description: "Offentligt API for pakken @i18n-micro/core: delte runtime-primitiver og typer, der driver alle framework-integrationer, genereret fra kilden."
---

# `@i18n-micro/core`

50 eksporter fordelt på 3 indgangspunkter.
