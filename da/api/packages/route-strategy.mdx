...
description: "Offentligt API for pakken @i18n-micro/route-strategy: lokaliseret rutegenerering ved buildtid for Nuxt-sider, genereret fra kilden."
---

# `@i18n-micro/route-strategy`

18 eksporter fordelt på 1 indgangspunkt.
