...
description: "Offentligt API for pakken @i18n-micro/types: delte TypeScript-definitioner brugt på tværs af framework-integrationer, genereret fra kilden."
---

# `@i18n-micro/types`

26 eksporter fordelt på 1 indgangspunkt.
