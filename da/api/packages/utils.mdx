...
description: "Eksporteret API for @i18n-micro/utils, genereret fra kildekoden."
---

# `@i18n-micro/utils`

102 eksporter fordelt på 24 entry points.
...
<code>SourceLocaleInfo</code> — 2 medlemmer, identisk med `PreMergeLocaleInfo` ovenfor.
