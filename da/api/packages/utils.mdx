...
description: "Offentligt API for pakken @i18n-micro/utils: build-hjælpere, source-loader, merger og premerge-utilities, genereret fra kilden ved buildtid."
---

# `@i18n-micro/utils`

102 eksporter fordelt på 24 indgangspunkter.
