...
description: "Offentligt API for pakken @i18n-micro/vue: Vue 3-composables, komponenter og plugin til oversættelser og locale-routing, fra kilden."
---

# `@i18n-micro/vue`

27 eksporter fordelt på 1 indgangspunkt.
