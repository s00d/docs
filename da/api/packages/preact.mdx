...
description: "Offentligt API for pakken @i18n-micro/preact: Preact-hooks, komponenter og provider til oversættelser og routing, genereret fra kilden."
---

# `@i18n-micro/preact`

39 eksporter fordelt på 1 indgangspunkt.
