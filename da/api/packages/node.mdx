...
description: "Offentligt API for pakken @i18n-micro/node: Node.js runtime-adapter, oversættelses-loaders og eksporterede typer, genereret fra kilden."
---

# `@i18n-micro/node`

15 eksporter fordelt på 1 indgangspunkt.
