---
title: "Guide til Storybook-integration"
description: "Integrer Nuxt I18n Micro med Storybook: konfigurer @nuxtjs/storybook, tilføj locale-kontroller og forhåndsvis komponenter på tværs af sprog."
---

# 🌐 Guide til Storybook-integration

## 📖 Introduktion

Ved at integrere **Nuxt**, **Storybook** og **nuxt-i18n-micro** i dit projekt kan du bygge en robust, lokaliseret applikation med en komponent-drevet udviklingstilgang. Denne guide giver en trin-for-trin gennemgang af opsætning af disse værktøjer sammen, inklusive konfiguration, lokalisering og Storybook-integration.

## 🛠 Nuxt-konfiguration

For at aktivere lokalisering og Storybook i dit Nuxt-projekt skal du konfigurere din `nuxt.config.ts`-fil som følger:
...
For at integrere Storybook med Nuxt og nuxt-i18n-micro skal du konfigurere `.storybook/main.ts`-filen og tilføje `mergeTranslations` og `staticDirs`.
...
For komplette eksempler kan du tjekke disse projekter:

1. **[Nuxt + Storybook + i18n-eksempel på GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Dette repository viser, hvordan man integrerer Nuxt, Storybook og nuxt-i18n-micro. Det indeholder opsætningsinstruktioner og konfigurationsdetaljer.

2. **[Storybook for Nuxt-dokumentation](https://storybook.nuxtjs.org/getting-started/setup)**  
   Den officielle dokumentation for at opsætte Storybook med Nuxt. Den indeholder detaljerede trin og bedste praksis.
