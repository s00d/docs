---
title: "Balíček Solid (`@i18n-micro/solid`)"
description: "Použijte @i18n-micro/solid pro přidání signálů, komponent a provideru pro překlady a locale-aware routování v SolidJS aplikacích."
---
...
### Příklad 1: Custom Router with Signals
...
### Příklad 2: Query Parameter-Based Locale Routing
