---
title: "Balíček Astro (`@i18n-micro/astro`)"
description: "Použijte @i18n-micro/astro pro přidání locale routování, překladů a SEO pomocníků do Astro projektů se sdíleným runtime @i18n-micro/core."
---
...
### Základní nastavení (Without Router Adapter)
...
### Příklad 1: Subdomain-Based Locale Routing
...
### Příklad 3: Suffix-Based Locale Routing
...
### Příklad 4: Integration with Third-Party Router
