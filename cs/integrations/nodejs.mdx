---
title: "Node.js runtime s @i18n-micro/node"
description: "Použijte @i18n-micro/node pro načítání překladů a detekci locale v běžných Node.js serverech, workerech a CLI bez připojeného UI frameworku."
---
