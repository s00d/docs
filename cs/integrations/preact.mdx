---
title: "Balíček Preact (`@i18n-micro/preact`)"
description: "Použijte @i18n-micro/preact pro přidání překladů, přepínání locale a locale-aware routování do Preact aplikací s Nuxt-like vývojářským zážitkem."
---
...
Nainstalujte balíček preferovaným package managerem:
...
### Základní nastavení (Without Router)
...
### Nastavení With Router Adapter (Wouter Example)
...
### Nastavení With Built-in Router Adapter
...
### Příklad 2: Preact Router Adapter
...
### Příklad 3: Query Parameter-Based Locale Routing
