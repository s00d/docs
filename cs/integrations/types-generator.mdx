---
title: "Generátor typů pro locale JSON"
description: "Použijte @i18n-micro/types-generator pro emitování TypeScript typů z vašeho locale JSON. Získáte plné autocompletion a bezpečnost pro $t a pomocníky."
---
...
Nainstalujte balíček jako dev závislost:
