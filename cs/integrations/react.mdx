---
title: "Balíček React (`@i18n-micro/react`)"
description: "Použijte @i18n-micro/react pro přidání hooků, komponent a provideru pro překlady a locale-aware routování v React aplikacích a frameworcích."
---
...
### Příklad 1: Next.js Router Adapter
...
### Příklad 2: TanStack Router Adapter
