---
title: "Balíček Vue (`@i18n-micro/vue`)"
description: "Použijte @i18n-micro/vue pro standalone Vue 3 aplikace: sdílené i18n composables, komponenty a integrace s routerem bez Nuxtu."
---
