---
title: "Balíček DevTools UI (`@i18n-micro/devtools-ui`)"
description: "Použijte @i18n-micro/devtools-ui jako samostatné DevTools UI a Vite plugin pro procházení překladů a úpravu locale v jakémkoli @i18n-micro projektu."
---
...
Balíček poskytuje a universal bridge creation function that works with any i18n implementation:
...
Balíček poskytuje full TypeScript support:
