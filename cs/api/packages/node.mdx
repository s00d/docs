...
description: "Veřejné API balíčku @i18n-micro/node: Node.js server-side runtime pro načítání a slučování překladů, generováno ze zdroje."
---

# `@i18n-micro/node`

15 exportů v 1 vstupním bodě.
...
<details>
<summary><code>I18n</code> — 46 členů</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 členů</summary>
...
<code>LoadedTranslations</code> — 2 členů, identical to [`LoadedTranslations`](/api/packages/astro).
