...
description: "Veřejné API balíčku @i18n-micro/utils: build pomocníci, source loader, merger a premerge nástroje, generováno ze zdroje v době buildu."
---

# `@i18n-micro/utils`

102 exportů napříč 24 vstupními body.
...
| `PreMergeLocaleInfo` | interface | 2 členů |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 členů</summary>
...
| `CacheControlOptions` | interface | 2 členů |

<details>
<summary><code>CacheControl</code> — 13 členů</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 členů</summary>
...
| Export | Druh | Signatura |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 členů |
...
| `MergeI18nHeadOptions` | interface | 3 členů |

<details>
<summary><code>I18nHeadObject</code> — 3 členů</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 členů</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 členů |
...
| `SourceLocaleInfo` | interface | 2 členů |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 členů</summary>
...
<code>SourceLocaleInfo</code> — 2 členů, identical to `PreMergeLocaleInfo` above.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 členů</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 členů |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 členů |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 členů |
| `TranslationPayloadStats` | interface | 2 členů |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 členů</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 členů</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 členů</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 členů</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 členů |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 členů</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 členů |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 členů</summary>
...
| Export | Druh | Signatura |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 členů |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 členů |

<details>
<summary><code>HreflangAlternate</code> — 2 členů</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 členů</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 členů |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 členů |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 členů</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 členů</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 členů |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 členů</summary>
...
| `I18nRouteContext` | interface | 3 členů |
...
<details>
<summary><code>I18nRouteContext</code> — 3 členů</summary>
...
| `RuntimeI18nOverrides` | interface | 4 členů |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 členů</summary>
...
| `TranslationStorageReader` | interface | 1 členů |

<details>
<summary><code>TranslationStorageReader</code> — 1 členů</summary>
...
| Export | Druh | Signatura |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 členů |
| `SplitLocaleRoutePage` | interface | 3 členů |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 členů |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 členů</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 členů</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 členů</summary>
