...
description: "Veřejné API balíčku @i18n-micro/astro: vstupní bod integrace, exportované typy a pomocníci, generováno ze zdroje v době buildu."
---

# `@i18n-micro/astro`

56 exportů napříč 6 vstupními body.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 členů |
| `AstroI18nOptions` | interface | 9 členů |
...
| `I18nClientProps` | interface | 4 členů |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 členů |
| `I18nMiddlewareOptions` | interface | 7 členů |
| `I18nRoutingStrategy` | interface | 10 členů |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 členů |
...
| `LoadTranslationsOptions` | interface | 3 členů |
| `Locale` | interface | 11 členů |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 členů |
| `LocaleHeadResult` | interface | 3 členů |
...
<details>
<summary><code>AstroI18n</code> — 48 členů</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 členů</summary>
...
<details>
<summary><code>FormatService</code> — 19 členů</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 členů</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 členů</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 členů</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 členů</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 členů</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 členů</summary>
...
<code>Locale</code> — 11 členů, identical to [`Locale`](/api/packages/types).
<details>
<summary><code>LocaleHeadOptions</code> — 4 členů</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 členů</summary>
...
<code>Translations</code> — 1 členů, identical to [`Translations`](/api/packages/types).
...
<code>I18nState</code> — 4 členů, identical to `I18nClientProps` above.
