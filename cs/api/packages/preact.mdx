...
description: "Veřejné API balíčku @i18n-micro/preact: Preact komponenty, hooky a provider pro překlady a locale routování, ze zdroje."
---

# `@i18n-micro/preact`

39 exportů v 1 vstupním bodě.
...
| `I18nGroupProps` | interface | 301 členů |
| `I18nLink` | const | `(props: I18nLinkProps) => JSX.Element` |
| `I18nLinkProps` | interface | 314 členů |
...
| `PreactI18n` | class | 44 členů |
| `PreactI18nOptions` | interface | 6 členů |
...
| `UseI18nOptions` | interface | 2 členů |
| `UseI18nReturn` | interface | 22 členů |
| `useI18nRouter` | const | `() => I18nRoutingStrategy \| null` |

<code>FormatService</code> — 19 členů, identical to [`FormatService`](/api/packages/astro).
<details>
<summary><code>I18nGroupProps</code> — 301 členů</summary>
...
<details>
<summary><code>I18nLinkProps</code> — 314 členů</summary>
...
<details>
<summary><code>I18nProviderProps</code> — 5 členů</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 6 členů</summary>
...
<details>
<summary><code>I18nSwitcherProps</code> — 314 členů</summary>
...
<details>
<summary><code>I18nTProps</code> — 311 členů</summary>
...
<code>ModuleOptions</code> — 47 členů, identical to [`ModuleOptions`](/api/packages/types).
<details>
<summary><code>PreactI18n</code> — 44 členů</summary>
...
<details>
<summary><code>PreactI18nOptions</code> — 6 členů</summary>
...
<details>
<summary><code>UseI18nOptions</code> — 2 členů</summary>
...
<details>
<summary><code>UseI18nReturn</code> — 22 členů</summary>
