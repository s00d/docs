...
description: "Veřejné API balíčku @i18n-micro/path-strategy: runtime routovací strategie mapující cesty na kódy locale, generováno ze zdroje."
---

# `@i18n-micro/path-strategy`

38 exportů napříč 6 vstupními body.
...
| `BasePathStrategy` | class | 36 členů |
...
| `GetRouteBaseNameOptions` | interface | 2 členů |
...
| `IsIndexRouteNameOptions` | interface | 2 členů |
| `NoPrefixPathStrategy` | class | 36 členů |
...
| `PathStrategy` | interface | 22 členů |
| `PathStrategyContext` | interface | 15 členů |
| `PrefixAndDefaultPathStrategy` | class | 37 členů |
| `PrefixExceptDefaultPathStrategy` | class | 44 členů |
| `PrefixPathStrategy` | class | 36 členů |
| `ResolvedRouteLike` | interface | 6 členů |
| `resolvePathWithParams` | function | `(path: string, params?: Record<string, unknown>) => string` |
| `RouteAnalysis` | interface | 2 členů |
| `RouteLike` | interface | 6 členů |
| `RouterAdapter` | interface | 3 členů |
| `SwitchLocaleOptions` | interface | 1 členů |

<details>
<summary><code>BasePathStrategy</code> — 36 členů</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2 členů</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2 členů</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36 členů</summary>
...
<details>
<summary><code>PathStrategy</code> — 22 členů</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15 členů</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37 členů</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44 členů</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36 členů</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6 členů</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2 členů</summary>
...
<details>
<summary><code>RouteLike</code> — 6 členů</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3 členů</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 členů</summary>
...
| --- | --- | --- |
| `NoPrefixPathStrategy` | class | 36 členů |
| `Strategy` | class | 36 členů |

<code>NoPrefixPathStrategy</code> — 36 členů, identical to `NoPrefixPathStrategy` above.
<code>Strategy</code> — 36 členů, identical to `NoPrefixPathStrategy` above.
...
<code>PrefixPathStrategy</code> — 36 členů, identical to `PrefixPathStrategy` above.
<code>Strategy</code> — 36 členů, identical to `PrefixPathStrategy` above.
...
| --- | --- | --- |
| `PrefixAndDefaultPathStrategy` | class | 37 členů |
| `Strategy` | class | 37 členů |

<code>PrefixAndDefaultPathStrategy</code> — 37 členů, identical to `PrefixAndDefaultPathStrategy` above.
<code>Strategy</code> — 37 členů, identical to `PrefixAndDefaultPathStrategy` above.
...
| --- | --- | --- |
| `PrefixExceptDefaultPathStrategy` | class | 44 členů |
| `Strategy` | class | 44 členů |

<code>PrefixExceptDefaultPathStrategy</code> — 44 členů, identical to `PrefixExceptDefaultPathStrategy` above.
<code>Strategy</code> — 44 členů, identical to `PrefixExceptDefaultPathStrategy` above.
...
<code>PathStrategy</code> — 22 členů, identical to `PathStrategy` above.
<code>PathStrategyContext</code> — 15 členů, identical to `PathStrategyContext` above.
<code>ResolvedRouteLike</code> — 6 členů, identical to `ResolvedRouteLike` above.
<code>RouteLike</code> — 6 členů, identical to `RouteLike` above.
<code>RouterAdapter</code> — 3 členů, identical to `RouterAdapter` above.
<code>SwitchLocaleOptions</code> — 1 členů, identical to `SwitchLocaleOptions` above.
