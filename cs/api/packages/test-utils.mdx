...
description: "Veřejné API balíčku @i18n-micro/test-utils: Vitest pomocníci, mocky a fixture pro testování chování i18n, generováno ze zdroje."
---

# `@i18n-micro/test-utils`

36 exportů napříč 2 vstupními body. Generováno z API snapshotu, který [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) porovnává s TypeScript zdroji.
...
| Export | Druh | Signatura |
| --- | --- | --- |
| `ExportTarget` | interface | 3 členy |
...
<details>
<summary><code>ExportTarget</code> — 3 členy</summary>
