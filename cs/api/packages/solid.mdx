...
description: "Veřejné API balíčku @i18n-micro/solid: SolidJS integrace pro překlady, přepínání locale a routování, generováno ze zdroje."
---

# `@i18n-micro/solid`

33 exportů v 1 vstupním bodě.
...
| `SolidI18n` | class | 53 členů |
| `SolidI18nOptions` | interface | 6 členů |
...
<details>
<summary><code>I18nProviderProps</code> — 4 členů</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 členů</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 členů</summary>
...
<code>SolidI18nOptions</code> — 6 členů, identical to [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 členů, identical to [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 členů, identical to [`UseI18nOptions`](/api/packages/preact).
