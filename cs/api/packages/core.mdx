...
description: "Veřejné API balíčku @i18n-micro/core: sdílené runtime primitivy a typy pohánějící všechny frameworkové integrace, generováno ze zdroje."
---

# `@i18n-micro/core`

50 exportů napříč 3 vstupními body.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 členů |
| `BaseI18nOptions` | interface | 7 členů |
...
| `FormatServiceOptions` | interface | 2 členů |
...
| `MergeTranslationChunkOptions` | interface | 1 členů |
...
| `ReactiveI18nStore` | interface | 9 členů |
...
| `TranslationStorage` | interface | 1 členů |
...
<details>
<summary><code>BaseI18n</code> — 34 členů</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 členů</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 členů</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 členů</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 členů</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 členů</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 členů |
...
| `I18nDevtoolsInspectorNode` | interface | 4 členů |
| `I18nDevtoolsStateSnapshot` | interface | 7 členů |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 členů</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 členů</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 členů</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 členů, identical to `MergeTranslationChunkOptions` above.
