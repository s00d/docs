...
description: "Veřejné API balíčku @i18n-micro/vue: Vue 3 composables, komponenty a plugin pro překlady a locale routování, ze zdroje."
---

# `@i18n-micro/vue`

27 exportů v 1 vstupním bodě.
...
| `UseLocaleHeadOptions` | interface | 5 členů |
| `VueI18n` | class | 51 členů |
| `VueI18nOptions` | interface | 6 členů |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 členů</summary>
...
<details>
<summary><code>VueI18n</code> — 51 členů</summary>
...
<code>VueI18nOptions</code> — 6 členů, identical to [`PreactI18nOptions`](/api/packages/preact).
