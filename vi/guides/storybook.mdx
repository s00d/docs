...
description: "Tích hợp Nuxt I18n Micro với Storybook: cấu hình @nuxtjs/storybook, thêm điều khiển ngôn ngữ và xem trước thành phần trên nhiều ngôn ngữ."
---
...
Tích hợp **Nuxt**, **Storybook**, và **nuxt-i18n-micro** vào dự án cho phép bạn xây dựng một ứng dụng có bản địa hóa mạnh mẽ với cách tiếp cận phát triển hướng thành phần. Hướng dẫn này cung cấp các bước để thiết lập các công cụ này cùng nhau, bao gồm cấu hình, bản địa hóa và tích hợp Storybook.
...
Để có các ví dụ hoàn chỉnh, hãy xem các dự án này:

1. **[Ví dụ Nuxt + Storybook + i18n trên GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Repo này minh họa cách tích hợp Nuxt, Storybook và nuxt-i18n-micro. Nó bao gồm hướng dẫn thiết lập và chi tiết cấu hình.

2. **[Tài liệu Storybook cho Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   Tài liệu chính thức để thiết lập Storybook với Nuxt. Nó cung cấp các bước chi tiết và thực hành tốt nhất.

3. **[Ví dụ tương tác trên StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Khám phá ví dụ trực tiếp về tích hợp Nuxt, Storybook và nuxt-i18n-micro ngay trong trình duyệt của bạn.
