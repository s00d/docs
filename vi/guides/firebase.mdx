...
description: "Triển khai Nuxt I18n Micro lên Firebase AppHosting: sửa các loại MIME JSON, cấu hình quy tắc route và giữ cho bản dịch hoạt động trong production."
---
