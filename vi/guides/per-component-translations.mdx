---
title: "Bản dịch theo từng thành phần"
description: "Đính kèm các bản dịch vào một thành phần hoặc trang cụ thể với $defineI18nRoute, giữ các khóa cục bộ thay vì chia sẻ các tệp ngôn ngữ toàn cục."
---
