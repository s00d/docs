...
description: "Tạo các kiểu TypeScript từ JSON locale."
---

# 🔧 Types Generator (`@i18n-micro/types-generator`)

Gói `@i18n-micro/types-generator` cung cấp tự động tạo kiểu TypeScript cho các khóa bản dịch. Nó phân tích các tệp JSON bản dịch của bạn và tạo các kiểu chặt chẽ, cho phép an toàn kiểu đầy đủ và hỗ trợ autocomplete cho các khóa bản dịch.

## 📖 Tổng quan

`@i18n-micro/types-generator` là một phụ thuộc dev tùy chọn nâng cao trải nghiệm phát triển của bạn bằng cách:
