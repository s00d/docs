---
title: "Trình sinh kiểu cho JSON ngôn ngữ"
description: "Sử dụng @i18n-micro/types-generator để phát ra các kiểu TypeScript từ JSON ngôn ngữ của bạn, mang lại tự động hoàn thành và an toàn đầy đủ cho $t và các trợ giúp."
---
