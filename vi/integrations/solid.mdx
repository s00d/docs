---
title: "Gói Solid (`@i18n-micro/solid`)"
description: "i18n cho SolidJS với @i18n-micro/solid."
---

# Gói Solid (`@i18n-micro/solid`)

Gói `@i18n-micro/solid` cung cấp giải pháp quốc tế hóa nhẹ, hiệu năng cao cho các ứng dụng SolidJS. Nó chia sẻ cùng logic cốt lõi với Nuxt I18n Micro, cung cấp các bản dịch reactive, hỗ trợ theo route và hỗ trợ TypeScript đầy đủ.

## Tổng quan

`@i18n-micro/solid` được thiết kế cho các ứng dụng SolidJS cần quốc tế hóa mà không có framework Nuxt. Nó cung cấp:
