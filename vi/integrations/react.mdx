---
title: "Gói React (`@i18n-micro/react`)"
description: "i18n cho React với @i18n-micro/react."
---

# Gói React (`@i18n-micro/react`)

Gói `@i18n-micro/react` cung cấp giải pháp quốc tế hóa nhẹ, hiệu năng cao cho các ứng dụng React. Nó chia sẻ cùng logic cốt lõi với Nuxt I18n Micro, cung cấp các bản dịch reactive, hỗ trợ theo route và hỗ trợ TypeScript đầy đủ.

## Tổng quan

`@i18n-micro/react` được thiết kế cho các ứng dụng React cần quốc tế hóa mà không có framework Nuxt. Nó cung cấp:
