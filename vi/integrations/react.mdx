...
description: "Sử dụng @i18n-micro/react để thêm các hook, thành phần và provider cho bản dịch và định tuyến nhận biết ngôn ngữ trong các ứng dụng và framework React."
---
