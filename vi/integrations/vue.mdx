...
description: "Sử dụng @i18n-micro/vue để thêm các composable, thành phần và plugin cho bản dịch và định tuyến nhận biết ngôn ngữ trong các ứng dụng Vue 3 độc lập."
---
