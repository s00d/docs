---
title: "Gói Vue (`@i18n-micro/vue`)"
description: "i18n cho Vue 3 với @i18n-micro/vue."
---

# Gói Vue (`@i18n-micro/vue`)

Gói `@i18n-micro/vue` cung cấp giải pháp quốc tế hóa nhẹ, hiệu năng cao cho các ứng dụng Vue 3. Nó chia sẻ cùng logic cốt lõi với Nuxt I18n Micro, cung cấp các bản dịch reactive, hỗ trợ theo route và hỗ trợ TypeScript đầy đủ.

## Tổng quan

`@i18n-micro/vue` được thiết kế cho các ứng dụng Vue 3 cần quốc tế hóa mà không có framework Nuxt. Nó cung cấp:
