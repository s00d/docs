---
title: "Gói DevTools UI (`@i18n-micro/devtools-ui`)"
description: "DevTools UI độc lập và plugin Vite."
---

# Gói DevTools UI (`@i18n-micro/devtools-ui`)

Gói `@i18n-micro/devtools-ui` cung cấp giao diện công cụ phát triển độc lập để quản lý các bản dịch. Nó bao gồm một plugin Vite để tích hợp tự động và một hệ thống bridge chung cho hỗ trợ i18n không phụ thuộc framework.

## Tổng quan

`@i18n-micro/devtools-ui` là một gói độc lập cung cấp:
