...
description: "Sử dụng @i18n-micro/devtools-ui làm giao diện DevTools độc lập và plugin Vite để duyệt các bản dịch và chỉnh sửa các ngôn ngữ trong bất kỳ dự án @i18n-micro nào."
---
