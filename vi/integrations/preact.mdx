---
title: "Gói Preact (`@i18n-micro/preact`)"
description: "i18n cho Preact với @i18n-micro/preact."
---

# Gói Preact (`@i18n-micro/preact`)

Gói `@i18n-micro/preact` cung cấp giải pháp quốc tế hóa nhẹ, hiệu năng cao cho các ứng dụng **Pure Preact**. Nó chia sẻ cùng logic cốt lõi với Nuxt I18n Micro, cung cấp các bản dịch reactive, hỗ trợ theo route và hỗ trợ TypeScript đầy đủ.

## Tổng quan

`@i18n-micro/preact` được thiết kế cho các ứng dụng Pure Preact (không có lớp tương thích React) cần quốc tế hóa. Nó cung cấp:
