---
title: "Runtime Node.js với @i18n-micro/node"
description: "Sử dụng @i18n-micro/node để tải bản dịch và phát hiện ngôn ngữ trong các máy chủ Node.js thuần, worker và CLI mà không cần bất kỳ framework UI nào được đính kèm."
---
