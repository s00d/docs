...
description: "i18n cho Node.js với @i18n-micro/node."
---

# 🌐 Node.js Runtime

Dùng `@i18n-micro/node` để thêm các bản dịch i18n vào bất kỳ ứng dụng Node.js, công cụ CLI hoặc dịch vụ backend nào. Gói này cung cấp cùng logic dịch như module Nuxt, nhưng cho các môi trường Node.js thuần túy.
