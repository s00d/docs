...
description: "Sử dụng @i18n-micro/astro để thêm định tuyến ngôn ngữ, bản dịch và các trợ giúp SEO vào các dự án Astro với runtime @i18n-micro/core dùng chung."
---
