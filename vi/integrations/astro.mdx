---
title: "Gói Astro (`@i18n-micro/astro`)"
description: "i18n cho Astro với @i18n-micro/astro."
---

# Gói Astro (`@i18n-micro/astro`)

Gói `@i18n-micro/astro` cung cấp giải pháp quốc tế hóa nhẹ, hiệu năng cao cho các ứng dụng Astro. Nó chia sẻ cùng logic cốt lõi với Nuxt I18n Micro, cung cấp hỗ trợ SSR, tự động phát hiện locale, các component Astro và hỗ trợ TypeScript đầy đủ.

## Tổng quan

`@i18n-micro/astro` được thiết kế cho các ứng dụng Astro cần quốc tế hóa với hỗ trợ render phía server. Nó cung cấp:
