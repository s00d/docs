---
title: "Tổng quan tích hợp framework"
description: "Tổng quan về các tích hợp framework @i18n-micro cho Vue, React, Preact, SolidJS, Astro và Node.js chia sẻ một runtime bản dịch duy nhất."
---
