---
title: "Phương thức"
description: "Tất cả các phương thức runtime của nuxt-i18n-micro."
---

# 🛠️ Phương thức

Trang này ghi tài liệu tất cả các phương thức khả dụng được cung cấp bởi nuxt-i18n-micro. Các phương thức được tổ chức theo chức năng để dễ điều hướng.

## 📊 Tổng quan API

Mọi trình trợ giúp mà plugin tiêm vào, được đọc từ interface `PluginsInjections` — nên
danh sách này không thể trôi khỏi những gì thực sự khả dụng.
