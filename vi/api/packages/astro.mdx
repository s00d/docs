...
description: "API công khai của gói @i18n-micro/astro: điểm vào tích hợp, các kiểu đã xuất và các trợ giúp, được sinh từ mã nguồn tại thời điểm build."
---

# `@i18n-micro/astro`

56 xuất trên 6 điểm vào.
...
| Xuất | Loại | Chữ ký |
| --- | --- | --- |
| `AstroI18n` | class | 48 thành viên |
| `AstroI18nOptions` | interface | 9 thành viên |
...
| `FormatService` | class | 19 thành viên |
...
| `I18nClientProps` | interface | 4 thành viên |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 thành viên |
| `I18nMiddlewareOptions` | interface | 7 thành viên |
| `I18nRoutingStrategy` | interface | 10 thành viên |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 thành viên |
...
| `LoadTranslationsOptions` | interface | 3 thành viên |
| `Locale` | interface | 11 thành viên |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 thành viên |
| `LocaleHeadResult` | interface | 3 thành viên |
...
<details>
<summary><code>AstroI18n</code> — 48 thành viên</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 thành viên</summary>
...
<details>
<summary><code>FormatService</code> — 19 thành viên</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 thành viên</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 thành viên</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 thành viên</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 thành viên</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 thành viên</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 thành viên</summary>
...
<code>Locale</code> — 11 thành viên, giống hệt [`Locale`](/api/packages/types).
<details>
<summary><code>LocaleHeadOptions</code> — 4 thành viên</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 thành viên</summary>
...
<code>Translations</code> — 1 thành viên, giống hệt [`Translations`](/api/packages/types).
...
| `I18nState` | interface | 4 thành viên |
...
<code>I18nState</code> — 4 thành viên, giống hệt `I18nClientProps` above.
