...
description: "API công khai của gói @i18n-micro/route-strategy: tạo route đã bản địa hóa tại thời điểm build cho các trang Nuxt, được sinh từ mã nguồn."
---

# `@i18n-micro/route-strategy`

18 xuất trên 1 điểm vào.
...
| `RouteGenerator` | class | 23 thành viên |
| `RouteGeneratorOptions` | interface | 11 thành viên |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 thành viên</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 thành viên</summary>
