...
description: "API công khai của gói @i18n-micro/core: các nguyên hàm runtime và kiểu dùng chung làm nền tảng cho mọi tích hợp framework, được sinh từ mã nguồn."
---

# `@i18n-micro/core`

50 xuất trên 3 điểm vào.
...
| Xuất | Loại | Chữ ký |
| --- | --- | --- |
| `BaseI18n` | class | 34 thành viên |
| `BaseI18nOptions` | interface | 7 thành viên |
...
| `FormatServiceOptions` | interface | 2 thành viên |
...
| `MergeTranslationChunkOptions` | interface | 1 thành viên |
...
| `ReactiveI18nStore` | interface | 9 thành viên |
...
| `TranslationStorage` | interface | 1 thành viên |
...
<details>
<summary><code>BaseI18n</code> — 34 thành viên</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 thành viên</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 thành viên</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 thành viên</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 thành viên</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 thành viên</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 thành viên |
...
| `I18nDevtoolsInspectorNode` | interface | 4 thành viên |
| `I18nDevtoolsStateSnapshot` | interface | 7 thành viên |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 thành viên</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 thành viên</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 thành viên</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 thành viên, giống hệt `MergeTranslationChunkOptions` above.
