...
description: "API công khai của gói @i18n-micro/solid: các signal SolidJS, thành phần, và provider cho bản dịch và định tuyến ngôn ngữ, được sinh từ mã nguồn."
---

# `@i18n-micro/solid`

33 xuất trên 1 điểm vào.
...
| `SolidI18n` | class | 53 thành viên |
| `SolidI18nOptions` | interface | 6 thành viên |
...
<details>
<summary><code>I18nProviderProps</code> — 4 thành viên</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 thành viên</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 thành viên</summary>
...
<code>SolidI18nOptions</code> — 6 thành viên, giống hệt [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 thành viên, giống hệt [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 thành viên, giống hệt [`UseI18nOptions`](/api/packages/preact).
