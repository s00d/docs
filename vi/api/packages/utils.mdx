...
description: "API công khai của gói @i18n-micro/utils: các trợ giúp build, source loader, bộ hợp nhất, và các tiện ích premerge, được sinh từ mã nguồn tại thời điểm build."
---

# `@i18n-micro/utils`

102 xuất trên 24 điểm vào.
...
| `PreMergeLocaleInfo` | interface | 2 thành viên |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 thành viên</summary>
...
| `CacheControlOptions` | interface | 2 thành viên |

<details>
<summary><code>CacheControl</code> — 13 thành viên</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 thành viên</summary>
...
| Xuất | Loại | Chữ ký |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 thành viên |
...
| `MergeI18nHeadOptions` | interface | 3 thành viên |

<details>
<summary><code>I18nHeadObject</code> — 3 thành viên</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 thành viên</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 thành viên |
...
| `SourceLocaleInfo` | interface | 2 thành viên |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 thành viên</summary>
...
<code>SourceLocaleInfo</code> — 2 thành viên, giống hệt `PreMergeLocaleInfo` above.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 thành viên</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 thành viên |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 thành viên |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 thành viên |
| `TranslationPayloadStats` | interface | 2 thành viên |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 thành viên</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 thành viên</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 thành viên</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 thành viên</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 thành viên |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 thành viên</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 thành viên |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 thành viên</summary>
...
| Xuất | Loại | Chữ ký |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 thành viên |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 thành viên |

<details>
<summary><code>HreflangAlternate</code> — 2 thành viên</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 thành viên</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 thành viên |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 thành viên |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 thành viên</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 thành viên</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 thành viên |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 thành viên</summary>
...
| `I18nRouteContext` | interface | 3 thành viên |
...
<details>
<summary><code>I18nRouteContext</code> — 3 thành viên</summary>
...
| `RuntimeI18nOverrides` | interface | 4 thành viên |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 thành viên</summary>
...
| `TranslationStorageReader` | interface | 1 thành viên |

<details>
<summary><code>TranslationStorageReader</code> — 1 thành viên</summary>
...
| Xuất | Loại | Chữ ký |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 thành viên |
| `SplitLocaleRoutePage` | interface | 3 thành viên |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 thành viên |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 thành viên</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 thành viên</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 thành viên</summary>
