...
description: "API công khai của gói @i18n-micro/vue: các composable Vue 3, thành phần, và plugin cho bản dịch và định tuyến ngôn ngữ, được sinh từ mã nguồn."
---

# `@i18n-micro/vue`

27 xuất trên 1 điểm vào.
...
| `UseLocaleHeadOptions` | interface | 5 thành viên |
| `VueI18n` | class | 51 thành viên |
| `VueI18nOptions` | interface | 6 thành viên |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 thành viên</summary>
...
<details>
<summary><code>VueI18n</code> — 51 thành viên</summary>
...
<code>VueI18nOptions</code> — 6 thành viên, giống hệt [`PreactI18nOptions`](/api/packages/preact).
