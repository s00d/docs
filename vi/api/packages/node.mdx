...
description: "API công khai của gói @i18n-micro/node: bộ điều hợp runtime cho Node.js, các loader bản dịch và các kiểu đã xuất, được sinh từ mã nguồn."
---

# `@i18n-micro/node`

15 xuất trên 1 điểm vào.
...
| `I18n` | class | 46 thành viên |
| `I18nOptions` | interface | 7 thành viên |
...
<details>
<summary><code>I18n</code> — 46 thành viên</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 thành viên</summary>
...
<code>LoadedTranslations</code> — 2 thành viên, giống hệt [`LoadedTranslations`](/api/packages/astro).
