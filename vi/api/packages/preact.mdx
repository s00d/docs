...
description: "API công khai của gói @i18n-micro/preact: các hook Preact, thành phần, và provider cho bản dịch và định tuyến, được sinh từ mã nguồn."
---

# `@i18n-micro/preact`

39 xuất trên 1 điểm vào.
...
| `I18nGroupProps` | interface | 301 thành viên |
| `I18nLink` | const | `(props: I18nLinkProps) => JSX.Element` |
| `I18nLinkProps` | interface | 314 thành viên |
...
| `PreactI18n` | class | 44 thành viên |
| `PreactI18nOptions` | interface | 6 thành viên |
...
| `UseI18nOptions` | interface | 2 thành viên |
| `UseI18nReturn` | interface | 22 thành viên |
| `useI18nRouter` | const | `() => I18nRoutingStrategy \| null` |

<code>FormatService</code> — 19 thành viên, giống hệt [`FormatService`](/api/packages/astro).
<details>
<summary><code>I18nGroupProps</code> — 301 thành viên</summary>
...
<details>
<summary><code>I18nLinkProps</code> — 314 thành viên</summary>
...
<details>
<summary><code>I18nProviderProps</code> — 5 thành viên</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 6 thành viên</summary>
...
<details>
<summary><code>I18nSwitcherProps</code> — 314 thành viên</summary>
...
<details>
<summary><code>I18nTProps</code> — 311 thành viên</summary>
...
<code>ModuleOptions</code> — 47 thành viên, giống hệt [`ModuleOptions`](/api/packages/types).
<details>
<summary><code>PreactI18n</code> — 44 thành viên</summary>
...
<details>
<summary><code>PreactI18nOptions</code> — 6 thành viên</summary>
...
<details>
<summary><code>UseI18nOptions</code> — 2 thành viên</summary>
...
<details>
<summary><code>UseI18nReturn</code> — 22 thành viên</summary>
