...
description: "API công khai của gói @i18n-micro/test-utils: các trợ giúp Vitest, mock, và fixture để kiểm thử hành vi i18n, được sinh từ mã nguồn."
---

# `@i18n-micro/test-utils`

36 xuất trên 2 điểm vào.
...
| Xuất | Loại | Chữ ký |
| --- | --- | --- |
| `ExportTarget` | interface | 3 thành viên |
...
<details>
<summary><code>ExportTarget</code> — 3 thành viên</summary>
