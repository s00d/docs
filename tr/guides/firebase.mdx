...
description: "Nuxt I18n Micro'yu Firebase AppHosting'e dağıt: JSON MIME türlerini düzelt, rota kurallarını yapılandır, çevirilerin üretimde çalışmasını sağla."
---
