---
title: "nuxt-i18n-micro-cli komutları"
description: "nuxt-i18n-micro-cli ile şablonlardan anahtarları çıkar, sabit kodlanmış metni $t çağrılarına dönüştür, çeviri ve senkronizasyon iş akışlarını çalıştır."
---
