---
title: "React paketi (`@i18n-micro/react`)"
description: "React uygulamalarına ve çerçevelerine çeviriler ile yerel ayar farkında yönlendirme için hook'lar, bileşenler ve bir sağlayıcı eklemek için @i18n-micro/react'i kullan."
---
