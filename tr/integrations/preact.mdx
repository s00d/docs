---
title: "Preact paketi (`@i18n-micro/preact`)"
description: "Preact uygulamalarına Nuxt benzeri bir geliştirici deneyimiyle çeviriler, yerel ayar değiştirme ve yerel ayar farkında yönlendirme eklemek için @i18n-micro/preact'i kullan."
---
