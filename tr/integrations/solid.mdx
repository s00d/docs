---
title: "Solid paketi (`@i18n-micro/solid`)"
description: "SolidJS uygulamalarına çeviriler ile yerel ayar farkında yönlendirme için sinyaller, bileşenler ve bir sağlayıcı eklemek için @i18n-micro/solid'i kullan."
---
