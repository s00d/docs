---
title: "@i18n-micro/node ile Node.js çalışma zamanı"
description: "Herhangi bir UI çerçevesi eklenmeden düz Node.js sunucularında, çalışanlarda ve CLI'larda çevirileri yüklemek ve yerel ayarları algılamak için @i18n-micro/node'u kullan."
---
