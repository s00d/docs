---
title: "Vue paketi (`@i18n-micro/vue`)"
description: "Bağımsız Vue 3 uygulamalarına çeviriler ile yerel ayar farkında yönlendirme için composable'lar, bileşenler ve bir eklenti eklemek için @i18n-micro/vue'yu kullan."
---
