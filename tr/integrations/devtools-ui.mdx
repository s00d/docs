---
title: "DevTools UI paketi (`@i18n-micro/devtools-ui`)"
description: "Herhangi bir @i18n-micro projesinde çevirilere göz atıp yerel ayarları düzenlemek için bağımsız bir DevTools UI ve Vite eklentisi olarak @i18n-micro/devtools-ui'yi kullan."
---
