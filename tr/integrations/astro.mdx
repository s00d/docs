---
title: "Astro paketi (`@i18n-micro/astro`)"
description: "Astro projelerine yerel ayar yönlendirmesi, çeviriler ve SEO yardımcıları eklemek için paylaşılan @i18n-micro/core çalışma zamanı ile @i18n-micro/astro'yu kullan."
---
