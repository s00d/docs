---
title: "Çerçeve entegrasyonlarına genel bakış"
description: "Vue, React, Preact, SolidJS, Astro ve Node.js için tek bir çeviri çalışma zamanını paylaşan @i18n-micro çerçeve entegrasyonlarına genel bakış."
---
