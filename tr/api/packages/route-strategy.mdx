...
description: "@i18n-micro/route-strategy paketinin herkese açık API'si: Nuxt sayfaları için derleme zamanı yerelleştirilmiş rota üretimi. Kaynaktan üretilmiştir."
---

# `@i18n-micro/route-strategy`

1 giriş noktası üzerinden 18 dışa aktarım.
...
| `RouteGenerator` | class | 23 üye |
| `RouteGeneratorOptions` | interface | 11 üye |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code>: 23 üye</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code>: 11 üye</summary>
