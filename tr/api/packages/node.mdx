...
description: "@i18n-micro/node paketinin herkese açık API'si: Node.js çalışma zamanı adaptörü, çeviri yükleyicileri ve dışa aktarılan türler. Kaynaktan üretilmiştir."
---

# `@i18n-micro/node`

1 giriş noktası üzerinden 15 dışa aktarım.
...
<details>
<summary><code>I18n</code>: 46 üye</summary>
...
<details>
<summary><code>I18nOptions</code>: 7 üye</summary>
