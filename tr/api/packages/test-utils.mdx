...
description: "@i18n-micro/test-utils paketinin herkese açık API'si: i18n davranışını test etmek için Vitest yardımcıları, mock'lar ve fikstürler. Kaynaktan üretilmiştir."
---

# `@i18n-micro/test-utils`

2 giriş noktası üzerinden 36 dışa aktarım.
...
<details>
<summary><code>ExportTarget</code>: 3 üye</summary>
