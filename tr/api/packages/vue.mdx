...
description: "@i18n-micro/vue paketinin herkese açık API'si: Vue 3 için eklenti, composable'lar ve bileşenler. Kaynaktan üretilmiştir."
---

# `@i18n-micro/vue`

1 giriş noktası üzerinden 27 dışa aktarım.
...
<details>
<summary><code>UseLocaleHeadOptions</code>: 5 üye</summary>
...
<details>
<summary><code>VueI18n</code>: 51 üye</summary>
