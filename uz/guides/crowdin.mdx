---
title: "Crowdin bilan ishlash"
description: "Nuxt I18n Micro tarjima fayllarini Crowdin bilan sinxronlashtirish: yuklash, yuklab olish va CI/CD ish jarayoni."
---
...
Integrating Crowdin into your project streamlines the localization and translation process, making it easier to manage translations across multiple languages and platforms. This guide taqdim etadi bosqichma-bosqich walkthrough on setting up Crowdin with your project, including configuration, uploading sources, and downloading translations.

## 🔧 Installation and Setup

Ishga kirishish uchun with Crowdin, you'll need to install the Crowdin CLI globally on your machine and initialize it within your project directory.

### 📦 Installing Crowdin CLI

Birinchidan, install the Crowdin CLI globally using npm:
...
The Crowdin configuration file (`crowdin.yml`) defines how your source files are mapped and where translations should be placed. Below bun example configuration:
...
- **`base_path`**: Specifies the base directory for source files. Ushbu misolda, translations are stored in the `./locales` directory.
...
The `files` section maps your source files to the paths where translations will be stored. Masalan:
