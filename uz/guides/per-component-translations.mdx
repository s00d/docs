---
title: "Komponent boʻyicha tarjimalar"
description: " yordamida sahifa yoki komponent boʻyicha tarjimalarni belgilang: inline JSON, locale marshrutlari va meta bekor qilishlari."
---

# 📖 Komponent boʻyicha tarjimalar

Qanday qilishni oʻrganing: define translations directly within Vue components using `$defineI18nRoute` for modular and maintainable localization.

## 📖 Umumiy sharh

Per-Component Translations in `Nuxt I18n Micro` sizga imkon beradi define translations directly within specific components or pages using the `$defineI18nRoute` function. Thbupproach is ideal for managing localized content that is unique to individual components, providing a more modular and maintainable method for handling translations.
...
`$defineI18nRoute` bu Nuxt app injection, not a global macro.  
...
- **[Getting Started](/quickstart)** - Basic setup and configuration
