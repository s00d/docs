---
title: "Storybook bilan integratsiya"
description: "Nuxt I18n Micro’ni Storybook bilan ishlatish: mock i18n konteksti, locale almashtirish decorator’lari va misollar."
---
...
Integrating **Nuxt**, **Storybook**, and **nuxt-i18n-micro** into your project sizga imkon beradi build a robust, localized application with a component-driven development approach. This guide taqdim etadi bosqichma-bosqich walkthrough on setting up these tools together, including configuration, localization, and Storybook integration.

## 🛠 Nuxt Configuration

Yoqish uchun localization and Storybook in your Nuxt project, configure your `nuxt.config.ts` file quyidagi tarzda:
...
Integratsiya qilish uchun Storybook with Nuxt and nuxt-i18n-micro, configure the `.storybook/main.ts` file, add `mergeTranslations` and `staticDirs`.
