---
title: "Firebase’da deploy qilish"
description: "Nuxt I18n Micro’ni Firebase Hosting va Cloud Functions’ga deploy qilish, jumladan static va SSR sozlashlari, cache va CDN masalalari."
---
...
**Yechim:** Ensure translation files are being copied to the output directory:
...
**Yechim:** Check if page-specific translations are being generated:
...
**Yechim:** Optimize caching and preloading:
