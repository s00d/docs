---
title: "Ekotizim paketlari sharhi"
description: "@i18n-micro ekotizim paketlari: har bir framework va runtime uchun mustaqil integratsiyalar roʻyxati."
---
...
A language switcher component that taqdim etadi dropdown or list interface for changing locales. Features:
...
the framework (`ReactI18nOptions`, `SolidI18nOptions`, va boshqalar). The options themselves
are identical:

| Property         | Type                                                       | Required | Default          | Description                                    |
| ---------------- | ---------------------------------------------------------- | -------- | ---------------- | ---------------------------------------------- |
| `locale`         | `string`                                                   | ✅       | -                | Current locale code (masalan, `'en'`)             |
...
Foydalanish uchun routing features, you need to implement the `I18nRoutingStrategy` interface:
