---
title: "Paket API’lari"
description: "Har bir @i18n-micro workspace paketining havola indeksi. Eksport qilingan API’lar va CI tekshiradigan manba snapshotlaridan yaratilgan turlar roʻyxati."
---

# Paket API’lari

`nuxt-i18n-micro` kichik paketlar toʻplamidan tuzilgan boʻlib, ularning aksariyati mustaqil ravishda ishlatilishi mumkin. Masalan, `@i18n-micro/vue` oddiy Vue ilovada, `@i18n-micro/core` esa istalgan joyda.

Quyidagi har bir sahifa
[`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) TypeScript manbalariga qarshi tekshiradigan API snapshotidan yaratiladi. Shu sababli, ushbu havola oʻzgarmasdan yoki CI muvaffaqiyatsiz boʻlmasdan eksport yoʻqolib qololmaydi.

{/* generated:packages-index — do not edit; run `pnpm run docs:generate` */}

| Paket | Kirish nuqtalari | Eksportlar |
| --- | --- | --- |
...
- [Integratsiyalar](/integrations/overview) — bu paketlarni har bir frameworkda ishlatish qoʻllanmalari
- [Modul parametrlari](/api/module-options) — Nuxt moduli qabul qiladigan parametrlar
- [Metodlar](/api/methods) — komponentlar ichida mavjud runtime yordamchilari
