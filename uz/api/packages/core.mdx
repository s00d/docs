...
description: "@i18n-micro/core paketining ochiq API’si: har bir framework integratsiyasini quvvatlantiradigan umumiy runtime primitivlari va turlar. Manbadan yaratiladi."
---

# `@i18n-micro/core`

3 ta kirish nuqtasi boʻyicha 50 ta eksport.
...
| Eksport | Turi | Imzo |
| --- | --- | --- |
| `BaseI18n` | class | 34 aʼzo |
| `BaseI18nOptions` | interface | 7 aʼzo |
...
| `FormatServiceOptions` | interface | 2 aʼzo |
...
| `MergeTranslationChunkOptions` | interface | 1 aʼzo |
...
| `ReactiveI18nStore` | interface | 9 aʼzo |
...
| `TranslationStorage` | interface | 1 aʼzo |
...
<details>
<summary><code>BaseI18n</code> — 34 aʼzo</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 aʼzo</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 aʼzo</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 aʼzo</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 aʼzo</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 aʼzo</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 aʼzo |
...
| `I18nDevtoolsInspectorNode` | interface | 4 aʼzo |
| `I18nDevtoolsStateSnapshot` | interface | 7 aʼzo |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 aʼzo</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 aʼzo</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 aʼzo</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 aʼzo, yuqoridagi `MergeTranslationChunkOptions` bilan bir xil.
