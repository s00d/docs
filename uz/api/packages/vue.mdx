...
description: "Public API of the @i18n-micro/vue package: Vue 3 composables, components, and plugin for translations and locale routing, from source."
---

# `@i18n-micro/vue`

1 ta kirish nuqtasi boʻyicha 27 ta eksport.
...
| `UseLocaleHeadOptions` | interface | 5 aʼzo |
| `VueI18n` | class | 51 aʼzo |
| `VueI18nOptions` | interface | 6 aʼzo |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 aʼzo</summary>
...
<details>
<summary><code>VueI18n</code> — 51 aʼzo</summary>
...
<code>VueI18nOptions</code> — 6 aʼzo, quyidagi bilan bir xil: [`PreactI18nOptions`](/api/packages/preact).
