...
description: "@i18n-micro/solid paketining ochiq API’si: tarjimalar va locale marshrutlash uchun SolidJS signallari, komponentlar va provayder. Manbadan olinadi."
---

# `@i18n-micro/solid`

1 ta kirish nuqtasi boʻyicha 33 ta eksport.
...
| `SolidI18n` | class | 53 aʼzo |
| `SolidI18nOptions` | interface | 6 aʼzo |
...
<details>
<summary><code>I18nProviderProps</code> — 4 aʼzo</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 aʼzo</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 aʼzo</summary>
...
<code>SolidI18nOptions</code> — 6 aʼzo, quyidagi bilan bir xil: [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 aʼzo, quyidagi bilan bir xil: [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 aʼzo, quyidagi bilan bir xil: [`UseI18nOptions`](/api/packages/preact).
