...
24 ta kirish nuqtasi boʻyicha 102 ta eksport.
...
| `PreMergeLocaleInfo` | interface | 2 aʼzo |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 aʼzo</summary>
...
| `CacheControlOptions` | interface | 2 aʼzo |

<details>
<summary><code>CacheControl</code> — 13 aʼzo</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 aʼzo</summary>
...
| Eksport | Turi | Imzo |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 aʼzo |
...
| `MergeI18nHeadOptions` | interface | 3 aʼzo |

<details>
<summary><code>I18nHeadObject</code> — 3 aʼzo</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 aʼzo</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 aʼzo |
...
| `SourceLocaleInfo` | interface | 2 aʼzo |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 aʼzo</summary>
...
<code>SourceLocaleInfo</code> — 2 aʼzo, quyidagi bilan bir xil: `PreMergeLocaleInfo` above.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 aʼzo</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 aʼzo |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 aʼzo |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 aʼzo |
| `TranslationPayloadStats` | interface | 2 aʼzo |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 aʼzo</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 aʼzo</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 aʼzo</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 aʼzo</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 aʼzo |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 aʼzo</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 aʼzo |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 aʼzo</summary>
...
| Eksport | Turi | Imzo |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 aʼzo |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 aʼzo |

<details>
<summary><code>HreflangAlternate</code> — 2 aʼzo</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 aʼzo</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 aʼzo |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 aʼzo |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 aʼzo</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 aʼzo</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 aʼzo |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 aʼzo</summary>
...
| `I18nRouteContext` | interface | 3 aʼzo |
...
<details>
<summary><code>I18nRouteContext</code> — 3 aʼzo</summary>
...
| `RuntimeI18nOverrides` | interface | 4 aʼzo |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 aʼzo</summary>
...
| `TranslationStorageReader` | interface | 1 aʼzo |

<details>
<summary><code>TranslationStorageReader</code> — 1 aʼzo</summary>
...
| Eksport | Turi | Imzo |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 aʼzo |
| `SplitLocaleRoutePage` | interface | 3 aʼzo |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 aʼzo |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 aʼzo</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 aʼzo</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 aʼzo</summary>
