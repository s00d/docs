...
description: "@i18n-micro/route-strategy paketining ochiq API’si: Nuxt sahifalari uchun build vaqtida mahalliylashtirilgan marshrut yaratish. Manbadan yaratiladi."
---

# `@i18n-micro/route-strategy`

1 ta kirish nuqtasi boʻyicha 18 ta eksport.
...
| `RouteGenerator` | class | 23 aʼzo |
| `RouteGeneratorOptions` | interface | 11 aʼzo |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 aʼzo</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 aʼzo</summary>
