...
description: "@i18n-micro/astro paketining ochiq API’si: integratsiya kirish nuqtasi, eksport qilingan turlar va yordamchilar. Build vaqtida manbadan yaratiladi."
---

# `@i18n-micro/astro`

6 ta kirish nuqtasi boʻyicha 56 ta eksport.
...
| Eksport | Turi | Imzo |
| --- | --- | --- |
| `AstroI18n` | class | 48 aʼzo |
| `AstroI18nOptions` | interface | 9 aʼzo |
...
| `I18nClientProps` | interface | 4 aʼzo |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 aʼzo |
| `I18nMiddlewareOptions` | interface | 7 aʼzo |
| `I18nRoutingStrategy` | interface | 10 aʼzo |
...
| `LoadTranslationsOptions` | interface | 3 aʼzo |
| `Locale` | interface | 11 aʼzo |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 aʼzo |
| `LocaleHeadResult` | interface | 3 aʼzo |
...
<details>
<summary><code>AstroI18n</code> — 48 aʼzo</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 aʼzo</summary>
...
<details>
<summary><code>FormatService</code> — 19 aʼzo</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 aʼzo</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 aʼzo</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 aʼzo</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 aʼzo</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 aʼzo</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 aʼzo</summary>
...
<details>
<summary><code>LocaleHeadOptions</code> — 4 aʼzo</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 aʼzo</summary>
...
<code>I18nState</code> — 4 aʼzo, quyidagi bilan bir xil: `I18nClientProps` above.
