...
description: "@i18n-micro/test-utils paketining ochiq API’si: i18n xatti-harakatini sinovdan oʻtkazish uchun Vitest yordamchilari, moklar va fixture’lar. Manbadan yaratiladi."
---

# `@i18n-micro/test-utils`

2 ta kirish nuqtasi boʻyicha 36 ta eksport.
...
<details>
<summary><code>ExportTarget</code> — 3 aʼzo</summary>
