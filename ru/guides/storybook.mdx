...
description: "Интегрируйте Nuxt I18n Micro со Storybook: настройте @nuxtjs/storybook, добавьте контролы локали и просматривайте компоненты на разных языках."
---
...
Интеграция **Nuxt**, **Storybook** и **nuxt-i18n-micro** в проект позволяет разрабатывать надёжное локализованное приложение в компонентно-ориентированном подходе. Это руководство показывает шаг за шагом, как подружить эти инструменты, включая настройку, локализацию и подключение Storybook.

## 🛠 Конфигурация Nuxt

Чтобы включить локализацию и Storybook в проекте Nuxt, настройте `nuxt.config.ts`:
...
Полные примеры смотрите в этих проектах:

1. **[Пример Nuxt + Storybook + i18n на GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Репозиторий показывает, как объединить Nuxt, Storybook и nuxt-i18n-micro. Включает инструкции по настройке и детали конфигурации.
...
3. **[Интерактивный пример на StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Изучите живой пример интеграции Nuxt, Storybook и nuxt-i18n-micro прямо в браузере.
