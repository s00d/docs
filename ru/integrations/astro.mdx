---
title: "Пакет Astro (`@i18n-micro/astro`)"
description: "Используйте @i18n-micro/astro с интеграцией, поддерживающей SSR, компоненты для клиентских фреймворков и SEO-хелперы для многоязычных Astro-сайтов."
---
...
### Basic Setup (Without Router-адаптер)
...
#### Option 1: Manual Конфигурация (Works Everywhere)
...
### Setting Router-адаптер in Middleware
...
### Creating a Custom Router-адаптер
...
### Пример 1: Subdomain-Based Locale Routing
...
### Пример 2: Query Parameter-Based Locale Routing
...
### Пример 3: Suffix-Based Locale Routing
...
### Пример 4: Integration with Third-Party Router
...
### `i18nIntegration(options: I18nIntegrationОпции)`
...
### `createI18nMiddleware(options: I18nMiddlewareОпции)`
...
#### `getI18nПропсы(astro: AstroGlobal, keys?: string[]): I18nClientProps`
...
### `useLocaleHead(astro: AstroGlobal, options?: LocaleHeadОпции)`
