...
description: "Используйте @i18n-micro/solid, чтобы получить сигналы, компоненты и провайдер для переводов и роутинга по локалям в SolidJS-приложениях."
---
...
### Providing Locales Конфигурация
...
### Пример 1: Custom Router with Signals
...
### `createI18n(options: SolidI18nОпции)`
