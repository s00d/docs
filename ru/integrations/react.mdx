...
description: "Используйте @i18n-micro/react, чтобы получить хуки, компоненты и провайдер для переводов и роутинга по локалям в React-приложениях."
---
...
### `createI18n(options: ReactI18nОпции)`
...
### Example 1: Next.js Router-адаптер
...
### Example 2: TanStack Router-адаптер
