...
description: "Используйте @i18n-micro/vue, чтобы добавить композаблы, компоненты и плагин для переводов и локале-специфичного роутинга в отдельных приложениях Vue 3."
---
...
### `createI18n(options: CreateI18nОпции)`
...
### `useLocaleHead(options?: UseLocaleHeadОпции)`
