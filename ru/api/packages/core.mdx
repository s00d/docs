...
description: "Публичный API пакета @i18n-micro/core: общие runtime-примитивы и типы, лежащие в основе каждой интеграции с фреймворком, сгенерировано из исходников."
---

# `@i18n-micro/core`

50 экспортов через 3 точки входа.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 членов |
| `BaseI18nOptions` | interface | 7 членов |
...
| `FormatServiceOptions` | interface | 2 членов |
...
| `MergeTranslationChunkOptions` | interface | 1 членов |
...
| `ReactiveI18nStore` | interface | 9 членов |
...
| `TranslationStorage` | interface | 1 членов |
...
| `BuildInspectorTreeOptions` | interface | 6 членов |
...
| `I18nDevtoolsInspectorNode` | interface | 4 членов |
| `I18nDevtoolsStateSnapshot` | interface | 7 членов |
