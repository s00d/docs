...
description: "Публичный API пакета @i18n-micro/utils: билд-хелперы, source-loader, merger и premerge-утилиты, сгенерировано из исходников на этапе сборки."
---

# `@i18n-micro/utils`

102 экспортов через 24 точек входа.
...
| `PreMergeLocaleInfo` | interface | 2 членов |
...
| `CacheControlOptions` | interface | 2 членов |
...
| Экспорт | Вид | Сигнатура |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 членов |
...
| `MergeI18nHeadOptions` | interface | 3 членов |
...
| `MergeSourceTranslationsInput` | interface | 6 членов |
...
| `SourceLocaleInfo` | interface | 2 членов |
...
| `ResolvedTranslationPayloadOptions` | interface | 8 членов |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 членов |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 членов |
| `TranslationPayloadStats` | interface | 2 членов |
...
| `TranslationPayloadHostConfig` | interface | 3 членов |
...
| `TranslationPayloadFetchRequestInput` | interface | 9 членов |
...
| Экспорт | Вид | Сигнатура |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 членов |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 членов |
...
| `ResolvePreferredLocaleInput` | interface | 7 членов |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 членов |
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 членов |
...
| `I18nRouteContext` | interface | 3 членов |
...
| `RuntimeI18nOverrides` | interface | 4 членов |
...
| `TranslationStorageReader` | interface | 1 членов |
...
| Экспорт | Вид | Сигнатура |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 членов |
| `SplitLocaleRoutePage` | interface | 3 членов |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 членов |
