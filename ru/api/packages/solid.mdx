...
description: "Публичный API пакета @i18n-micro/solid: сигналы, компоненты и провайдер SolidJS для переводов и роутинга по локалям, из исходников."
---

# `@i18n-micro/solid`

33 экспортов через 1 точку входа.
...
| `SolidI18n` | class | 53 членов |
| `SolidI18nOptions` | interface | 6 членов |
