...
description: "Публичный API пакета @i18n-micro/node: runtime-адаптер для Node.js, загрузчики переводов и экспортируемые типы, сгенерировано из исходников."
---

# `@i18n-micro/node`

15 экспортов через 1 точку входа.
...
| `I18n` | class | 46 членов |
| `I18nOptions` | interface | 7 членов |
