...
description: "Публичный API пакета @i18n-micro/preact: хуки, компоненты и провайдер Preact для переводов и роутинга, сгенерировано из исходников."
---

# `@i18n-micro/preact`

39 экспортов через 1 точку входа.
...
| `I18nGroupProps` | interface | 301 членов |
| `I18nLink` | const | `(props: I18nLinkProps) => JSX.Element` |
| `I18nLinkProps` | interface | 314 членов |
...
| `PreactI18n` | class | 44 членов |
| `PreactI18nOptions` | interface | 6 членов |
...
| `UseI18nOptions` | interface | 2 членов |
| `UseI18nReturn` | interface | 22 членов |
