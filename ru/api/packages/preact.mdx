...
description: "Экспортируемый API @i18n-micro/preact, сгенерированный из исходного кода."
---

# `@i18n-micro/preact`

39 экспортов в 1 точке входа.
...
| `createBrowserHistoryAdapter` | функция | `(locales: Locale[], defaultLocale: string) => I18nRoutingStrategy` |
| `createI18n` | функция | `(options: PreactI18nOptions) => PreactI18n` |
| `createPreactRouterAdapter` | константа | `(locales: Locale[], defaultLocale: string) => I18nRoutingStrategy` |
...
| `I18nContext` | константа | `import("preact/src/index").Context<PreactI18n \| null>` |
| `I18nDefaultLocaleContext` | константа | `import("preact/src/index").Context<string \| null>` |
| `I18nGroup` | константа | `(props: I18nGroupProps) => JSX.Element` |
| `I18nGroupProps` | интерфейс | 301 членов |
| `I18nLink` | константа | `(props: I18nLinkProps) => JSX.Element` |
| `I18nLinkProps` | интерфейс | 314 членов |
| `I18nLocalesContext` | константа | `import("preact/src/index").Context<Locale[] \| null>` |
| `I18nProvider` | функция | `(\{ i18n, locales, defaultLocale, routingStrategy, children \}: I18nProviderProps) => import("preact/src/index").VNode<import("preact/src/index").Attributes & \{ value: PreactI18n \| null; children?: ComponentChildren; \}>` |
| `I18nProviderProps` | интерфейс | 5 членов |
| `I18nRouterContext` | константа | `import("preact/src/index").Context<I18nRoutingStrategy \| null>` |
| `I18nRoutingStrategy` | интерфейс | 6 членов |
| `I18nSwitcher` | константа | `(props: I18nSwitcherProps) => JSX.Element` |
| `I18nSwitcherProps` | интерфейс | 314 членов |
| `I18nT` | константа | `(props: I18nTProps) => JSX.Element \| null` |
| `I18nTProps` | интерфейс | 311 членов |
...
| `PreactI18n` | класс | 44 членов |
| `PreactI18nOptions` | интерфейс | 6 членов |
...
| `useI18n` | константа | `(options?: UseI18nOptions) => UseI18nReturn` |
| `useI18nContext` | константа | `() => PreactI18n` |
| `useI18nDefaultLocale` | константа | `() => string \| null` |
| `useI18nLocales` | константа | `() => Locale[] \| null` |
| `UseI18nOptions` | интерфейс | 2 членов |
| `UseI18nReturn` | интерфейс | 22 членов |
| `useI18nRouter` | константа | `() => I18nRoutingStrategy \| null` |

<code>FormatService</code> — 19 members, identical to [`FormatService`](/api/packages/astro).
<details>
<summary><code>I18nGroupProps</code> — 301 членов</summary>
...
<details>
<summary><code>I18nLinkProps</code> — 314 членов</summary>
...
<details>
<summary><code>I18nProviderProps</code> — 5 членов</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 6 членов</summary>
...
<details>
<summary><code>I18nSwitcherProps</code> — 314 членов</summary>
...
<details>
<summary><code>I18nTProps</code> — 311 членов</summary>
...
<details>
<summary><code>PreactI18n</code> — 44 членов</summary>
...
<details>
<summary><code>PreactI18nOptions</code> — 6 членов</summary>
...
<details>
<summary><code>UseI18nOptions</code> — 2 членов</summary>
...
<details>
<summary><code>UseI18nReturn</code> — 22 членов</summary>
