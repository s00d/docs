...
description: "Публичный API пакета @i18n-micro/route-strategy: генерация локализованных маршрутов Nuxt на этапе сборки, сгенерировано из исходников."
---

# `@i18n-micro/route-strategy`

18 экспортов через 1 точку входа.
...
| `RouteGenerator` | class | 23 членов |
| `RouteGeneratorOptions` | interface | 11 членов |
