...
description: "Публичный API пакета @i18n-micro/astro: точка входа интеграции, экспортируемые типы и хелперы, сгенерировано из исходников на этапе сборки."
---

# `@i18n-micro/astro`

56 экспортов через 6 точек входа.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 членов |
| `AstroI18nOptions` | interface | 9 членов |
...
| `I18nClientProps` | interface | 4 членов |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 членов |
| `I18nMiddlewareOptions` | interface | 7 членов |
| `I18nRoutingStrategy` | interface | 10 членов |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 членов |
...
| `LoadTranslationsOptions` | interface | 3 членов |
| `Locale` | interface | 11 членов |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 членов |
| `LocaleHeadResult` | interface | 3 членов |
...
| `Translations` | interface | 1 членов |
