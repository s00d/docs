...
description: "Публичный API пакета @i18n-micro/path-strategy: рантайм-разрешение путей локалей, редиректы и SEO-хелперы, сгенерировано из исходников."
---

# `@i18n-micro/path-strategy`

38 экспортов через 6 точек входа.
...
| `BasePathStrategy` | class | 36 членов |
...
| `GetRouteBaseNameOptions` | interface | 2 членов |
...
| `IsIndexRouteNameOptions` | interface | 2 членов |
| `NoPrefixPathStrategy` | class | 36 членов |
...
| `PathStrategy` | interface | 22 членов |
| `PathStrategyContext` | interface | 15 членов |
| `PrefixAndDefaultPathStrategy` | class | 37 членов |
| `PrefixExceptDefaultPathStrategy` | class | 44 членов |
| `PrefixPathStrategy` | class | 36 членов |
| `ResolvedRouteLike` | interface | 6 членов |
| `resolvePathWithParams` | function | `(path: string, params?: Record<string, unknown>) => string` |
| `RouteAnalysis` | interface | 2 членов |
| `RouteLike` | interface | 6 членов |
| `RouterAdapter` | interface | 3 членов |
| `SwitchLocaleOptions` | interface | 1 членов |
