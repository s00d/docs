...
description: "Экспортируемый API @i18n-micro/vue, сгенерированный из исходного кода."
---

# `@i18n-micro/vue`

27 экспортов в 1 точке входа.
...
| `createI18n` | функция | `(options: CreateI18nOptions) => I18nPlugin` |
| `createVueRouterAdapter` | функция | `(router: Router, locales: Locale[], defaultLocale: string) => I18nRoutingStrategy` |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 членов</summary>
...
<details>
<summary><code>VueI18n</code> — 51 членов</summary>
