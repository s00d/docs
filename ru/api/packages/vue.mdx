...
description: "Публичный API пакета @i18n-micro/vue: композаблы, компоненты и плагин Vue 3 для переводов и роутинга по локалям, из исходников."
---

# `@i18n-micro/vue`

27 экспортов через 1 точку входа.
...
| `UseLocaleHeadOptions` | interface | 5 членов |
| `VueI18n` | class | 51 членов |
| `VueI18nOptions` | interface | 6 членов |
