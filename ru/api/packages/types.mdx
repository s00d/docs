...
description: "Публичный API пакета @i18n-micro/types: общие TypeScript-определения, используемые во всех интеграциях с фреймворками, сгенерировано из исходников."
---

# `@i18n-micro/types`

26 экспортов через 1 точку входа.
...
| `DefineI18nRouteConfig` | interface | 3 членов |
| `DefineLocaleMessage` | interface | 1 членов |
...
| `I18nHeadInput` | interface | 5 членов |
| `I18nHeadLink` | interface | 4 членов |
| `I18nHeadMeta` | interface | 1 членов |
...
| `ModuleOptions` | interface | 47 членов |
| `ModuleOptionsExtend` | interface | 50 членов |
| `ModulePrivateOptionsExtend` | interface | 50 членов |
...
| `PluralTranslations` | interface | 2 членов |
...
| `TranslationPayloadOptions` | interface | 8 членов |
