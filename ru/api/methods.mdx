---
title: "Справочник методов"
description: "Все runtime-хелперы, которые Nuxt I18n Micro внедряет в приложение: $t, $tc, $switchLocale, $localeRoute и связанные API."
---
