...
description: "API pública del paquete @i18n-micro/astro: punto de entrada de integración, tipos exportados y helpers, generada a partir del código fuente en tiempo de compilación."
---
...
<code>I18nState</code> — 4 miembros, idéntico a `I18nClientProps` above.
