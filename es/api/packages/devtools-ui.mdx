...
description: "API pública del paquete @i18n-micro/devtools-ui: panel DevTools independiente, plugin de Vite y helpers exportados, generada a partir del código fuente."
---
...
<code>I18nDevToolsBridge</code> — 4 miembros, idéntico a `I18nDevToolsBridge` above.
<code>TranslationContent</code> — 1 miembros, idéntico a `TranslationContent` above.
...
<code>BridgeAdapter</code> — 6 miembros, idéntico a `BridgeAdapter` above.
<code>CreateBridgeOptions</code> — 4 miembros, idéntico a `CreateBridgeOptions` above.
