...
description: "API pública del paquete @i18n-micro/utils: helpers de build, source loader, merger y utilidades de premerge, generada a partir del código fuente en tiempo de compilación."
---
...
<code>SourceLocaleInfo</code> — 2 miembros, idéntico a `PreMergeLocaleInfo` above.
