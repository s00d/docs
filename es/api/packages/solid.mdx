...
description: "API pública del paquete @i18n-micro/solid: signals, componentes y provider de SolidJS para traducciones y enrutamiento por idioma, desde el código fuente."
---

# `@i18n-micro/solid`

33 exports en 1 punto de entrada.
...
<code>FormatService</code> — 19 miembros, idéntico a [`FormatService`](/api/packages/astro).
<details>
...
<code>Locale</code> — 11 miembros, idéntico a [`Locale`](/api/packages/types).
<code>ModuleOptions</code> — 47 miembros, idéntico a [`ModuleOptions`](/api/packages/types).
<details>
...
<code>SolidI18nOptions</code> — 6 miembros, idéntico a [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 miembros, idéntico a [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 miembros, idéntico a [`UseI18nOptions`](/api/packages/preact).
