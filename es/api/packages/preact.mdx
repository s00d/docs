...
description: "API pública del paquete @i18n-micro/preact: hooks, componentes y provider de Preact para traducciones y enrutamiento, generada a partir del código fuente."
---
