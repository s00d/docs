...
description: "API pública del paquete @i18n-micro/types: definiciones TypeScript compartidas usadas en las integraciones de framework, generada a partir del código fuente."
---
