...
description: "API pública del paquete @i18n-micro/route-strategy: generación de rutas localizadas en tiempo de compilación para páginas de Nuxt, generada a partir del código fuente."
---

# `@i18n-micro/route-strategy`

18 exports en 1 punto de entrada.
