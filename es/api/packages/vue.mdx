...
description: "API pública del paquete @i18n-micro/vue: composables, componentes y plugin de Vue 3 para traducciones y enrutamiento por idioma, desde el código fuente."
---

# `@i18n-micro/vue`

27 exports en 1 punto de entrada.
...
<code>VueI18nOptions</code> — 6 miembros, idéntico a [`PreactI18nOptions`](/api/packages/preact).
