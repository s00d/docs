...
description: "API pública del paquete @i18n-micro/node: adaptador de runtime para Node.js, loaders de traducción y tipos exportados, generada a partir del código fuente."
---

# `@i18n-micro/node`

15 exports en 1 punto de entrada.
...
<code>LoadedTranslations</code> — 2 miembros, idéntico a [`LoadedTranslations`](/api/packages/astro).
