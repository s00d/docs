...
description: "API pública del paquete @i18n-micro/test-utils: helpers, mocks y fixtures de Vitest para probar el comportamiento i18n, generada a partir del código fuente."
---

# `@i18n-micro/test-utils`

36 exports en 2 puntos de entrada.
