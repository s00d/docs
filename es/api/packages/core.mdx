...
description: "API pública del paquete @i18n-micro/core: primitivas y tipos de runtime compartidos que impulsan cada integración de framework, generada a partir del código fuente."
---
...
<code>MergeTranslationChunkOptions</code> — 1 miembros, idéntico a `MergeTranslationChunkOptions` above.
