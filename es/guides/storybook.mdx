...
description: "Integra Nuxt I18n Micro con Storybook: configura @nuxtjs/storybook, añade controles de idioma y previsualiza componentes en varios idiomas."
---
...
Integrar **Nuxt**, **Storybook** y **nuxt-i18n-micro** en tu proyecto te permite construir una aplicación robusta y localizada con un enfoque de desarrollo dirigido por componentes. Esta guía ofrece un recorrido paso a paso para configurar estas herramientas juntas, incluyendo configuración, localización e integración con Storybook.

## 🛠 Configuración de Nuxt

Para habilitar la localización y Storybook en tu proyecto Nuxt, configura tu archivo `nuxt.config.ts` de la siguiente manera:
...
Para integrar Storybook con Nuxt y nuxt-i18n-micro, configura el archivo `.storybook/main.ts`, añade `mergeTranslations` y `staticDirs`.
...
1. **[Ejemplo Nuxt + Storybook + i18n en GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
...
2. **[Documentación de Storybook para Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   La documentación oficial para configurar Storybook con Nuxt. Ofrece pasos detallados y buenas prácticas.

3. **[Ejemplo interactivo en StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Explora un ejemplo en vivo de integración de Nuxt, Storybook y nuxt-i18n-micro directamente en tu navegador.
