---
title: "Paquete Astro (`@i18n-micro/astro`)"
description: "Usa @i18n-micro/astro para añadir integración i18n a proyectos Astro con soporte SSR, componentes multi-framework y detección de idioma."
---
