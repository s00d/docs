---
title: "Paquete Preact (`@i18n-micro/preact`)"
description: "Usa @i18n-micro/preact para añadir hooks, componentes y un provider para traducciones y enrutamiento por idioma en apps Preact."
---
...
### Configuración básica (sin Router)
