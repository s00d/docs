---
title: "Paquete Node.js (`@i18n-micro/node`)"
description: "Usa @i18n-micro/node para gestionar traducciones en el lado del servidor en aplicaciones Node.js con detección de idioma y carga de mensajes."
---
