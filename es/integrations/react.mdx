---
title: "Paquete React (`@i18n-micro/react`)"
description: "Usa @i18n-micro/react para añadir hooks, componentes y un provider para traducciones y enrutamiento por idioma en apps React."
---
