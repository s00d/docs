---
title: "Paquete Solid (`@i18n-micro/solid`)"
description: "Usa @i18n-micro/solid para añadir signals, componentes y un provider para traducciones y enrutamiento por idioma en apps SolidJS."
---
...
### Traducciones específicas de ruta
