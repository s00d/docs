---
title: "Paquete Vue (`@i18n-micro/vue`)"
description: "Usa @i18n-micro/vue para añadir composables, componentes y un plugin para traducciones y enrutamiento por idioma en apps Vue 3 independientes."
---
