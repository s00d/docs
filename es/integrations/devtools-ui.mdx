---
title: "Paquete DevTools UI (`@i18n-micro/devtools-ui`)"
description: "Usa @i18n-micro/devtools-ui, un panel independiente de DevTools con plugin de Vite para gestionar traducciones durante el desarrollo."
---
