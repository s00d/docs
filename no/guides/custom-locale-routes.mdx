---
title: "Egendefinerte lokaliserte ruter med localeRoutes"
description: "Definer per-lokale rute-stier i Nuxt I18n Micro med $defineI18nRoute og localeRoutes slik at URL-er kan avvike på tvers av språk og slugs."
---

# 🔗 Egendefinerte lokaliserte ruter med `localeRoutes` i `Nuxt I18n Micro`
