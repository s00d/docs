...
description: "Offentlig API for @i18n-micro/utils pakken: bygghjelpere, kildelaster, merger og pre-merge-verktøy, generert fra kilden ved byggetid."
---

# `@i18n-micro/utils`

102 eksporter fordelt på 24 inngangspunkter.
...
| `PreMergeLocaleInfo` | interface | 2 medlemmer |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 medlemmer</summary>
...
| `CacheControlOptions` | interface | 2 medlemmer |

<details>
<summary><code>CacheControl</code> — 13 medlemmer</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 medlemmer</summary>
...
| Eksport | Type | Signatur |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 medlemmer |
...
| `MergeI18nHeadOptions` | interface | 3 medlemmer |

<details>
<summary><code>I18nHeadObject</code> — 3 medlemmer</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 medlemmer</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 medlemmer |
...
| `SourceLocaleInfo` | interface | 2 medlemmer |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 medlemmer</summary>
...
<code>SourceLocaleInfo</code> — 2 medlemmer, identisk med `PreMergeLocaleInfo` over.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 medlemmer</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 medlemmer |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 medlemmer |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 medlemmer |
| `TranslationPayloadStats` | interface | 2 medlemmer |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 medlemmer</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 medlemmer</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 medlemmer</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 medlemmer</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 medlemmer |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 medlemmer</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 medlemmer |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 medlemmer</summary>
...
| Eksport | Type | Signatur |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 medlemmer |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 medlemmer |

<details>
<summary><code>HreflangAlternate</code> — 2 medlemmer</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 medlemmer</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 medlemmer |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 medlemmer |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 medlemmer</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 medlemmer</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 medlemmer |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 medlemmer</summary>
...
| `I18nRouteContext` | interface | 3 medlemmer |
...
<details>
<summary><code>I18nRouteContext</code> — 3 medlemmer</summary>
...
| `RuntimeI18nOverrides` | interface | 4 medlemmer |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 medlemmer</summary>
...
| `TranslationStorageReader` | interface | 1 medlemmer |

<details>
<summary><code>TranslationStorageReader</code> — 1 medlemmer</summary>
...
| Eksport | Type | Signatur |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 medlemmer |
| `SplitLocaleRoutePage` | interface | 3 medlemmer |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 medlemmer |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 medlemmer</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 medlemmer</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 medlemmer</summary>
