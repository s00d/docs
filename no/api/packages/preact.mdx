...
description: "Offentlig API for @i18n-micro/preact pakken: Preact-hooks, komponenter og provider for oversettelser og ruting, generert fra kilden."
---

# `@i18n-micro/preact`

39 eksporter fordelt på 1 inngangspunkt.
...
| `I18nGroupProps` | interface | 301 medlemmer |
| `I18nLink` | const | `(props: I18nLinkProps) => JSX.Element` |
| `I18nLinkProps` | interface | 314 medlemmer |
...
| `PreactI18n` | class | 44 medlemmer |
| `PreactI18nOptions` | interface | 6 medlemmer |
...
| `UseI18nOptions` | interface | 2 medlemmer |
| `UseI18nReturn` | interface | 22 medlemmer |
| `useI18nRouter` | const | `() => I18nRoutingStrategy \| null` |

<code>FormatService</code> — 19 medlemmer, identisk med [`FormatService`](/api/packages/astro).
<details>
<summary><code>I18nGroupProps</code> — 301 medlemmer</summary>
...
<details>
<summary><code>I18nLinkProps</code> — 314 medlemmer</summary>
...
<details>
<summary><code>I18nProviderProps</code> — 5 medlemmer</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 6 medlemmer</summary>
...
<details>
<summary><code>I18nSwitcherProps</code> — 314 medlemmer</summary>
...
<details>
<summary><code>I18nTProps</code> — 311 medlemmer</summary>
...
<details>
<summary><code>Locale</code> — 11 medlemmer</summary>
...
<code>ModuleOptions</code> — 47 medlemmer, identisk med [`ModuleOptions`](/api/packages/types).
<details>
<summary><code>PreactI18n</code> — 44 medlemmer</summary>
...
<details>
<summary><code>PreactI18nOptions</code> — 6 medlemmer</summary>
...
<details>
<summary><code>UseI18nOptions</code> — 2 medlemmer</summary>
...
<details>
<summary><code>UseI18nReturn</code> — 22 medlemmer</summary>
