...
description: "Offentlig API for @i18n-micro/test-utils pakken: Vitest-hjelpere, mocks og fixtures for testing av i18n-atferd, generert fra kilden."
---

# `@i18n-micro/test-utils`

36 eksporter fordelt på 2 inngangspunkter.
...
| Eksport | Type | Signatur |
| --- | --- | --- |
| `ExportTarget` | interface | 3 medlemmer |
...
<details>
<summary><code>ExportTarget</code> — 3 medlemmer</summary>
