...
description: "Offentlig API for @i18n-micro/astro pakken: integrasjonens inngangspunkt, eksporterte typer og hjelpere, generert fra kilden ved byggetid."
---

# `@i18n-micro/astro`

56 eksporter fordelt på 6 inngangspunkter.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 medlemmer |
| `AstroI18nOptions` | interface | 9 medlemmer |
...
| `FormatService` | class | 19 medlemmer |
...
| `I18nClientProps` | interface | 4 medlemmer |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 medlemmer |
| `I18nMiddlewareOptions` | interface | 7 medlemmer |
| `I18nRoutingStrategy` | interface | 10 medlemmer |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 medlemmer |
...
| `LoadTranslationsOptions` | interface | 3 medlemmer |
| `Locale` | interface | 11 medlemmer |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 medlemmer |
| `LocaleHeadResult` | interface | 3 medlemmer |
...
| `Translations` | interface | 1 medlemmer |
...
<details>
<summary><code>AstroI18n</code> — 48 medlemmer</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 medlemmer</summary>
...
<details>
<summary><code>FormatService</code> — 19 medlemmer</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 medlemmer</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 medlemmer</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 medlemmer</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 medlemmer</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 medlemmer</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 medlemmer</summary>
...
<code>Locale</code> — 11 medlemmer, identisk med [`Locale`](/api/packages/types).
<details>
<summary><code>LocaleHeadOptions</code> — 4 medlemmer</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 medlemmer</summary>
...
<code>Translations</code> — 1 medlemmer, identisk med [`Translations`](/api/packages/types).
...
| `I18nState` | interface | 4 medlemmer |
...
<code>I18nState</code> — 4 medlemmer, identisk med `I18nClientProps` over.
