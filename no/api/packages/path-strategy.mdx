...
description: "Offentlig API for @i18n-micro/path-strategy pakken: runtime-oppløsning av lokale-stier, omdirigeringer og SEO-hjelpere, generert fra kilden."
---

# `@i18n-micro/path-strategy`

38 eksporter fordelt på 6 inngangspunkter.
...
| `BasePathStrategy` | class | 36 medlemmer |
...
| `GetRouteBaseNameOptions` | interface | 2 medlemmer |
...
| `IsIndexRouteNameOptions` | interface | 2 medlemmer |
| `NoPrefixPathStrategy` | class | 36 medlemmer |
...
| `PathStrategy` | interface | 22 medlemmer |
| `PathStrategyContext` | interface | 15 medlemmer |
| `PrefixAndDefaultPathStrategy` | class | 37 medlemmer |
| `PrefixExceptDefaultPathStrategy` | class | 44 medlemmer |
| `PrefixPathStrategy` | class | 36 medlemmer |
| `ResolvedRouteLike` | interface | 6 medlemmer |
| `resolvePathWithParams` | function | `(path: string, params?: Record<string, unknown>) => string` |
| `RouteAnalysis` | interface | 2 medlemmer |
| `RouteLike` | interface | 6 medlemmer |
| `RouterAdapter` | interface | 3 medlemmer |
| `SwitchLocaleOptions` | interface | 1 medlemmer |

<details>
<summary><code>BasePathStrategy</code> — 36 medlemmer</summary>
...
<details>
<summary><code>GetRouteBaseNameOptions</code> — 2 medlemmer</summary>
...
<details>
<summary><code>IsIndexRouteNameOptions</code> — 2 medlemmer</summary>
...
<details>
<summary><code>NoPrefixPathStrategy</code> — 36 medlemmer</summary>
...
<details>
<summary><code>PathStrategy</code> — 22 medlemmer</summary>
...
<details>
<summary><code>PathStrategyContext</code> — 15 medlemmer</summary>
...
<details>
<summary><code>PrefixAndDefaultPathStrategy</code> — 37 medlemmer</summary>
...
<details>
<summary><code>PrefixExceptDefaultPathStrategy</code> — 44 medlemmer</summary>
...
<details>
<summary><code>PrefixPathStrategy</code> — 36 medlemmer</summary>
...
<details>
<summary><code>ResolvedRouteLike</code> — 6 medlemmer</summary>
...
<details>
<summary><code>RouteAnalysis</code> — 2 medlemmer</summary>
...
<details>
<summary><code>RouteLike</code> — 6 medlemmer</summary>
...
<details>
<summary><code>RouterAdapter</code> — 3 medlemmer</summary>
...
<details>
<summary><code>SwitchLocaleOptions</code> — 1 medlemmer</summary>
...
| --- | --- | --- |
| `NoPrefixPathStrategy` | class | 36 medlemmer |
| `Strategy` | class | 36 medlemmer |

<code>NoPrefixPathStrategy</code> — 36 medlemmer, identisk med `NoPrefixPathStrategy` over.
<code>Strategy</code> — 36 medlemmer, identisk med `NoPrefixPathStrategy` over.
...
<code>PrefixPathStrategy</code> — 36 medlemmer, identisk med `PrefixPathStrategy` over.
<code>Strategy</code> — 36 medlemmer, identisk med `PrefixPathStrategy` over.
...
| --- | --- | --- |
| `PrefixAndDefaultPathStrategy` | class | 37 medlemmer |
| `Strategy` | class | 37 medlemmer |

<code>PrefixAndDefaultPathStrategy</code> — 37 medlemmer, identisk med `PrefixAndDefaultPathStrategy` over.
<code>Strategy</code> — 37 medlemmer, identisk med `PrefixAndDefaultPathStrategy` over.
...
| --- | --- | --- |
| `PrefixExceptDefaultPathStrategy` | class | 44 medlemmer |
| `Strategy` | class | 44 medlemmer |

<code>PrefixExceptDefaultPathStrategy</code> — 44 medlemmer, identisk med `PrefixExceptDefaultPathStrategy` over.
<code>Strategy</code> — 44 medlemmer, identisk med `PrefixExceptDefaultPathStrategy` over.
...
<code>PathStrategy</code> — 22 medlemmer, identisk med `PathStrategy` over.
<code>PathStrategyContext</code> — 15 medlemmer, identisk med `PathStrategyContext` over.
<code>ResolvedRouteLike</code> — 6 medlemmer, identisk med `ResolvedRouteLike` over.
<code>RouteLike</code> — 6 medlemmer, identisk med `RouteLike` over.
<code>RouterAdapter</code> — 3 medlemmer, identisk med `RouterAdapter` over.
<code>SwitchLocaleOptions</code> — 1 medlemmer, identisk med `SwitchLocaleOptions` over.
