...
description: "Offentlig API for @i18n-micro/core-pakken: delte runtime-primitiver og typer som driver hver rammeverksintegrasjon, generert fra kilden."
---

# `@i18n-micro/core`

50 eksporter fordelt på 3 inngangspunkter.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 medlemmer |
| `BaseI18nOptions` | interface | 7 medlemmer |
...
| `FormatServiceOptions` | interface | 2 medlemmer |
...
| `MergeTranslationChunkOptions` | interface | 1 medlemmer |
...
| `ReactiveI18nStore` | interface | 9 medlemmer |
...
| `TranslationStorage` | interface | 1 medlemmer |
...
<details>
<summary><code>BaseI18n</code> — 34 medlemmer</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 medlemmer</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 medlemmer</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 medlemmer</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 medlemmer</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 medlemmer</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 medlemmer |
...
| `I18nDevtoolsInspectorNode` | interface | 4 medlemmer |
| `I18nDevtoolsStateSnapshot` | interface | 7 medlemmer |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 medlemmer</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 medlemmer</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 medlemmer</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 medlemmer, identisk med `MergeTranslationChunkOptions` over.
