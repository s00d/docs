...
description: "Offentlig API for @i18n-micro/vue pakken: Vue 3-composables, komponenter og plugin for oversettelser og lokale-ruting, fra kilden."
---

# `@i18n-micro/vue`

27 eksporter fordelt på 1 inngangspunkt.
...
| `UseLocaleHeadOptions` | interface | 5 medlemmer |
| `VueI18n` | class | 51 medlemmer |
| `VueI18nOptions` | interface | 6 medlemmer |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 medlemmer</summary>
...
<details>
<summary><code>VueI18n</code> — 51 medlemmer</summary>
...
<code>VueI18nOptions</code> — 6 medlemmer, identisk med [`PreactI18nOptions`](/api/packages/preact).
