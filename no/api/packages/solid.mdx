...
description: "Offentlig API for @i18n-micro/solid pakken: SolidJS-signaler, komponenter og provider for oversettelser og lokale-ruting, fra kilden."
---

# `@i18n-micro/solid`

33 eksporter fordelt på 1 inngangspunkt.
...
| `SolidI18n` | class | 53 medlemmer |
| `SolidI18nOptions` | interface | 6 medlemmer |
...
<details>
<summary><code>I18nProviderProps</code> — 4 medlemmer</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 medlemmer</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 medlemmer</summary>
...
<code>SolidI18nOptions</code> — 6 medlemmer, identisk med [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 medlemmer, identisk med [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 medlemmer, identisk med [`UseI18nOptions`](/api/packages/preact).
