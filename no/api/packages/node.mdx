...
description: "Offentlig API for @i18n-micro/node pakken: Node.js-runtime-adapter, oversettelseslastere og eksporterte typer, generert fra kilden."
---

# `@i18n-micro/node`

15 eksporter fordelt på 1 inngangspunkt.
...
| `I18n` | class | 46 medlemmer |
| `I18nOptions` | interface | 7 medlemmer |
...
<details>
<summary><code>I18n</code> — 46 medlemmer</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 medlemmer</summary>
...
<code>LoadedTranslations</code> — 2 medlemmer, identisk med [`LoadedTranslations`](/api/packages/astro).
