---
title: "Solid-pakke (`@i18n-micro/solid`)"
description: "Bruk @i18n-micro/solid til å legge til signaler, komponenter og en provider for oversettelser og lokale-bevisst ruting i SolidJS-applikasjoner."
---
