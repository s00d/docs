---
title: "Typegenerator for lokale-JSON"
description: "Bruk @i18n-micro/types-generator til å utstede TypeScript-typer fra lokale-JSON-en din, slik at $t og hjelpere får full autoutfylling og trygghet."
---
