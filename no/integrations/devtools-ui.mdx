---
title: "DevTools UI-pakke (`@i18n-micro/devtools-ui`)"
description: "Bruk @i18n-micro/devtools-ui som et frittstående DevTools-UI og en Vite-plugin for å bla i oversettelser og redigere lokaler i vilkårlig @i18n-micro-prosjekt."
---
