---
title: "Vue-pakke (`@i18n-micro/vue`)"
description: "Bruk @i18n-micro/vue til å legge til composables, komponenter og en plugin for oversettelser og lokale-bevisst ruting i frittstående Vue 3-apper."
---
