---
title: "React-pakke (`@i18n-micro/react`)"
description: "Bruk @i18n-micro/react til å legge til hooks, komponenter og en provider for oversettelser og lokale-bevisst ruting i React-apper og -rammeverk."
---
