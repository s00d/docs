---
title: "Astro-pakke (`@i18n-micro/astro`)"
description: "Bruk @i18n-micro/astro til å legge til lokale-ruting, oversettelser og SEO-hjelpere i Astro-prosjekter med den delte @i18n-micro/core-runtimen."
---
