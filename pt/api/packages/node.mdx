...
description: "API pública do pacote @i18n-micro/node: adaptador de runtime para Node.js, loaders de tradução e tipos exportados, gerado a partir do código-fonte."
---

# `@i18n-micro/node`

15 exportações em 1 ponto de entrada.
...
| `I18n` | class | 46 membros |
| `I18nOptions` | interface | 7 membros |
...
<details>
<summary><code>I18n</code> — 46 membros</summary>
...
<details>
<summary><code>I18nOptions</code> — 7 membros</summary>
...
<code>LoadedTranslations</code> — 2 membros, idêntico a [`LoadedTranslations`](/api/packages/astro).
