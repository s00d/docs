...
description: "API pública do pacote @i18n-micro/core: primitivas de runtime partilhadas e tipos que alimentam todas as integrações de framework, gerado a partir do código-fonte."
---

# `@i18n-micro/core`

50 exportações em 3 pontos de entrada.
...
| --- | --- | --- |
| `BaseI18n` | class | 34 membros |
| `BaseI18nOptions` | interface | 7 membros |
...
| `FormatServiceOptions` | interface | 2 membros |
...
| `MergeTranslationChunkOptions` | interface | 1 membros |
...
| `ReactiveI18nStore` | interface | 9 membros |
...
| `TranslationStorage` | interface | 1 membros |
...
<details>
<summary><code>BaseI18n</code> — 34 membros</summary>
...
<details>
<summary><code>BaseI18nOptions</code> — 7 membros</summary>
...
<details>
<summary><code>FormatServiceOptions</code> — 2 membros</summary>
...
<details>
<summary><code>MergeTranslationChunkOptions</code> — 1 membros</summary>
...
<details>
<summary><code>ReactiveI18nStore</code> — 9 membros</summary>
...
<details>
<summary><code>TranslationStorage</code> — 1 membros</summary>
...
| `BuildInspectorTreeOptions` | interface | 6 membros |
...
| `I18nDevtoolsInspectorNode` | interface | 4 membros |
| `I18nDevtoolsStateSnapshot` | interface | 7 membros |
| `parseInspectorNodeId` | function | `(nodeId: string) => \{ kind: "root" \| "active" \| "locale" \| "chunk" \| "key"; locale?: string; routeName?: string; path?: string; \}` |

<details>
<summary><code>BuildInspectorTreeOptions</code> — 6 membros</summary>
...
<details>
<summary><code>I18nDevtoolsInspectorNode</code> — 4 membros</summary>
...
<details>
<summary><code>I18nDevtoolsStateSnapshot</code> — 7 membros</summary>
...
<code>MergeTranslationChunkOptions</code> — 1 membro, idêntico a `MergeTranslationChunkOptions` acima.
