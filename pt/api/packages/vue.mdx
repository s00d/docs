...
description: "API pública do pacote @i18n-micro/vue: composables, componentes e plugin Vue 3 para traduções e encaminhamento de locale, a partir do código-fonte."
---

# `@i18n-micro/vue`

27 exportações em 1 ponto de entrada.
...
| `UseLocaleHeadOptions` | interface | 5 membros |
| `VueI18n` | class | 51 membros |
| `VueI18nOptions` | interface | 6 membros |
...
<details>
<summary><code>UseLocaleHeadOptions</code> — 5 membros</summary>
...
<details>
<summary><code>VueI18n</code> — 51 membros</summary>
...
<code>VueI18nOptions</code> — 6 membros, idêntico a [`PreactI18nOptions`](/api/packages/preact).
