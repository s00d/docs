...
description: "API pública do pacote @i18n-micro/solid: signals, componentes e provider SolidJS para traduções e encaminhamento de locale, a partir do código-fonte."
---

# `@i18n-micro/solid`

33 exportações em 1 ponto de entrada.
...
| `SolidI18n` | class | 53 membros |
| `SolidI18nOptions` | interface | 6 membros |
...
<details>
<summary><code>I18nProviderProps</code> — 4 membros</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 7 membros</summary>
...
<details>
<summary><code>SolidI18n</code> — 53 membros</summary>
...
<code>SolidI18nOptions</code> — 6 membros, idêntico a [`PreactI18nOptions`](/api/packages/preact).
<code>Translations</code> — 1 membro, idêntico a [`Translations`](/api/packages/types).
<code>UseI18nOptions</code> — 2 membros, idêntico a [`UseI18nOptions`](/api/packages/preact).
