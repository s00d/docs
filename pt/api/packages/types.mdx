...
description: "API pública do pacote @i18n-micro/types: definições TypeScript partilhadas usadas nas integrações de framework, gerado a partir do código-fonte."
---

# `@i18n-micro/types`

26 exportações em 1 ponto de entrada.
