...
description: "API pública do pacote @i18n-micro/utils: helpers de build, source loader, merger e utilitários de premerge, gerado a partir do código-fonte em tempo de build."
---

# `@i18n-micro/utils`

102 exportações em 24 pontos de entrada.
...
| `PreMergeLocaleInfo` | interface | 2 membros |
...
<details>
<summary><code>PreMergeLocaleInfo</code> — 2 membros</summary>
...
| `CacheControlOptions` | interface | 2 membros |

<details>
<summary><code>CacheControl</code> — 13 membros</summary>
...
<details>
<summary><code>CacheControlOptions</code> — 2 membros</summary>
...
| Exportação | Tipo | Assinatura |
| --- | --- | --- |
| `I18nHeadObject` | interface | 3 membros |
...
| `MergeI18nHeadOptions` | interface | 3 membros |

<details>
<summary><code>I18nHeadObject</code> — 3 membros</summary>
...
<details>
<summary><code>MergeI18nHeadOptions</code> — 3 membros</summary>
...
| `MergeSourceTranslationsInput` | interface | 6 membros |
...
| `SourceLocaleInfo` | interface | 2 membros |
...
<details>
<summary><code>MergeSourceTranslationsInput</code> — 6 membros</summary>
...
<code>SourceLocaleInfo</code> — 2 membros, idêntico a `PreMergeLocaleInfo` acima.
...
<details>
<summary><code>TranslationFileBuckets</code> — 2 membros</summary>
...
| `ResolvedTranslationPayloadOptions` | interface | 8 membros |
...
| `TranslationPayloadMisconfigurationInput` | interface | 3 membros |
| `TranslationPayloadMode` | type | `'premerged' \| 'source'` |
| `TranslationPayloadSizeThresholds` | interface | 2 membros |
| `TranslationPayloadStats` | interface | 2 membros |

<details>
<summary><code>ResolvedTranslationPayloadOptions</code> — 8 membros</summary>
...
<details>
<summary><code>TranslationPayloadMisconfigurationInput</code> — 3 membros</summary>
...
<details>
<summary><code>TranslationPayloadSizeThresholds</code> — 2 membros</summary>
...
<details>
<summary><code>TranslationPayloadStats</code> — 2 membros</summary>
...
| `TranslationPayloadHostConfig` | interface | 3 membros |

<details>
<summary><code>TranslationPayloadHostConfig</code> — 3 membros</summary>
...
| `TranslationPayloadFetchRequestInput` | interface | 9 membros |

<details>
<summary><code>TranslationPayloadFetchRequestInput</code> — 9 membros</summary>
...
| Exportação | Tipo | Assinatura |
| --- | --- | --- |
| `HreflangAlternate` | interface | 2 membros |
...
| `ResolveHreflangAlternatesOptions` | interface | 1 membros |

<details>
<summary><code>HreflangAlternate</code> — 2 membros</summary>
...
<details>
<summary><code>ResolveHreflangAlternatesOptions</code> — 1 membros</summary>
...
| `ResolvePreferredLocaleInput` | interface | 7 membros |
| `resolveServerLocale` | function | `(input: ResolveServerLocaleInput) => string` |
| `ResolveServerLocaleInput` | interface | 8 membros |

<details>
<summary><code>ResolvePreferredLocaleInput</code> — 7 membros</summary>
...
<details>
<summary><code>ResolveServerLocaleInput</code> — 8 membros</summary>
...
| `WarnUnresolvedOgLocaleOptions` | interface | 2 membros |

<details>
<summary><code>WarnUnresolvedOgLocaleOptions</code> — 2 membros</summary>
...
| `I18nRouteContext` | interface | 3 membros |
...
<details>
<summary><code>I18nRouteContext</code> — 3 membros</summary>
...
| `RuntimeI18nOverrides` | interface | 4 membros |

<details>
<summary><code>RuntimeI18nOverrides</code> — 4 membros</summary>
...
| `TranslationStorageReader` | interface | 1 membros |

<details>
<summary><code>TranslationStorageReader</code> — 1 membros</summary>
...
| Exportação | Tipo | Assinatura |
| --- | --- | --- |
| `SplitLocaleRouteEntry` | interface | 4 membros |
| `SplitLocaleRoutePage` | interface | 3 membros |
| `splitLocaleRoutes` | function | `(entries: readonly SplitLocaleRouteEntry[]) => SplitLocaleRoutesResult` |
| `SplitLocaleRoutesResult` | interface | 2 membros |

<details>
<summary><code>SplitLocaleRouteEntry</code> — 4 membros</summary>
...
<details>
<summary><code>SplitLocaleRoutePage</code> — 3 membros</summary>
...
<details>
<summary><code>SplitLocaleRoutesResult</code> — 2 membros</summary>
