...
description: "API pública do pacote @i18n-micro/test-utils: helpers Vitest, mocks e fixtures para testar o comportamento de i18n, gerado a partir do código-fonte."
---

# `@i18n-micro/test-utils`

36 exportações em 2 pontos de entrada.
...
| Exportação | Tipo | Assinatura |
| --- | --- | --- |
| `ExportTarget` | interface | 3 membros |
...
<details>
<summary><code>ExportTarget</code> — 3 membros</summary>
