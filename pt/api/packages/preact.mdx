...
description: "API pública do pacote @i18n-micro/preact: hooks, componentes e provider Preact para traduções e encaminhamento, gerado a partir do código-fonte."
---

# `@i18n-micro/preact`

39 exportações em 1 ponto de entrada.
...
| `I18nGroupProps` | interface | 301 membros |
| `I18nLink` | const | `(props: I18nLinkProps) => JSX.Element` |
| `I18nLinkProps` | interface | 314 membros |
...
| `PreactI18n` | class | 44 membros |
| `PreactI18nOptions` | interface | 6 membros |
...
| `UseI18nOptions` | interface | 2 membros |
| `UseI18nReturn` | interface | 22 membros |
| `useI18nRouter` | const | `() => I18nRoutingStrategy \| null` |

<code>FormatService</code> — 19 membros, idêntico a [`FormatService`](/api/packages/astro).
<details>
<summary><code>I18nGroupProps</code> — 301 membros</summary>
...
<details>
<summary><code>I18nLinkProps</code> — 314 membros</summary>
...
<details>
<summary><code>I18nProviderProps</code> — 5 membros</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 6 membros</summary>
...
<details>
<summary><code>I18nSwitcherProps</code> — 314 membros</summary>
...
<details>
<summary><code>I18nTProps</code> — 311 membros</summary>
...
<code>ModuleOptions</code> — 47 membros, idêntico a [`ModuleOptions`](/api/packages/types).
<details>
<summary><code>PreactI18n</code> — 44 membros</summary>
...
<details>
<summary><code>PreactI18nOptions</code> — 6 membros</summary>
...
<details>
<summary><code>UseI18nOptions</code> — 2 membros</summary>
...
<details>
<summary><code>UseI18nReturn</code> — 22 membros</summary>
