...
description: "API pública do pacote @i18n-micro/astro: ponto de entrada de integração, tipos exportados e helpers, gerado a partir do código-fonte em tempo de build."
---

# `@i18n-micro/astro`

56 exportações em 6 pontos de entrada.
...
| --- | --- | --- |
| `AstroI18n` | class | 48 membros |
| `AstroI18nOptions` | interface | 9 membros |
...
| `FormatService` | class | 19 membros |
...
| `I18nClientProps` | interface | 4 membros |
| `i18nIntegration` | function | `(options: I18nIntegrationOptions) => AstroIntegration` |
| `I18nIntegrationOptions` | interface | 53 membros |
| `I18nMiddlewareOptions` | interface | 7 membros |
| `I18nRoutingStrategy` | interface | 10 membros |
| `interpolate` | function | `(template: string, params: Params) => string` |
| `LoadedTranslations` | interface | 2 membros |
...
| `LoadTranslationsOptions` | interface | 3 membros |
| `Locale` | interface | 11 membros |
| `LocaleCode` | type | `string` |
| `LocaleHeadOptions` | interface | 4 membros |
| `LocaleHeadResult` | interface | 3 membros |
...
<details>
<summary><code>AstroI18n</code> — 48 membros</summary>
...
<details>
<summary><code>AstroI18nOptions</code> — 9 membros</summary>
...
<details>
<summary><code>FormatService</code> — 19 membros</summary>
...
<details>
<summary><code>I18nClientProps</code> — 4 membros</summary>
...
<details>
<summary><code>I18nIntegrationOptions</code> — 53 membros</summary>
...
<details>
<summary><code>I18nMiddlewareOptions</code> — 7 membros</summary>
...
<details>
<summary><code>I18nRoutingStrategy</code> — 10 membros</summary>
...
<details>
<summary><code>LoadedTranslations</code> — 2 membros</summary>
...
<details>
<summary><code>LoadTranslationsOptions</code> — 3 membros</summary>
...
<code>Locale</code> — 11 membros, idêntico a [`Locale`](/api/packages/types).
<details>
<summary><code>LocaleHeadOptions</code> — 4 membros</summary>
...
<details>
<summary><code>LocaleHeadResult</code> — 3 membros</summary>
...
<code>Translations</code> — 1 membro, idêntico a [`Translations`](/api/packages/types).
...
<code>I18nState</code> — 4 membros, idêntico a `I18nClientProps` acima.
