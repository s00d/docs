...
description: "API pública do pacote @i18n-micro/hmr: helpers de hot module replacement para ficheiros JSON de locale durante o desenvolvimento, gerado a partir do código-fonte."
---

# `@i18n-micro/hmr`

8 exportações em 3 pontos de entrada.
Gerado a partir do snapshot da API que [`pnpm run api:surface`](https://github.com/s00d/nuxt-i18n-micro/blob/main/docs/guide/maintenance-commands.md#api-surface) valida contra o código-fonte TypeScript.
