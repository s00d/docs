...
description: "API pública do pacote @i18n-micro/route-strategy: geração de rotas localizadas em tempo de build para páginas Nuxt, gerado a partir do código-fonte."
---

# `@i18n-micro/route-strategy`

18 exportações em 1 ponto de entrada.
...
| `RouteGenerator` | class | 23 membros |
| `RouteGeneratorOptions` | interface | 11 membros |
| `shouldAddLocalePrefix` | const | `(locale: string, defaultLocale: Locale, addLocalePrefix: boolean) => boolean` |

<details>
<summary><code>RouteGenerator</code> — 23 membros</summary>
...
<details>
<summary><code>RouteGeneratorOptions</code> — 11 membros</summary>
