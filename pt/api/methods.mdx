---
title: "Métodos"
description: "Todos os métodos de runtime do nuxt-i18n-micro."
---
...
Cada helper que o plugin injeta, lido a partir da interface `PluginsInjections` — portanto esta
lista não pode ficar dessincronizada do que está realmente disponível.
