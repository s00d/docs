...
description: "i18n para Node.js com @i18n-micro/node."
---
...
### Hot Module Replacement (HMR) com file watcher
...
## 🌍 Utilizar em rotas de servidor Nuxt
...
## 📋 Exemplos de utilização avançados
...
### Integração com traduções específicas de rota
