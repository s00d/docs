---
title: "Guia de integração do Storybook"
description: "Integre o Nuxt I18n Micro com o Storybook: configure o @nuxtjs/storybook, adicione controlos de locale e pré-visualize componentes em vários idiomas."
---

# 🌐 Guia de integração do Storybook

## 📖 Introdução

Integrar **Nuxt**, **Storybook** e **nuxt-i18n-micro** no seu projeto permite construir uma aplicação localizada e robusta com uma abordagem de desenvolvimento orientada a componentes. Este guia orienta-o passo a passo pela configuração destas ferramentas em conjunto, incluindo configuração, localização e integração com o Storybook.

## 🛠 Configuração do Nuxt

Para ativar a localização e o Storybook no seu projeto Nuxt, configure o seu ficheiro `nuxt.config.ts` da seguinte forma:
...
Para exemplos completos, veja estes projetos:

1. **[Exemplo Nuxt + Storybook + i18n no GitHub](https://github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Este repositório demonstra como integrar Nuxt, Storybook e nuxt-i18n-micro. Inclui instruções de configuração e detalhes.

2. **[Documentação do Storybook para Nuxt](https://storybook.nuxtjs.org/getting-started/setup)**  
   Documentação oficial para configurar o Storybook com o Nuxt. Apresenta passos detalhados e boas práticas.

3. **[Exemplo interativo no StackBlitz](https://stackblitz.com/~/github.com/s00d/nuxtjs-storybook-i18n-micro)**  
   Explore diretamente no seu browser um exemplo em direto de integração de Nuxt, Storybook e nuxt-i18n-micro.
